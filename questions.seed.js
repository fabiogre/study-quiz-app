const SEED_QUESTIONS = [
    ...
    },
    {
        ...
        "extraInfo_en": "Important: ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œATM/Frame Relay onlyÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â is worded too narrowly. Depending on the pseudowire/service profile, it may also be relevant in other contexts.",
    ...
    },
    {
        ...
        "source": "Telecommunication Grundlagen",
        "question_en": "What does ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œencapsulate customer payloadÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â mean in the provider context?",
    ...
    },
    {
        ...
        "tip_en": "Separate in your mind ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œphysicalÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â (joint) and ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œlogicalÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â (separate).",
        "source_en": "Telecommunication basics",
        "options_en": [
    ...
    },
    {
        ...
        "source": "Telecommunication Grundlagen",
        "question_en": "What best describes a ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œserviceÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â in the provider environment?",
    ...
    },
    {
        ...
        "source": "Telecommunication Grundlagen",
        "question_en": "What is the typical advantage of VPWS from the customerÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢s perspective?",
        ...
        "tip_en": "Note: ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œlike a cable between two locationsÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â.",
        "source_en": "Telecommunication basics",
        "options_en": [
    ...
    },
    {
        ...
        "correctIndex": 0,
        "explanation": "Route Refresh hilft, ohne Hard-Reset der Session eine erneute Policy-Anwendung auf empfangene Routen auszulÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶sen.",
    ...
    },
    {
        ...
        "tip": "Die 6 StandardzustÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤nde der BGP FSM auswendig koennen.",
    ...
    {
        "id": "bgp-m2s1-q1",
        "question": "Wann spricht man von Multiprotocol BGP oder MP-BGP?",
        "question_en": "When do we speak of Multiprotocol BGP or MP-BGP?",
        "options": [
            "Wenn eine BGP-Implementierung mehrere Address Families und Reachability-Typen transportieren kann",
            "Sobald BGP ueber TCP Port 179 laeuft",
            "Nur wenn Route Reflectors aktiviert sind",
            "Nur wenn MPLS im Core verwendet wird"
        ],
        "options_en": [
            "When a BGP implementation can carry multiple address families and reachability types",
            "As soon as BGP runs over TCP port 179",
            "Only when route reflectors are enabled",
            "Only when MPLS is used in the core"
        ],
        "correctIndex": 0,
        "explanation": "Klassisches BGP war auf IPv4-Unicast fokussiert. Mit den Multiprotocol-Erweiterungen kann BGP mehrere Address Families parallel transportieren.",
        "explanation_en": "Classic BGP was focused on IPv4 unicast. With the multiprotocol extensions, BGP can carry multiple address families in parallel.",
        "extraInfo": "Genau deshalb spricht man dann von MP-BGP.",
        "extraInfo_en": "That is exactly why it is then called MP-BGP.",
        "tip": "Mehrere Address Families = MP-BGP.",
        "tip_en": "Multiple address families = MP-BGP.",
        "tags": [
            "BGP",
            "MP-BGP",
            "Address Family"
    ...
    {
        "id": "bgp-m2s1-q2",
        "question": "Welche Aussage beschreibt die Entwicklung von BGP zu MP-BGP am besten?",
        "question_en": "Which statement best describes the evolution from BGP to MP-BGP?",
        "options": [
            "Frueher war BGP im Wesentlichen IPv4-orientiert, spaeter kamen weitere Adressfamilien wie VPN-IPv4, VPN-IPv6 oder labelbezogene Familien hinzu",
            "BGP war schon immer automatisch fuer jede denkbare Adressfamilie aktiv",
            "MP-BGP ersetzt TCP als Transportprotokoll",
            "MP-BGP ist nur ein anderer Name fuer iBGP"
        ],
        "options_en": [
            "Originally BGP was essentially IPv4-oriented, and later more address families such as VPN-IPv4, VPN-IPv6, or label-related families were added",
            "BGP was always automatically active for every possible address family",
            "MP-BGP replaces TCP as the transport protocol",
            "MP-BGP is just another name for iBGP"
        ],
        "correctIndex": 0,
        "explanation": "Mit MP-BGP wurde BGP erweitert, damit nicht nur IPv4-Unicast, sondern auch VPN-, IPv6-, Label- und andere Reachability-Typen transportiert werden koennen.",
        "explanation_en": "MP-BGP extended BGP so that not only IPv4 unicast, but also VPN, IPv6, label, and other reachability types can be carried.",
        "extraInfo": "Die Kernidee ist AFI/SAFI-Unterstuetzung statt nur eines einzigen Adresstyps.",
        "extraInfo_en": "The core idea is AFI/SAFI support instead of just one address type.",
        "tip": "MP-BGP = BGP plus mehrere Reachability-Familien.",
        "tip_en": "MP-BGP = BGP plus multiple reachability families.",
        "tags": [
            "BGP",
            "MP-BGP",
            "VPN-IPv4",
    ...
    {
        "id": "bgp-m2s1-q3",
        "question": "Wie passen VPWS, VPLS und VPRN als VPN-Servicearten am besten zusammen?",
        "question_en": "How do VPWS, VPLS, and VPRN best map as VPN service types?",
        "options": [
            "VPWS = Layer 2 Punkt-zu-Punkt, VPLS = Layer 2 Multipoint, VPRN = Layer 3 Multipoint",
            "VPWS = Layer 3 Multipoint, VPLS = Layer 1 Punkt-zu-Punkt, VPRN = Layer 2 Broadcast",
            "Alle drei sind nur Layer-3-Services",
            "Alle drei sind nur lokale Single-Router-Services"
        ],
        "options_en": [
            "VPWS = Layer 2 point-to-point, VPLS = Layer 2 multipoint, VPRN = Layer 3 multipoint",
            "VPWS = Layer 3 multipoint, VPLS = Layer 1 point-to-point, VPRN = Layer 2 broadcast",
            "All three are only Layer 3 services",
            "All three are only local single-router services"
        ],
        "correctIndex": 0,
        "explanation": "Diese drei Services decken typische Provider-VPN-Modelle fuer L2-Punkt-zu-Punkt, L2-Multipoint und L3-Multipoint ab.",
        "explanation_en": "These three services cover typical provider VPN models for L2 point-to-point, L2 multipoint, and L3 multipoint.",
        "extraInfo": "Gerade VPRN ist der Kontext, in dem MP-BGP besonders wichtig wird.",
        "extraInfo_en": "VPRN in particular is the context where MP-BGP becomes especially important.",
        "tip": "VPWS kabelartig, VPLS switchartig, VPRN routerartig.",
        "tip_en": "VPWS is cable-like, VPLS switch-like, VPRN router-like.",
        "tags": [
            "BGP",
            "VPN",
            "VPWS",
    ...
    {
        "id": "bgp-m2s1-q4",
        "question": "Was kennzeichnet ein distributed VPN am besten?",
        "question_en": "What best characterizes a distributed VPN?",
        "options": [
            "Der Service wird durch mehrere PE-Geraete gemeinsam bereitgestellt und braucht Tunnel fuer den Transport zwischen ihnen",
            "Er existiert immer nur auf einem einzelnen CE-Router",
            "Er benoetigt grundsaetzlich weder Tunnel noch PE-Router",
            "Er kann nur mit GRE und niemals mit MPLS arbeiten"
        ],
        "options_en": [
            "The service is jointly provided by multiple PE devices and requires tunnels for transport between them",
            "It always exists only on a single CE router",
            "It fundamentally needs neither tunnels nor PE routers",
            "It can work only with GRE and never with MPLS"
        ],
        "correctIndex": 0,
        "explanation": "Bei einem distributed VPN arbeiten mehrere Provider-Edge-Geraete zusammen. Zwischen ihnen muessen die Kundendaten durch geeignete Tunnel transportiert werden.",
        "explanation_en": "In a distributed VPN, multiple provider-edge devices work together. Customer traffic must be transported between them through suitable tunnels.",
        "extraInfo": "Die P-Router in der Mitte transportieren dabei nur den Tunnelverkehr weiter.",
        "extraInfo_en": "The P routers in the middle simply forward the tunnel traffic.",
        "tip": "Distributed = mehrere PE, nicht nur ein lokaler Router.",
        "tip_en": "Distributed = multiple PEs, not just one local router.",
        "tags": [
            "BGP",
            "VPN",
            "Distributed VPN",
    ...
    {
        "id": "bgp-m2s1-q5",
        "question": "Welche Kombination von VPN-Services ist korrekt beschrieben?",
        "question_en": "Which combination of VPN services is described correctly?",
        "options": [
            "Ein VPLS kann an ein VPRN-Interface angebunden werden; ein VPWS kann in VPLS oder ein VPRN-Interface terminiert werden",
            "Ein VPRN kann nie mit einem VPLS in Beziehung stehen",
            "Ein VPWS kann nur direkt an einen CE und nie an andere Services gebunden werden",
            "Routed VPLS bedeutet, dass ein VPRN in ein VPWS umgewandelt wird"
        ],
        "options_en": [
            "A VPLS can be attached to a VPRN interface; a VPWS can be terminated into VPLS or a VPRN interface",
            "A VPRN can never have any relation to a VPLS",
            "A VPWS can only terminate directly on a CE and never into other services",
            "Routed VPLS means that a VPRN is converted into a VPWS"
        ],
        "correctIndex": 0,
        "explanation": "Provider-Services koennen sinnvoll miteinander verbunden werden. Wird ein VPLS an ein VPRN-Interface angebunden, spricht man typischerweise von routed VPLS oder rVPLS.",
        "explanation_en": "Provider services can be meaningfully interconnected. When a VPLS is attached to a VPRN interface, that is typically called routed VPLS or rVPLS.",
        "extraInfo": "Solche Kopplungen erlauben komplexere Kunden-Topologien statt isolierter Einzelservices.",
        "extraInfo_en": "Such combinations allow more complex customer topologies instead of isolated single services.",
        "tip": "Services koennen gekoppelt werden, nicht nur isoliert existieren.",
        "tip_en": "Services can be interconnected, not only exist in isolation.",
        "tags": [
            "BGP",
            "VPN",
            "VPLS",
    ...
    {
        "id": "bgp-m2s1-q6",
        "question": "Wie funktioniert das Tunneling von VPN-Daten zwischen PE-Routern im Kern?",
        "question_en": "How does VPN data tunneling between PE routers work in the core?",
        "options": [
            "Am ingress-PE wird ein Tunnel-Header hinzugefuegt, P-Router leiten anhand dieses Transports weiter, und am egress-PE wird er wieder entfernt",
            "Die CE-Router fuehren das gesamte Provider-Tunneling selbst aus",
            "P-Router muessen alle Kundennetze komplett lernen und routen",
            "Tunnel-Header bleiben immer bis zum CE bestehen"
        ],
        "options_en": [
            "At the ingress PE a tunnel header is added, P routers forward based on that transport, and at the egress PE it is removed again",
            "The CE routers perform the entire provider tunneling themselves",
            "P routers must fully learn and route all customer networks",
            "Tunnel headers always remain all the way to the CE"
        ],
        "correctIndex": 0,
        "explanation": "Der Kern der Idee ist: PE kapselt, P transportiert, egress-PE entkapselt. Die mittleren Core-Router muessen den Kundendienst selbst nicht terminieren.",
        "explanation_en": "The core idea is: PE encapsulates, P transports, egress PE decapsulates. The core routers in the middle do not have to terminate the customer service themselves.",
        "extraInfo": "Genau so bleibt der Core vom eigentlichen Kundendienst weitgehend entkoppelt.",
        "extraInfo_en": "That is exactly how the core remains largely decoupled from the actual customer service.",
        "tip": "PE packt ein, P transportiert, PE packt aus.",
        "tip_en": "PE wraps, P transports, PE unwraps.",
        "tags": [
            "BGP",
            "VPN",
            "Tunnel",
    ...
    {
        "id": "bgp-m2s1-q7",
        "question": "Warum braucht man neben Transport-Tunneln noch Service-Tunnel oder Service-Kontexte?",
        "question_en": "Why do we need service tunnels or service contexts in addition to transport tunnels?",
        "options": [
            "Weil viele verschiedene VPN-Services denselben Transport-Tunnel teilen koennen und trotzdem voneinander unterscheidbar bleiben muessen",
            "Weil sonst TCP nicht mehr funktioniert",
            "Weil ein Tunnel immer nur genau eine Community tragen darf",
            "Weil Route Reflectors keine Tunnel verstehen"
        ],
        "options_en": [
            "Because many different VPN services can share the same transport tunnel and still need to remain distinguishable",
            "Because otherwise TCP no longer works",
            "Because one tunnel may carry only a single community",
            "Because route reflectors do not understand tunnels"
        ],
        "correctIndex": 0,
        "explanation": "Ein Transport-Tunnel allein sagt noch nicht, zu welchem Kundendienst die Daten gehoeren. Deshalb braucht es einen zusaetzlichen Service-Kontext pro Dienst.",
        "explanation_en": "A transport tunnel alone does not say which customer service the traffic belongs to. That is why an additional service context is needed per service.",
        "extraInfo": "Hier kommt der Service Distribution Point als Bindeglied ins Spiel.",
        "extraInfo_en": "This is where the service distribution point comes in as the binding element.",
        "tip": "Ein Tunnel kann viele Services tragen, also braucht es Demultiplexing.",
        "tip_en": "One tunnel can carry many services, so demultiplexing is required.",
        "tags": [
            "BGP",
            "VPN",
            "Transport Tunnel",
    ...
    {
        "id": "bgp-m2s1-q8",
        "question": "Welche Rolle spielt ein SDP in diesem VPN-Kontext am besten?",
        "question_en": "What best describes the role of an SDP in this VPN context?",
        "options": [
            "Es bindet Service-Kontext und Transportweg logisch zusammen",
            "Es ersetzt den Route Distinguisher",
            "Es ist nur eine andere Bezeichnung fuer LOCAL_PREF",
            "Es ist das gleiche wie ein CE-Router"
        ],
        "options_en": [
            "It logically binds the service context and the transport path together",
            "It replaces the route distinguisher",
            "It is just another name for LOCAL_PREF",
            "It is the same thing as a CE router"
        ],
        "correctIndex": 0,
        "explanation": "Der SDP ist die logische Bindestelle, ueber die ein Dienst einem Transporttunnel zugeordnet werden kann.",
        "explanation_en": "The SDP is the logical attachment point through which a service can be associated with a transport tunnel.",
        "extraInfo": "Ohne diese Zuordnung gaebe es keinen sauberen Weg, Dienst und Transportbeziehung zusammenzubringen.",
        "extraInfo_en": "Without that association there would be no clean way to bring service and transport together.",
        "tip": "SDP = Bindeglied zwischen Service und Tunnel.",
        "tip_en": "SDP = link between service and tunnel.",
        "tags": [
            "BGP",
            "VPN",
            "SDP",
    ...
    {
        "id": "bgp-m2s1-q9",
        "question": "Was bedeutet 'multiple router instances' im VPRN-Kontext?",
        "question_en": "What does 'multiple router instances' mean in the VPRN context?",
        "options": [
            "Neben dem Default- oder Base-Router existiert pro VPRN eine eigene logische Router-Instanz mit eigenen Layer-3-Interfaces und Routing-Protokollen",
            "Alle VPRNs teilen sich zwingend dieselbe einzige Routing-Tabelle",
            "Jeder CE-Router wird automatisch zu einem Route Reflector",
            "Es gibt im VPRN-Kontext keine separaten Instanzen"
        ],
        "options_en": [
            "Besides the default or base router, each VPRN has its own logical router instance with its own Layer 3 interfaces and routing protocols",
            "All VPRNs must share the same single routing table",
            "Each CE router automatically becomes a route reflector",
            "There are no separate instances in the VPRN context"
        ],
        "correctIndex": 0,
        "explanation": "Genau dadurch kann jedes VPRN als eigenes L3-Kundennetz mit eigener Routing-Sicht betrieben werden.",
        "explanation_en": "That is exactly what allows each VPRN to be operated as its own Layer 3 customer network with its own routing view.",
        "extraInfo": "Der Base Router bleibt davon logisch getrennt.",
        "extraInfo_en": "The base router remains logically separate from that.",
        "tip": "VPRN = eigene Routing-Instanz, nicht nur ein weiteres Interface.",
        "tip_en": "VPRN = its own routing instance, not just another interface.",
        "tags": [
            "BGP",
            "VPRN",
            "Router Instance",
    ...
    {
        "id": "bgp-m2s1-q10",
        "question": "Warum ist MP-BGP fuer VPRN besonders wichtig?",
        "question_en": "Why is MP-BGP especially important for VPRN?",
        "options": [
            "Weil PE-Router damit die VPN-Routing-Informationen verschiedener Kundenseiten austauschen koennen",
            "Weil sonst keine Ethernet-Frames mehr moeglich sind",
            "Weil MP-BGP den Need fuer Route Distinguisher komplett entfernt",
            "Weil VPRN ohne TCP arbeitet"
        ],
        "options_en": [
            "Because it allows PE routers to exchange VPN routing information for different customer sites",
            "Because otherwise Ethernet frames are no longer possible",
            "Because MP-BGP completely removes the need for route distinguishers",
            "Because VPRN operates without TCP"
        ],
        "correctIndex": 0,
        "explanation": "MP-BGP transportiert die VPN-spezifischen Routing-Informationen zwischen den PE-Routern und ist damit zentral fuer verteilte Layer-3-VPNs.",
        "explanation_en": "MP-BGP carries the VPN-specific routing information between PE routers and is therefore central to distributed Layer 3 VPNs.",
        "extraInfo": "Gerade VPRN ist einer der klassischen Einsatzzwecke von MP-BGP im Provider-Netz.",
        "extraInfo_en": "VPRN is one of the classic use cases of MP-BGP in provider networks.",
        "tip": "VPRN braucht MP-BGP fuer den VPN-Routen-Austausch.",
        "tip_en": "VPRN needs MP-BGP for VPN route exchange.",
        "tags": [
            "BGP",
            "MP-BGP",
            "VPRN",
    ...
    {
        "id": "bgp-m2s1-q11",
        "question": "Welche Aussage zu MP-BGP-Sessions zwischen PE-Routern ist fachlich korrekt?",
        "question_en": "Which statement about MP-BGP sessions between PE routers is technically correct?",
        "options": [
            "Ohne Hilfskonstrukte wie Route Reflectors braucht man fuer den vollen Austausch typischerweise ein Full Mesh; alternativ kann ein Route Reflector die Skalierbarkeit verbessern",
            "MP-BGP erlaubt nie den Einsatz von Route Reflectors",
            "Ein einziges CE-PE-Peering ersetzt alle PE-PE-Beziehungen",
            "Full Mesh ist nur bei Layer 2 und nie bei VPRN relevant"
        ],
        "options_en": [
            "Without helper constructs such as route reflectors, full exchange typically requires a full mesh; alternatively a route reflector can improve scalability",
            "MP-BGP never allows the use of route reflectors",
            "A single CE-PE peering replaces all PE-PE relationships",
            "Full mesh matters only for Layer 2 and never for VPRN"
        ],
        "correctIndex": 0,
        ...
        "extraInfo": "Das ist genau der Grund, warum Route Reflectors in grÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶sseren MP-BGP-VPN-Umgebungen so wichtig werden.",
    ...
    {
        "id": "bgp-m2s1-q12",
        "question": "Wofuer dient der Route Distinguisher in einem VPRN am besten?",
        "question_en": "What is the main purpose of the route distinguisher in a VPRN?",
        "options": [
            "Er macht ueberlappende Kundenpraefixe im MP-BGP-Kontext eindeutig, indem er sie mit einem zusaetzlichen Wert kombiniert",
            "Er ersetzt den NEXT_HOP",
            "Er setzt automatisch den MED-Wert",
            "Er schaltet private Adressen in oeffentliche um"
        ],
        "options_en": [
            "It makes overlapping customer prefixes unique in the MP-BGP context by combining them with an additional value",
            "It replaces the NEXT_HOP",
            "It automatically sets the MED value",
            "It converts private addresses into public ones"
        ],
        "correctIndex": 0,
        "explanation": "Wenn mehrere Kunden gleiche oder ueberlappende Praefixe nutzen, sorgt der RD dafuer, dass BGP daraus unterschiedliche VPN-Praefixe bilden kann.",
        "explanation_en": "When multiple customers use the same or overlapping prefixes, the RD allows BGP to create distinct VPN prefixes from them.",
        "extraInfo": "Gerade in Multi-Customer-VPRN-Umgebungen ist das unverzichtbar.",
        "extraInfo_en": "That is indispensable especially in multi-customer VPRN environments.",
        "tip": "RD macht gleiche Kundenpraefixe in BGP eindeutig.",
        "tip_en": "RD makes identical customer prefixes unique in BGP.",
        "tags": [
            "BGP",
            "VPRN",
            "Route Distinguisher",
    ...
    {
        "id": "bgp-m2s1-q13",
        "question": "Wie entsteht aus einem normalen Kundenpraefix ein VPN-Praefix fuer MP-BGP?",
        "question_en": "How is a normal customer prefix turned into a VPN prefix for MP-BGP?",
        "options": [
            "Indem der Route Distinguisher mit dem IPv4- oder IPv6-Praefix kombiniert wird",
            "Indem der AS_PATH an das Prefix angehaengt wird",
            "Indem das Prefix in eine Community umgewandelt wird",
            "Indem das Prefix immer in ein MPLS-Label uebersetzt wird"
        ],
        "options_en": [
            "By combining the route distinguisher with the IPv4 or IPv6 prefix",
            "By appending the AS_PATH to the prefix",
            "By converting the prefix into a community",
            "By always translating the prefix into an MPLS label"
        ],
        "correctIndex": 0,
        "explanation": "Vereinfacht gesagt entsteht `VPN-IPv4` oder `VPN-IPv6`, indem ein RD vor das eigentliche Kundenpraefix gesetzt wird.",
        "explanation_en": "Put simply, `VPN-IPv4` or `VPN-IPv6` is created by placing an RD in front of the actual customer prefix.",
        "extraInfo": "Genau so kann MP-BGP dieselben Kundenadressen in verschiedenen VPNs sauber auseinanderhalten.",
        "extraInfo_en": "That is exactly how MP-BGP can cleanly distinguish the same customer addresses in different VPNs.",
        "tip": "RD + Prefix = VPN-Prefix.",
        "tip_en": "RD + prefix = VPN prefix.",
        "tags": [
            "BGP",
            "VPN-IPv4",
            "VPN-IPv6",
    ...
    {
        "id": "bgp-m2s1-q14",
        "question": "Was muss auf der MP-BGP-Session zwischen PE-Routern zusaetzlich aktiviert sein, damit diese VPN-Praefixe ausgetauscht werden koennen?",
        "question_en": "What must additionally be enabled on the MP-BGP session between PE routers so that these VPN prefixes can be exchanged?",
        "options": [
            "Die passende VPN-IPv4- oder VPN-IPv6-Address-Family",
            "Nur eine hoehere Router-ID",
            "Nur ein anderer TCP-Port",
            "Nur ein Layer-2-Switch zwischen den Routern"
        ],
        "options_en": [
            "The corresponding VPN-IPv4 or VPN-IPv6 address family",
            "Only a higher router ID",
            "Only a different TCP port",
            "Only a Layer 2 switch between the routers"
        ],
        "correctIndex": 0,
        "explanation": "Ohne die passende VPN-Address-Family auf der MP-BGP-Session koennen die PE-Router diese VPN-Praefixe nicht austauschen.",
        "explanation_en": "Without the matching VPN address family on the MP-BGP session, the PE routers cannot exchange those VPN prefixes.",
        "extraInfo": "Der RD allein reicht also nicht; die Session muss die richtige Familie auch wirklich sprechen.",
        "extraInfo_en": "So the RD alone is not enough; the session must actually speak the right family.",
        "tip": "VPN-Prefixe brauchen die passende VPN-AF auf der Session.",
        "tip_en": "VPN prefixes need the matching VPN AF on the session.",
        "tags": [
            "BGP",
            "MP-BGP",
            "VPN-IPv4",
    ...
    {
        "id": "bgp-m2s3-q1",
        "question": "Welche Aussage zu Service-Labels in MP-BGP VPN-IPv4/IPv6 Updates ist am saubersten?",
        "question_en": "Which statement about service labels in MP-BGP VPN-IPv4/IPv6 updates is the most accurate?",
        "options": [
            "Die Updates tragen Label-Information fuer die VPN-Weiterleitung; auf SR OS kann dabei derselbe Service-Labelwert fuer mehrere Prefixe derselben VRF genutzt werden",
            "Das Service-Label ersetzt den Route Distinguisher im Control Plane NLRI",
            "Service-Labels existieren nur bei Layer-2-VPNs, nicht bei VPN-IPv4/IPv6",
            "Jeder Intermediate Router muss pro VPN-Prefix das Service-Label manuell konfigurieren"
        ],
        "options_en": [
            "The updates carry label information for VPN forwarding; on SR OS, the same service-label value can be reused for multiple prefixes in the same VRF",
            "The service label replaces the route distinguisher in the control-plane NLRI",
            "Service labels exist only for Layer-2 VPNs, not for VPN-IPv4/IPv6",
            "Every intermediate router must manually configure the service label for each VPN prefix"
        ],
        "correctIndex": 0,
        "explanation": "VPN-IPv4/VPN-IPv6 MP-BGP updates can carry the MPLS label information needed for the VPN route. On SR OS VPRN, label-per-VRF is common, so multiple prefixes of one VRF may share the same service label.",
        "explanation_en": "VPN-IPv4/VPN-IPv6 MP-BGP updates can carry the MPLS label information needed for the VPN route. On SR OS VPRN, label-per-VRF is common, so multiple prefixes of one VRF may share the same service label.",
        "extraInfo": "Das ist der wichtige Unterschied zwischen \"Label pro Route in der BGP-Info\" und \"gleicher Service-Labelwert fuer mehrere Prefixe derselben VRF in der Plattform-Implementierung\".",
        "extraInfo_en": "That is the important difference between \"a label carried with the BGP route\" and \"the same service-label value reused for multiple prefixes of the same VRF in the platform implementation\".",
        "tip": "MP-BGP traegt Label-Info mit. Die Plattform kann trotzdem label-per-VRF arbeiten.",
        "tip_en": "MP-BGP carries label information. The platform can still operate in label-per-VRF mode.",
        "tags": [
            "BGP",
            "MP-BGP",
            "Service Labels",
    ...
    {
        "id": "bgp-m2s3-q2",
        "question": "Welche Aussage zum Route Distinguisher in diesem Kontext ist korrekt?",
        "question_en": "Which statement about the route distinguisher in this context is correct?",
        "options": [
            "Der RD sorgt im Control Plane fuer eindeutige VPN-IPv4/IPv6-Routen; in der VRF/FIB der Data Plane wird mit den eigentlichen IP-Prefixen gearbeitet",
            "Der RD wird im Forwarding als zusaetzlicher Lookup-Schluessel vor jedes Kundendatenpaket gesetzt",
            "Der RD bestimmt, welche VPNs eine Route importieren duerfen",
            "Der RD ersetzt das Service-Label, sobald das Paket den ersten Border Router erreicht"
        ],
        "options_en": [
            "The RD makes VPN-IPv4/IPv6 routes unique in the control plane; the VRF/FIB in the data plane works with the actual IP prefixes",
            "The RD is used in forwarding as an additional lookup key placed in front of every customer data packet",
            "The RD decides which VPNs are allowed to import a route",
            "The RD replaces the service label once the packet reaches the first border router"
        ],
        "correctIndex": 0,
        "explanation": "Der RD macht Prefixe im MP-BGP eindeutig. Die eigentliche Weiterleitung in der VRF/FIB verwendet wieder die normalen IPv4/IPv6-Prefixe plus Tunnel-/Label-Kontext.",
        "explanation_en": "The RD makes prefixes unique in MP-BGP. Actual forwarding in the VRF/FIB uses the normal IPv4/IPv6 prefixes again plus tunnel/label context.",
        "extraInfo": "Import/Export-Mitgliedschaft wird durch RT gesteuert, nicht durch RD.",
        "extraInfo_en": "Import/export membership is controlled by RT, not by RD.",
        "tip": "RD = Eindeutigkeit im Control Plane, nicht Service-Mitgliedschaft im Data Plane.",
        "tip_en": "RD = uniqueness in the control plane, not service membership in the data plane.",
        "tags": [
            "BGP",
            "Route Distinguisher",
            "Control Plane",
    ...
    {
        "id": "bgp-m2s3-q3",
        "question": "Warum sind End-to-End-Transport-Tunnel ueber mehrere Regionen hinweg oft eine gut skalierende Option?",
        "question_en": "Why are end-to-end transport tunnels across multiple regions often a well-scaling option?",
        "options": [
            "Weil Service-Labels und Service-Parameter nur zwischen den PE-Routern ausgetauscht werden muessen und Zwischenrouter nicht service-spezifisch konfiguriert werden muessen",
            "Weil dann jeder Intermediate Router alle VPN-MACs und VPN-Prefixe lokal speichern muss",
            "Weil PE-Router dann kein MP-BGP oder tLDP mehr benoetigen",
            "Weil damit automatisch keine Transport-Labels mehr benoetigt werden"
        ],
        "options_en": [
            "Because service labels and service parameters only need to be exchanged between the PE routers and intermediate routers do not need service-specific configuration",
            "Because every intermediate router then has to locally store all VPN MACs and VPN prefixes",
            "Because PE routers no longer need MP-BGP or tLDP",
            "Because transport labels are then automatically no longer needed"
        ],
        "correctIndex": 0,
        "explanation": "Das Skalierungsziel ist: der Dienst bleibt eine PE-zu-PE-Sache. Die dazwischenliegenden Router transportieren nur Tunnelinformationen.",
        "explanation_en": "The scaling goal is that the service remains a PE-to-PE matter. Intermediate routers transport only tunnel information.",
        "extraInfo": "Je weniger service-spezifisches Wissen in der Mitte gebraucht wird, desto besser skaliert das Netz.",
        "extraInfo_en": "The less service-specific knowledge is required in the middle, the better the network scales.",
        "tip": "PEs kennen den Dienst, die Mitte kennt vor allem den Tunnel.",
        "tip_en": "PEs know the service, the middle mainly knows the tunnel.",
        "tags": [
            "BGP",
            "Inter-Region",
            "Transport Tunnel",
    ...
    {
        "id": "bgp-m2s3-q4",
        "question": "Wie baut man typischerweise einen End-to-End-Transport-Tunnel ueber mehrere Regionen, wenn LDP/RSVP/SR nicht einfach regionsuebergreifend signalisiert wird?",
        "question_en": "How do you typically build an end-to-end transport tunnel across multiple regions when LDP/RSVP/SR is not simply signaled across regions?",
        "options": [
            "Man stitcht mehrere kleinere Tunnels an den Regionsgrenzen zusammen, typischerweise mit BGP-gelernten Label-Prefixen",
            "Man ersetzt alle Tunnel durch GRE und braucht dann keinerlei Label mehr",
            "Man verteilt an allen Zwischenroutern die kompletten Service-Labels per tLDP",
            "Man deaktiviert MP-BGP und benutzt nur noch OSPF Area Summaries"
        ],
        "options_en": [
            "You stitch multiple smaller tunnels together at regional boundaries, typically using BGP-learned labeled prefixes",
            "You replace all tunnels with GRE and then no longer need any labels at all",
            "You distribute the full service labels to all intermediate routers using tLDP",
            "You disable MP-BGP and use only OSPF area summaries"
        ],
        "correctIndex": 0,
        "explanation": "Die Grundidee ist Stitching: innerhalb jeder Region kommt man mit einem intra-region Tunnel bis zum Border Router, und zwischen den Regionen wird ueber BGP-labeled reachability weitergereicht.",
        "explanation_en": "The basic idea is stitching: within each region an intra-region tunnel reaches the border router, and between regions BGP-labeled reachability carries the traffic further.",
        "extraInfo": "Dadurch muss das lokale IGP/MPLS-Signaling nicht einfach ungefiltert ueber alle Regionen erweitert werden.",
        "extraInfo_en": "This avoids blindly extending local IGP/MPLS signaling across all regions.",
        "tip": "Stitching = viele kurze Tunnel logisch zu einem langen Tunnel verbinden.",
        "tip_en": "Stitching = logically joining many short tunnels into one long tunnel.",
        "tags": [
            "BGP",
            "Inter-Region",
            "Tunnel Stitching",
    ...
    {
        "id": "bgp-m2s3-q5",
        "question": "Welche MP-BGP Address Family wird typischerweise genutzt, um transportrelevante Prefixe samt Label fuer solche End-to-End-Tunnel zu verteilen?",
        "question_en": "Which MP-BGP address family is typically used to distribute transport-relevant prefixes together with labels for such end-to-end tunnels?",
        "options": [
            "label-ipv4 oder label-ipv6",
            "vpn-ipv4 oder vpn-ipv6",
            "flow-ipv4 oder flow-ipv6",
            "mcast-ipv4 oder mcast-ipv6"
        ],
        "options_en": [
            "label-ipv4 or label-ipv6",
            "vpn-ipv4 or vpn-ipv6",
            "flow-ipv4 or flow-ipv6",
            "mcast-ipv4 or mcast-ipv6"
        ],
        "correctIndex": 0,
        "explanation": "Fuer das Transport-Tunnel-Stitching geht es um labeled unicast reachability, also typischerweise label-ipv4 oder label-ipv6.",
        "explanation_en": "For transport-tunnel stitching, the point is labeled unicast reachability, typically label-ipv4 or label-ipv6.",
        "extraInfo": "VPN-IPv4/VPN-IPv6 ist fuer die eigentlichen VPN-Routen, label-ipv4/ipv6 fuer den transportbezogenen labeled reachability-Teil.",
        "extraInfo_en": "VPN-IPv4/VPN-IPv6 is for the actual VPN routes; label-ipv4/ipv6 is for the transport-related labeled reachability part.",
        "tip": "Transport-Prefixe mit Label = label-ipv4/6.",
        "tip_en": "Transport prefixes with a label = label-ipv4/6.",
        "tags": [
            "BGP",
            "MP-BGP",
            "Label-IPv4",
    ...
    {
        "id": "bgp-m2s3-q6",
        "question": "Welche Adresse advertiset ein PE typischerweise, um den Tunnel-Endpunkt zu identifizieren?",
        "question_en": "Which address does a PE typically advertise to identify the tunnel endpoint?",
        "options": [
            "Die Loopback- bzw. System-IP-Adresse",
            "Die MAC-Adresse des Access-Ports",
            "Die VLAN-ID des Kundensubinterfaces",
            "Die Customer-ID des VPN-Service"
        ],
        "options_en": [
            "The loopback or system IP address",
            "The MAC address of the access port",
            "The VLAN ID of the customer subinterface",
            "The customer ID of the VPN service"
        ],
        "correctIndex": 0,
        "explanation": "Loopback- oder System-IPs sind stabil und unabhaengig von einzelnen Access-Links. Deshalb eignen sie sich gut als Tunnel-Endpunkte.",
        "explanation_en": "Loopback or system IPs are stable and independent of individual access links. That makes them good tunnel endpoints.",
        "extraInfo": "Das passt auch zur Next-Hop-Aufloesung im Tunnel-Table.",
        "extraInfo_en": "That also fits with next-hop resolution in the tunnel table.",
        "tip": "Tunnel-Endpunkte sollten stabil sein, deshalb meist Loopback/System-IP.",
        "tip_en": "Tunnel endpoints should be stable, so usually loopback/system IP.",
        "tags": [
            "BGP",
            "PE Router",
            "Loopback",
    ...
    {
        "id": "bgp-m2s3-q7",
        "question": "Wie sieht der Label-Gedanke im Data Plane innerhalb einer Region typischerweise aus?",
        "question_en": "What does the label logic in the data plane within one region typically look like?",
        "options": [
            "Ein inneres BGP-Label fuer den stitched Transport und ein aeusseres LDP/RSVP/SR-Label fuer den intra-region Weg",
            "Nur ein einziges Service-Label ohne jegliches Transport-Label",
            "Nur der Route Distinguisher und sonst keine Labels",
            "Ein aeusseres Service-Label und ein inneres OSPF-Area-Label"
        ],
        "options_en": [
            "An inner BGP label for the stitched transport and an outer LDP/RSVP/SR label for the intra-region path",
            "Only a single service label without any transport label",
            "Only the route distinguisher and no labels at all",
            "An outer service label and an inner OSPF area label"
        ],
        "correctIndex": 0,
        "explanation": "Innerhalb der Region bringt das aeussere LDP/RSVP/SR-Label das Paket bis zum Border Router. Danach bleibt das BGP-Label sichtbar und erlaubt das weitere Stitching.",
        "explanation_en": "Inside the region, the outer LDP/RSVP/SR label carries the packet to the border router. After that, the BGP label remains visible and enables further stitching.",
        "extraInfo": "Das ist die wichtige Trennung zwischen regionalem Transport und ueberregionalem stitched Label-Kontext.",
        "extraInfo_en": "This is the key separation between regional transport and the inter-regional stitched label context.",
        "tip": "Outer = Region, Inner = stitched Weiterweg.",
        "tip_en": "Outer = region, inner = stitched onward path.",
        "tags": [
            "BGP",
            "Data Plane",
            "LDP",
    ...
    {
        "id": "bgp-m2s3-q8",
        "question": "Was passiert typischerweise am Region Border Router, wenn das Paket die Region verlaesst?",
        "question_en": "What typically happens at the region border router when the packet leaves the region?",
        "options": [
            "Das aeussere intra-region Label wird entfernt, und das sichtbare BGP-Label wird fuer den naechsten MP-BGP-Hop weiterverwendet oder geswappt",
            "Der Route Distinguisher wird in das Datenpaket eingefuegt, damit die naechste Region den Kunden erkennt",
            "Alle Service-Labels werden geloescht und spaeter per ARP wieder aufgebaut",
            "Das Paket wird in ein natives Ethernet-Frame ohne Tunnel umgewandelt"
        ],
        "options_en": [
            "The outer intra-region label is removed, and the visible BGP label is reused or swapped for the next MP-BGP hop",
            "The route distinguisher is inserted into the data packet so the next region can identify the customer",
            "All service labels are deleted and later rebuilt using ARP",
            "The packet is converted into a native Ethernet frame without a tunnel"
        ],
        "correctIndex": 0,
        "explanation": "Am Border Router endet der regionale Transport. Das sichtbare BGP-Label uebernimmt dann die Rolle fuer den naechsten stitched Abschnitt und kann auf den vom naechsten BGP-Router advertised Wert geswappt werden.",
        "explanation_en": "At the border router, regional transport ends. The visible BGP label then takes over for the next stitched segment and may be swapped to the value advertised by the next BGP router.",
        "extraInfo": "Direkt benachbarte Border Router brauchen dafuer oft kein zusaetzliches inner-regionales LDP/RSVP/SR-Label.",
        "extraInfo_en": "Directly adjacent border routers often do not need an additional intra-regional LDP/RSVP/SR label for that hop.",
        "tip": "Am Border faellt das aeussere Regionslabel, das BGP-Label bleibt relevant.",
        "tip_en": "At the border, the outer regional label falls away, and the BGP label stays relevant.",
        "tags": [
            "BGP",
            "RBR",
            "Data Plane",
    ...
    {
        "id": "bgp-m2s3-q9",
        "question": "Welche Aussage zu Segment Routing in diesem Zusammenhang ist korrekt?",
        "question_en": "Which statement about Segment Routing in this context is correct?",
        "options": [
            "Bei Segment Routing kann der aeussere Transport-Stack auch aus mehr als einem Label bestehen",
            "Segment Routing ersetzt das innere BGP-Label immer vollstaendig",
            "Segment Routing kann nur mit BGP und nie mit OSPF oder IS-IS signalisiert werden",
            "Segment Routing ist nur fuer L2VPN, nicht fuer Transport-Tunnel nutzbar"
        ],
        "options_en": [
            "With Segment Routing, the outer transport stack may contain more than one label",
            "Segment Routing always fully replaces the inner BGP label",
            "Segment Routing can be signaled only with BGP and never with OSPF or IS-IS",
            "Segment Routing is usable only for L2VPN and not for transport tunnels"
        ],
        "correctIndex": 0,
        "explanation": "Im SR-Fall kann der Transport-Stack mehrere Labels/SIDs umfassen. Das aendert aber nicht die Grundidee von innerem BGP-Label plus aeusserem Transportkontext.",
        "explanation_en": "In the SR case, the transport stack may include multiple labels/SIDs. That does not change the core idea of an inner BGP label plus outer transport context.",
        "extraInfo": "SR fuegt Flexibilitaet beim Pfad hinzu, nicht den Wegfall des gesamten Label-Konzepts.",
        "extraInfo_en": "SR adds flexibility for the path, not the removal of the entire label concept.",
        "tip": "SR kann mehr Label im Outer Stack bedeuten.",
        "tip_en": "SR may mean more labels in the outer stack.",
        "tags": [
            "BGP",
            "Segment Routing",
            "Data Plane",
    ...
    {
        "id": "bgp-m2s3-q10",
        "question": "Was koennen die PE-Router austauschen, nachdem der End-to-End-Transport-Tunnel steht?",
        "question_en": "What can the PE routers exchange once the end-to-end transport tunnel is in place?",
        "options": [
            "Je nach Service unter anderem Service-Labels, L3-Prefixe oder L2-MAC-Informationen",
            "Nur noch TCP-Keepalives, aber keine dienstspezifischen Informationen mehr",
            "Ausschliesslich Customer-IDs, aber keine eigentlichen VPN-Datenstrukturen",
            "Nur OSPF Area-IDs, damit alle Zwischenrouter den Dienst lernen"
        ],
        "options_en": [
            "Depending on the service, items such as service labels, L3 prefixes, or L2 MAC information",
            "Only TCP keepalives, but no longer any service-specific information",
            "Only customer IDs, but no actual VPN data structures",
            "Only OSPF area IDs so that all intermediate routers learn the service"
        ],
        "correctIndex": 0,
        "explanation": "Sobald der Transportpfad klar ist, koennen die PEs die dienstspezifischen Informationen direkt austauschen. Die Mitte muss den einzelnen VPN-Service nicht verstehen.",
        "explanation_en": "Once the transport path is known, the PEs can exchange service-specific information directly. The middle of the network does not have to understand each individual VPN service.",
        "extraInfo": "Das ist der Kern der Skalierung: Transport und Dienstwissen bleiben getrennt.",
        "extraInfo_en": "That is the core of scalability: transport and service knowledge stay separated.",
        "tip": "Transport zuerst, Servicedetails danach.",
        "tip_en": "Transport first, service details afterwards.",
        "tags": [
            "BGP",
            "PE Router",
            "Service Labels",
    ...
    {
        "id": "bgp-m2s3-q11",
        "question": "Welches Protokoll wird klassisch genutzt, um bei traditionellen Layer-2-VPN-Services die Service-Labels auszuhandeln?",
        "question_en": "Which protocol is classically used to negotiate service labels for traditional Layer-2 VPN services?",
        "options": [
            "Targeted LDP",
            "ICMP",
            "RSTP",
        ...
        "correctIndex": 0,
        "explanation": "Targeted LDP ist der klassische Dienstsignalisierungsmechanismus fuer traditionelle L2VPN/Pseudowire-Services.",
        "explanation_en": "Targeted LDP is the classic service-signaling mechanism for traditional L2VPN/pseudowire services.",
        "extraInfo": "Fuer VPRN/VPN-IPv4/IPv6 spielt dagegen MP-BGP eine zentrale Rolle.",
        "extraInfo_en": "For VPRN/VPN-IPv4/IPv6, MP-BGP instead plays the central role.",
        "tip": "Traditionelles L2VPN-Service-Labeling = tLDP.",
        "tip_en": "Traditional L2VPN service-label signaling = tLDP.",
        "tags": [
            "BGP",
            "Targeted LDP",
            "L2VPN",
    ...
    {
        "id": "bgp-m2s3-q12",
        "question": "Welche Aussage zu Intra-Region-Tunneln ist im SR OS Kontext am treffendsten?",
        "question_en": "Which statement about intra-region tunnels is the most accurate in the SR OS context?",
        "options": [
            "Standardmaessig werden oft nur LDP-Tunnel zur Aufloesung von label-IP BGP Next-Hops genutzt; mit zusaetzlicher Konfiguration koennen weitere Tunneltypen beteiligt werden",
            "Intra-Region-Tunnel werden grundsaetzlich immer nur per GRE gebaut, nie mit MPLS",
            "Wenn mehrere Tunnel existieren, wird immer der mit der hoechsten numerischen Preference genommen",
            "Resolution any bedeutet, dass gar keine Tunnelauflosung mehr noetig ist"
        ],
        "options_en": [
            "By default, often only LDP tunnels are used to resolve label-IP BGP next hops; with additional configuration, other tunnel types can participate",
            "Intra-region tunnels are always built only with GRE and never with MPLS",
            "If multiple tunnels exist, the one with the highest numerical preference is always chosen",
            "Resolution any means no tunnel resolution is needed anymore"
        ],
        "correctIndex": 0,
        "explanation": "Im SR OS Kontext kann die Tunnelauflosung standardmaessig restriktiver sein. Mit zusaetzlichen Optionen wie resolution any werden weitere Tunneltypen in die Aufloesung einbezogen.",
        "explanation_en": "In the SR OS context, tunnel resolution can be more restrictive by default. With additional options such as resolution any, more tunnel types are considered for resolution.",
        "extraInfo": "Beim Tunnel Table Manager gilt typischerweise: kleinere Preference ist besser.",
        "extraInfo_en": "For the tunnel table manager, the usual rule is: lower preference is better.",
        "tip": "Resolution any erweitert die Auswahl, nicht den Verzicht auf Tunnel.",
        "tip_en": "Resolution any expands the choice, it does not remove the need for tunnels.",
        "tags": [
            "BGP",
            "Intra-Region",
            "LDP",
    ...
    {
        "id": "bgp-m2s3-q13",
        "question": "Welche Aussage zu Inter-Region-Transport-Tunneln ist falsch?",
        "question_en": "Which statement about inter-region transport tunnels is false?",
        "options": [
            "Jeder Intermediate Router muss die VPN-Service-Labels pro Dienst manuell kennen und konfigurieren",
            "BGP-labeled Reachability kann helfen, regionale Tunnel an den Grenzen zusammenzustitchen",
            "Zwischenrouter koennen service-unaware bleiben, was die Skalierbarkeit verbessert",
            "PE-Router koennen nach erfolgreichem Transportaufbau dienstspezifische Informationen direkt austauschen"
        ],
        "options_en": [
            "Every intermediate router must manually know and configure the VPN service labels per service",
            "BGP-labeled reachability can help stitch regional tunnels together at the boundaries",
            "Intermediate routers can remain service-unaware, which improves scalability",
            "After transport setup succeeds, PE routers can directly exchange service-specific information"
        ],
        "correctIndex": 0,
        "explanation": "Gerade das soll vermieden werden: service-spezifisches Wissen in jedem Zwischenrouter. Der inter-region Ansatz skaliert besser, wenn die Mitte nur den Transport versteht.",
        "explanation_en": "That is exactly what should be avoided: service-specific knowledge in every intermediate router. The inter-region approach scales better when the middle understands only transport.",
        "extraInfo": "Wenn die Mitte jeden Dienst kennen muss, skaliert das Netz schlechter.",
        "extraInfo_en": "If the middle has to know every service, the network scales worse.",
        "tip": "Falsch ist hier die Aussage, dass jeder Intermediate Router den Dienst konfigurieren muss.",
        "tip_en": "The false statement here is that every intermediate router must have the service configured.",
        "tags": [
            "BGP",
            "Inter-Region",
            "False Statement",
    ...
    {
        "id": "bgp-m2s1-q15",
        "question": "Welche Liste enthaelt nur typische MP-BGP Address Families oder Familienbeispiele aus deinem Stoff?",
        "question_en": "Which list contains only typical MP-BGP address families or family examples from your material?",
        "options": [
            "IPv4, IPv6, VPN-IPv4, VPN-IPv6, label-IPv4, label-IPv6, EVPN",
            "OSPF, IS-IS, ARP, STP, EVPN",
            "IPv4, IPv6, TCP, UDP, label-IPv4",
            "VPN-IPv4, VLAN, MAC table, EVPN, ICMP"
        ],
        "options_en": [
            "IPv4, IPv6, VPN-IPv4, VPN-IPv6, label-IPv4, label-IPv6, EVPN",
            "OSPF, IS-IS, ARP, STP, EVPN",
        ...
        "correctIndex": 0,
        "explanation": "MP-BGP erweitert BGP um verschiedene Address Families wie IPv4/IPv6 Unicast, VPN-IPv4/IPv6, labeled unicast und EVPN.",
        "explanation_en": "MP-BGP extends BGP with different address families such as IPv4/IPv6 unicast, VPN-IPv4/IPv6, labeled unicast, and EVPN.",
        "extraInfo": "Die anderen Antworten mischen Routing-Protokolle, Transport-Protokolle oder Datenstrukturen hinein, die keine MP-BGP AFI/SAFI-Familien sind.",
        "extraInfo_en": "The other answers mix in routing protocols, transport protocols, or data structures that are not MP-BGP AFI/SAFI families.",
        "tip": "Address family = welche Art Reachability BGP traegt.",
        "tip_en": "Address family = what kind of reachability BGP carries.",
        "tags": [
            "BGP",
            "MP-BGP",
            "Address Families",
    ...
    {
        "id": "bgp-m2s1-q16",
        "question": "Welche Rolle spielt MP-BGP bei VPRNs am treffendsten?",
        "question_en": "What best describes the role of MP-BGP for VPRNs?",
        "options": [
            "Es ermoeglicht den Austausch der VPN-Routing-Informationen verschiedener Kundenseiten zwischen den PE-Routern",
            "Es ersetzt alle Tunnel und macht MPLS oder GRE ueberfluessig",
            "Es dient nur dazu, CE-Router in Route Reflectors umzuwandeln",
            "Es wird nur fuer Access-Port-MTU-Berechnungen benoetigt"
        ],
        "options_en": [
            "It enables exchange of VPN routing information from different customer sites between PE routers",
            "It replaces all tunnels and makes MPLS or GRE unnecessary",
            "It is used only to turn CE routers into route reflectors",
            "It is needed only for access-port MTU calculations"
        ],
        "correctIndex": 0,
        "explanation": "VPRN ist ein verteilter L3-Dienst. Darum muessen die PE-Router die VPN-Routing-Informationen zwischen sich austauschen, und genau dafuer ist MP-BGP zentral.",
        "explanation_en": "VPRN is a distributed L3 service. Therefore the PE routers must exchange VPN routing information with each other, and that is exactly where MP-BGP is central.",
        "extraInfo": "Ohne Hilfsmittel wie Route Reflectors fuehrt das in groesseren Umgebungen oft zu Full-Mesh-Fragen.",
        "extraInfo_en": "Without helpers such as route reflectors, this often leads to full-mesh issues in larger environments.",
        "tip": "VPRN Routing-Infos zwischen PEs = MP-BGP-Aufgabe.",
        "tip_en": "VPRN routing information between PEs = an MP-BGP job.",
        "tags": [
            "BGP",
            "VPRN",
            "MP-BGP",
    ...
    {
        "id": "bgp-m2s1-q17",
        "question": "Welche zusaetzlichen Informationen sind bei VPN-IPv4/IPv6-Routen besonders wichtig?",
        "question_en": "Which additional information is especially important with VPN-IPv4/IPv6 routes?",
        "options": [
            "Route Targets fuer Import/Export und MPLS-Label-Information fuer die VPN-Weiterleitung",
            "Nur die Cluster-ID des Route Reflectors und die TCP-Fenstergroesse",
            "Nur die VLAN-ID des CE-Ports und der MAC-Age-Timer",
            "Nur der ARP-Cache des PE-Routers und der ICMP-Type"
        ],
        "options_en": [
            "Route targets for import/export and MPLS label information for VPN forwarding",
            "Only the route reflector cluster ID and the TCP window size",
            "Only the VLAN ID of the CE port and the MAC age timer",
            "Only the ARP cache of the PE router and the ICMP type"
        ],
        "correctIndex": 0,
        "explanation": "Bei VPN-Routen sind Route Targets fuer die Mitgliedschaft und Label-Information fuer die spaetere VPN-Weiterleitung zentral.",
        "explanation_en": "For VPN routes, route targets are central for membership and label information is central for later VPN forwarding.",
        "extraInfo": "Der RD sorgt fuer Eindeutigkeit, der RT fuer Import/Export, und das Label fuer die Weiterleitung.",
        "extraInfo_en": "The RD provides uniqueness, the RT handles import/export, and the label supports forwarding.",
        "tip": "RT = wer importieren darf, Label = wie weitergeleitet wird.",
        "tip_en": "RT = who may import, label = how forwarding happens.",
        "tags": [
            "BGP",
            "VPN-IPv4",
            "VPN-IPv6",
    ...
    {
        "id": "bgp-m2s1-q18",
        "question": "Welche Aussage zu MP-BGP und Full Mesh bei VPRN ist falsch?",
        "question_en": "Which statement about MP-BGP and full mesh for VPRN is false?",
        "options": [
            "Sobald MP-BGP fuer VPRN aktiviert ist, darf ein Route Reflector nicht mehr eingesetzt werden",
            "Ohne Skalierungsmechanismen fuehrt vollstaendiger iBGP-Austausch in groesseren Umgebungen typischerweise zu vielen Sessions",
            "Route Reflectors koennen die Zahl notwendiger iBGP-Sessions in MP-BGP-VPN-Umgebungen senken",
            "Die Grundidee von MP-BGP fuer VPRN bleibt auch bei Einsatz eines Route Reflectors dieselbe: PE-Router tauschen VPN-Routing-Informationen aus"
        ],
        "options_en": [
            "As soon as MP-BGP for VPRN is enabled, a route reflector may no longer be used",
            "Without scaling mechanisms, full iBGP exchange typically leads to many sessions in larger environments",
            "Route reflectors can reduce the number of required iBGP sessions in MP-BGP VPN environments",
            "The basic idea of MP-BGP for VPRN remains the same even when a route reflector is used: PE routers exchange VPN routing information"
        ],
        "correctIndex": 0,
        "explanation": "MP-BGP fuer VPRN verbietet Route Reflectors nicht. Im Gegenteil: Route Reflectors sind eine klassische Skalierungsantwort auf Full-Mesh-Probleme.",
        "explanation_en": "MP-BGP for VPRN does not forbid route reflectors. On the contrary, route reflectors are a classic scaling answer to full-mesh problems.",
        "extraInfo": "Der RR aendert die Topologie der Sessions, nicht die Grundfunktion von MP-BGP.",
        "extraInfo_en": "The RR changes session topology, not the core function of MP-BGP.",
        "tip": "RR = Skalierung fuer iBGP/MP-BGP, nicht Widerspruch dazu.",
        "tip_en": "RR = scaling for iBGP/MP-BGP, not the opposite of it.",
        "tags": [
            "BGP",
            "VPRN",
            "MP-BGP",
    ...
    {
        "id": "bgp-m3s1-q1",
        "question": "Warum verbessern Route Reflectors die iBGP-Skalierbarkeit?",
        "question_en": "Why do route reflectors improve iBGP scalability?",
        "options": [
            "Weil nicht mehr jeder PE mit jedem anderen PE voll vermascht peeren muss",
            "Weil sie TCP durch UDP ersetzen",
            "Weil sie MPLS-Labels im Core abschaffen",
            "Weil sie den AS_PATH fuer iBGP-Routen entfernen"
        ],
        "options_en": [
            "Because not every PE has to peer in a full mesh with every other PE anymore",
            "Because they replace TCP with UDP",
            "Because they remove MPLS labels from the core",
            "Because they remove AS_PATH from iBGP routes"
        ],
        "correctIndex": 0,
        "explanation": "Route Reflectors reduzieren die Zahl noetiger iBGP-Sessions, indem sie iBGP-gelernte Routen reflektieren duerfen.",
        "explanation_en": "Route reflectors reduce the number of required iBGP sessions by being allowed to reflect iBGP-learned routes.",
        "extraInfo": "Das adressiert direkt das Full-Mesh-Problem in groesseren PE-Umgebungen.",
        "extraInfo_en": "That directly addresses the full-mesh problem in larger PE environments.",
        "tip": "RR = weniger Sessions durch Reflection.",
        "tip_en": "RR = fewer sessions through reflection.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Scalability",
    ...
    {
        "id": "bgp-m3s1-q2",
        "question": "Was bedeutet \"reflecting\" im Route-Reflector-Kontext?",
        "question_en": "What does \"reflecting\" mean in the route-reflector context?",
        "options": [
            "Dass ein RR eine von einem iBGP-Peer gelernte Route an bestimmte andere iBGP-Peers weiteradvertised",
            "Dass ein RR alle eBGP-Routen in OSPF umwandelt",
            "Dass ein Client die Router-ID des RR spiegelt",
            "Dass ein RR nur noch selbst erzeugte lokale Routen sendet"
        ],
        "options_en": [
            "That an RR re-advertises a route learned from one iBGP peer to selected other iBGP peers",
            "That an RR converts all eBGP routes into OSPF",
            "That a client mirrors the router ID of the RR",
            "That an RR sends only locally originated routes from then on"
        ],
        "correctIndex": 0,
        "explanation": "Route Reflection ist genau das gezielte Weiteradvertisen von iBGP-gelernten Routen, obwohl die klassische Split-Horizon-Regel das sonst verbieten wuerde.",
        "explanation_en": "Route reflection is exactly the controlled re-advertisement of routes learned via iBGP, even though the classic split-horizon rule would otherwise forbid it.",
        "extraInfo": "Ohne Reflection bliebe das Full Mesh bestehen.",
        "extraInfo_en": "Without reflection, the full mesh would remain.",
        "tip": "Reflecting = iBGP-gelernt und von RR weitergegeben.",
        "tip_en": "Reflecting = learned via iBGP and re-advertised by the RR.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Reflection",
    ...
    {
        "id": "bgp-m3s1-q3",
        "question": "Welche Regel wird fuer ausgewaehlte iBGP-Peers durch Route Reflection praktisch aufgehoben?",
        "question_en": "Which rule is practically relaxed for selected iBGP peers by route reflection?",
        "options": [
            "Die iBGP-Split-Horizon-Regel fuer das Weiteradvertisen von iBGP-gelernten Routen",
            "Die eBGP-Regel, die den lokalen AS_PATH erweitert",
            "Die OSPF-SPF-Berechnung fuer Next-Hops",
            "Die MPLS-Labelvergabe im Dataplane"
        ],
        "options_en": [
            "The iBGP split-horizon rule for re-advertising routes learned via iBGP",
            "The eBGP rule that extends the local AS_PATH",
            "The OSPF SPF calculation for next hops",
            "The MPLS label allocation rule in the data plane"
        ],
        "correctIndex": 0,
        "explanation": "RFC 4456 erlaubt einem RR, iBGP-gelernte Routen an bestimmte andere iBGP-Peers zu reflektieren. Genau damit wird das klassische Split-Horizon-Hindernis fuer diese Topologie gelockert.",
        "explanation_en": "RFC 4456 allows an RR to reflect routes learned via iBGP to selected other iBGP peers. That is exactly how the classic split-horizon limitation is relaxed for this topology.",
        "extraInfo": "Nicht jede iBGP-Beziehung wird frei; die Reflection folgt klaren RR-Regeln.",
        "extraInfo_en": "Not every iBGP relationship becomes unrestricted; reflection follows clear RR rules.",
        "tip": "RR lockert Split Horizon kontrolliert, nicht beliebig.",
        "tip_en": "RR relaxes split horizon in a controlled way, not arbitrarily.",
        "tags": [
            "BGP",
            "Route Reflector",
            "RFC4456",
    ...
    {
        "id": "bgp-m3s1-q4",
        "question": "Wie sieht die Grundidee einer RR-Topologie mit vielen PE-Routern typischerweise aus?",
        "question_en": "What does the basic idea of an RR topology with many PE routers typically look like?",
        "options": [
            "Der RR sitzt logisch in der Mitte und hat iBGP-Sessions zu vielen PEs, die dadurch nicht mehr untereinander voll vermascht sein muessen",
            "Jeder CE baut eine eigene RR-Session zu jedem anderen CE auf",
            "Alle P-Router werden automatisch zu RR-Clients",
            "Ein RR ersetzt immer gleichzeitig alle Transport-Tunnel im Core"
        ],
        "options_en": [
            "The RR sits logically in the middle and has iBGP sessions to many PEs so that the PEs no longer have to be fully meshed with each other",
            "Each CE builds its own RR session to every other CE",
            "All P routers automatically become RR clients",
            "An RR always replaces all transport tunnels in the core at the same time"
        ],
        "correctIndex": 0,
        "explanation": "Die Session-Topologie wird sternfoermiger. Das spart iBGP-Peerings zwischen den vielen PEs.",
        "explanation_en": "The session topology becomes more hub-like. That saves iBGP peerings among the many PEs.",
        "extraInfo": "Der RR ersetzt Session-Komplexitaet, nicht den eigentlichen Transportpfad.",
        "extraInfo_en": "The RR replaces session complexity, not the actual transport path.",
        "tip": "RR = weniger Session-Linien zwischen den PEs.",
        "tip_en": "RR = fewer session lines between the PEs.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Topology",
    ...
    {
        "id": "bgp-m3s1-q5",
        "question": "Welche Aussage zu Route Reflectors ist falsch?",
        "question_en": "Which statement about route reflectors is false?",
        "options": [
            "Ein RR loest Skalierungsprobleme dadurch, dass alle Clients weiterhin voll vermascht untereinander peeren muessen",
            "Ein RR kann iBGP-gelernte Routen an bestimmte andere iBGP-Peers reflektieren",
            "Der Einsatz von RRs reduziert typischerweise die Zahl noetiger iBGP-Sessions im AS",
            "RRs sind in RFC 4456 beschrieben"
        ],
        "options_en": [
            "An RR solves scaling problems by requiring all clients to remain fully meshed with one another",
            "An RR can reflect routes learned via iBGP to selected other iBGP peers",
            "Using RRs typically reduces the number of required iBGP sessions in the AS",
            "RRs are described in RFC 4456"
        ],
        "correctIndex": 0,
        "explanation": "Gerade das Gegenteil ist der Zweck eines RR: Clients muessen nicht mehr alle untereinander full-meshed sein.",
        "explanation_en": "The exact opposite is the goal of an RR: clients no longer have to be full-meshed with one another.",
        "extraInfo": "Clients peeren prim?r mit dem RR, nicht mit jedem anderen Client.",
        "extraInfo_en": "Clients primarily peer with the RR, not with every other client.",
        "tip": "Falsch ist hier die Full-Mesh-Pflicht unter den Clients.",
        "tip_en": "The false statement here is the full-mesh requirement among clients.",
        "tags": [
            "BGP",
            "Route Reflector",
            "False Statement",
    ...
    {
        "id": "bgp-m3s1-q6",
        "question": "Warum tauchen Route Reflectors besonders in VPN-Umgebungen mit vielen PE-Routern auf?",
        "question_en": "Why do route reflectors appear especially in VPN environments with many PE routers?",
        "options": [
            "Weil viele PEs VPN-IPv4, VPN-IPv6 oder EVPN-Routen austauschen muessen und ein volles iBGP-Full-Mesh schnell unhandlich wird",
            "Weil EVPN ohne RR keine MAC-Adressen transportieren kann",
            "Weil MPLS-Labels nur durch RR-Speaker vergeben werden duerfen",
            "Weil ein RR die Rolle des CE-Routers uebernimmt"
        ],
        "options_en": [
            "Because many PEs must exchange VPN-IPv4, VPN-IPv6, or EVPN routes and a full iBGP mesh quickly becomes unwieldy",
            "Because EVPN cannot transport MAC addresses without an RR",
            "Because MPLS labels may only be allocated by RR speakers",
            "Because an RR takes over the role of the CE router"
        ],
        "correctIndex": 0,
        "explanation": "Der RR ist eine Antwort auf Session-Skalierung, nicht auf fehlende Tunnel oder fehlende MAC-Funktionen.",
        "explanation_en": "The RR is an answer to session scalability, not to missing tunnels or missing MAC functionality.",
        "extraInfo": "Gerade viele PE-Router und viele VPN-Routen machen den RR wertvoll.",
        "extraInfo_en": "Especially many PE routers and many VPN routes make the RR valuable.",
        "tip": "Viele PEs + viele VPN-Routen = RR wird interessant.",
        "tip_en": "Many PEs + many VPN routes = RR becomes interesting.",
        "tags": [
            "BGP",
            "Route Reflector",
            "VPN-IPv4",
    ...
    {
        "id": "bgp-m3s2-q1",
        "question": "In welche drei Kategorien lassen sich iBGP-Speaker im Route-Reflection-Umfeld typischerweise einteilen?",
        "question_en": "Into which three categories can iBGP speakers typically be grouped in a route-reflection environment?",
        "options": [
            "Route Reflectors, RR Clients und Regular iBGP Speakers als Non-Clients",
            "CEs, SAPs und SDPs",
            "Area Border Routers, ASBRs und PEs",
            "LDP Peers, RSVP Peers und OSPF Neighbors"
        ],
        "options_en": [
            "Route reflectors, RR clients, and regular iBGP speakers as non-clients",
            "CEs, SAPs, and SDPs",
            "Area border routers, ASBRs, and PEs",
            "LDP peers, RSVP peers, and OSPF neighbors"
        ],
        "correctIndex": 0,
        "explanation": "Im RR-Modell unterscheidet man typischerweise den RR selbst, seine Clients und normale iBGP-Non-Client-Peers.",
        "explanation_en": "In the RR model, one typically distinguishes the RR itself, its clients, and normal iBGP non-client peers.",
        "extraInfo": "Gerade diese Unterscheidung bestimmt spaeter, an wen der RR reflektieren darf.",
        "extraInfo_en": "This distinction determines later to whom the RR may reflect routes.",
        "tip": "RR-Modell merken: RR, Client, Non-Client.",
        "tip_en": "Remember the RR model: RR, client, non-client.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Cluster",
    ...
    {
        "id": "bgp-m3s2-q2",
        "question": "Welche Peering-Aussage zu RR-Clients und Non-Clients passt am besten?",
        "question_en": "Which peering statement about RR clients and non-clients fits best?",
        "options": [
            "Clients muessen nicht full-meshed untereinander sein; Non-Clients muessen untereinander und mit den RRs sauber vermascht bleiben",
            "Clients muessen immer voll vermascht sein; Non-Clients brauchen nur je einen RR-Link",
            "Weder Clients noch Non-Clients brauchen in einem RR-Design irgendein iBGP-Peering mehr",
            "Nur Clients duerfen untereinander peeren; RRs und Non-Clients duerfen nicht direkt verbunden werden"
        ],
        "options_en": [
            "Clients do not need to be full-meshed with each other; non-clients must remain properly meshed among themselves and with the RRs",
            "Clients must always be fully meshed; non-clients need only one RR link each",
            "Neither clients nor non-clients need any iBGP peering anymore in an RR design",
            "Only clients may peer with each other; RRs and non-clients must not be directly connected"
        ],
        "correctIndex": 0,
        "explanation": "Der Skalierungsgewinn kommt bei den Clients. Non-Clients bleiben aus Routing-Sicht normale iBGP-Speaker und muessen entsprechend behandelt werden.",
        "explanation_en": "The scaling gain comes from the clients. Non-clients remain normal iBGP speakers from a routing perspective and must be treated accordingly.",
        "extraInfo": "Clients werden entlastet, das komplette Non-Client-Mesh verschwindet aber nicht automatisch.",
        "extraInfo_en": "Clients are relieved, but the full non-client mesh does not disappear automatically.",
        "tip": "RR spart Full Mesh bei Clients, nicht blind bei allen.",
        "tip_en": "RR saves full mesh for clients, not blindly for everyone.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Clients",
    ...
    {
        "id": "bgp-m3s2-q3",
        "question": "Was ist ein Route-Reflection-Cluster am treffendsten?",
        "question_en": "What best describes a route-reflection cluster?",
        "options": [
            "Ein RR zusammen mit seinen Clients bildet logisch ein Cluster",
            "Alle P-Router derselben Region bilden automatisch ein Cluster",
            "Ein Cluster ist nur die Menge aller Route Targets in einem VPRN",
            "Ein Cluster ist gleichbedeutend mit einem einzelnen VPN-Prefix"
        ],
        "options_en": [
            "An RR together with its clients logically forms a cluster",
            "All P routers of the same region automatically form a cluster",
            "A cluster is only the set of all route targets in one VPRN",
            "A cluster is equivalent to a single VPN prefix"
        ],
        "correctIndex": 0,
        "explanation": "Das Cluster ist die route-reflection-bezogene Gruppierung um einen RR herum, nicht einfach eine Region oder ein einzelnes VPN-Prefix.",
        "explanation_en": "The cluster is the route-reflection-related grouping around one RR, not simply a region or a single VPN prefix.",
        "extraInfo": "Clients werden nicht als eigene Clusterknoten konfiguriert, sondern peeren zum RR.",
        "extraInfo_en": "Clients are not configured as their own cluster nodes; they peer to the RR.",
        "tip": "Cluster = RR plus seine Clients.",
        "tip_en": "Cluster = RR plus its clients.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Cluster",
    ...
    {
        "id": "bgp-m3s2-q4",
        "question": "Welche Aussage zur Cluster-ID ist korrekt?",
        "question_en": "Which statement about the cluster ID is correct?",
        "options": [
            "Sie ist ein 4-Byte-Identifier fuer das Cluster; in der Praxis wird haeufig die Router-ID des RR verwendet",
            "Sie ist immer identisch mit der AS-Nummer des Kunden",
            "Sie wird nur auf Clients konfiguriert, nie auf dem RR",
            "Sie darf in grossen Netzen absichtlich in allen Clustern gleich sein, damit Reflection leichter wird"
        ],
        "options_en": [
            "It is a 4-byte identifier for the cluster; in practice the RR router ID is often used",
            "It is always identical to the customer AS number",
            "It is configured only on clients, never on the RR",
            "In large networks it should intentionally be identical in all clusters so that reflection becomes easier"
        ],
        "correctIndex": 0,
        "explanation": "Die Cluster-ID identifiziert das Cluster. Typisch wird die Router-ID des RR verwendet oder bei redundanten RRs derselbe gemeinsame Cluster-Wert.",
        "explanation_en": "The cluster ID identifies the cluster. A common practice is to use the RR router ID or, with redundant RRs, the same shared cluster value.",
        "extraInfo": "Sie spielt spaeter auch bei der Schleifenvermeidung via CLUSTER_LIST eine Rolle.",
        "extraInfo_en": "It later also plays a role in loop prevention via CLUSTER_LIST.",
        "tip": "Cluster-ID = Kennung des RR-Clusters.",
        "tip_en": "Cluster ID = identity of the RR cluster.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Cluster ID",
    ...
    {
        "id": "bgp-m3s2-q5",
        "question": "Welche Aussage zur Konfiguration von RR und Clients ist am treffendsten?",
        "question_en": "Which statement about RR and client configuration is the most accurate?",
        "options": [
            "Der RR wird als Cluster-/RR-Knoten konfiguriert; die Clients benoetigen im Kern nur ihre iBGP-Sessions zum RR",
            "Clients muessen selbst jeweils eine eigene Cluster-ID erhalten, der RR nicht",
            "Nur Non-Clients duerfen iBGP-Sessions zum RR haben",
            "Clients muessen zwingend auch untereinander full-meshed sein, sonst funktioniert Reflection nicht"
        ],
        "options_en": [
            "The RR is configured as the cluster/RR node; the clients essentially only need their iBGP sessions to the RR",
            "Clients themselves each need their own cluster ID, while the RR does not",
            "Only non-clients may have iBGP sessions toward the RR",
            "Clients must also be fully meshed with each other, otherwise reflection does not work"
        ],
        "correctIndex": 0,
        "explanation": "Der RR traegt die route-reflection-spezifische Rolle. Die Clients sind aus dieser Sicht normale iBGP-Nachbarn des RR.",
        "explanation_en": "The RR carries the route-reflection-specific role. From this perspective, the clients are normal iBGP neighbors of the RR.",
        "extraInfo": "Gerade dadurch bleibt die Client-Seite vergleichsweise einfach.",
        "extraInfo_en": "That is exactly why the client side remains comparatively simple.",
        "tip": "RR konfiguriert die Reflection, Client peert zum RR.",
        "tip_en": "RR configures the reflection, client peers to the RR.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Clients",
    ...
    {
        "id": "bgp-m3s2-q6",
        "question": "Welche Routen advertiset ein RR typischerweise weiter?",
        "question_en": "Which routes does an RR typically advertise onward?",
        "options": [
            "Best und used routes",
            "Nur alle empfangenen routes aus dem RIB-IN ungeprueft",
            "Nur die Routen mit dem laengsten AS_PATH",
            "Nur lokale direkt angeschlossene Routen, nie iBGP-gelernte"
        ],
        "options_en": [
            "Best and used routes",
            "Only all received routes from the RIB-IN without any check",
            "Only the routes with the longest AS_PATH",
            "Only local directly connected routes and never routes learned via iBGP"
        ],
        "correctIndex": 0,
        "explanation": "Best bedeutet: die Route hat sich gegen andere Kandidaten desselben Prefixes in der BGP-Pfadwahl durchgesetzt. Used bedeutet: sie wurde auch vom RTM in die Routing-Tabelle uebernommen.",
        "explanation_en": "Best means the route won against other candidates for the same prefix in BGP path selection. Used means it was also installed in the routing table by the RTM.",
        "extraInfo": "Die Kombination verhindert, dass jeder Kandidat ungefiltert reflektiert wird.",
        "extraInfo_en": "The combination prevents every candidate from being reflected without filtering.",
        "tip": "RR spiegelt nicht blind alles, sondern typischerweise best und used.",
        "tip_en": "RR does not reflect everything blindly, but typically best and used.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Best Path",
    ...
    {
        "id": "bgp-m3s2-q7",
        "question": "Was bedeutet \"best\" im RR-Kontext am treffendsten?",
        "question_en": "What does \"best\" mean most accurately in the RR context?",
        "options": [
            "Die Route wurde unter mehreren Kandidaten desselben Prefixes anhand der BGP-Path-Selection ausgewaehlt",
            "Die Route hat die hoechste lokale TCP-Portnummer",
            "Die Route stammt immer von einem eBGP-Peer, unabhaengig von anderen Attributen",
            "Die Route hat automatisch den niedrigsten OSPF-Cost im ganzen Netzwerk und ist deshalb immer used"
        ],
        "options_en": [
            "The route was selected from multiple candidates for the same prefix using BGP path selection",
            "The route has the highest local TCP port number",
            "The route always comes from an eBGP peer regardless of other attributes",
            "The route automatically has the lowest OSPF cost in the entire network and is therefore always used"
        ],
        "correctIndex": 0,
        "explanation": "Best ist eine BGP-Auswahlentscheidung fuer einen Prefix. Das bedeutet noch nicht automatisch, dass die Route auch vom RTM genutzt wird.",
        "explanation_en": "Best is a BGP selection decision for a prefix. That does not automatically mean the route is also used by the RTM.",
        "extraInfo": "Genau deshalb unterscheidet man best und used.",
        "extraInfo_en": "That is exactly why best and used are distinguished.",
        "tip": "Best = im BGP gewonnen, Used = auch wirklich im Routing-Table.",
        "tip_en": "Best = won in BGP, Used = actually in the routing table.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Best Path",
    ...
    {
        "id": "bgp-m3s2-q8",
        "question": "Welche Aussage zu Non-Client-Peers in einem RR-Design ist falsch?",
        "question_en": "Which statement about non-client peers in an RR design is false?",
        "options": [
            "Non-Client-Peers koennen ihre iBGP-Sessions untereinander komplett weglassen, sobald ein RR existiert",
            "Non-Client-Peers bleiben aus RR-Sicht normale iBGP-Speaker",
            "In einem einfachen RFC4456-Design werden andere RRs oft als Non-Clients behandelt",
            "Non-Client-Peers muessen im Design sauber vermascht betrachtet werden"
        ],
        "options_en": [
            "Non-client peers can completely omit iBGP sessions among themselves as soon as an RR exists",
            "From the RR point of view, non-client peers remain normal iBGP speakers",
            "In a simple RFC4456 design, other RRs are often treated as non-clients",
            "Non-client peers must be treated as properly meshed in the design"
        ],
        "correctIndex": 0,
        "explanation": "Der RR spart das Full Mesh bei Clients. Non-Clients bleiben routingtechnisch normale iBGP-Speaker und duerfen deshalb nicht einfach blind entmesht werden.",
        "explanation_en": "The RR saves the full mesh for clients. Non-clients remain normal iBGP speakers from a routing perspective and therefore cannot simply be blindly de-meshed.",
        "extraInfo": "Gerade andere RRs werden in einfachen Designs oft als Non-Clients behandelt und deshalb sauber vermascht.",
        "extraInfo_en": "Other RRs in simple designs are often treated as non-clients and therefore properly meshed.",
        "tip": "Falsch ist hier das \"RR da = Non-Clients brauchen kein Mesh mehr\".",
        "tip_en": "The false part here is \"RR exists = non-clients no longer need a mesh\".",
        "tags": [
            "BGP",
            "Route Reflector",
            "Non-Clients",
    ...
    {
        "id": "bgp-m3s2-q9",
        "question": "Wenn der beste Pfad fuer einen Prefix auf einem RR von einem Non-Client kommt, wohin wird er nach RFC4456/Nokia-Grundlogik weitergegeben?",
        "question_en": "If the best path for a prefix on an RR is learned from a non-client, where is it propagated according to basic RFC4456/Nokia logic?",
        "options": [
            "Zu allen Clients und zu eBGP-Peers, aber nicht zu anderen Non-Clients",
            "Zu allen Clients, allen Non-Clients und allen eBGP-Peers",
            "Nur zu anderen Non-Clients, nie zu Clients",
            "Nur zurueck an den sendenden Non-Client"
        ],
        "options_en": [
            "To all clients and to eBGP peers, but not to other non-clients",
            "To all clients, all non-clients, and all eBGP peers",
            "Only to other non-clients and never to clients",
            "Only back to the sending non-client"
        ],
        "correctIndex": 0,
        "explanation": "RFC 4456 spiegelt eine vom non-client gelernte beste Route an Clients. Nokia SR OS propagiert sie zusaetzlich an eBGP peers, soweit Policy das erlaubt.",
        "explanation_en": "RFC 4456 reflects a best route learned from a non-client to clients. Nokia SR OS additionally propagates it to eBGP peers as allowed by policy.",
        "extraInfo": "Nicht zu anderen Non-Clients zu schicken, ist genau die klassische RR-Regel fuer non-client-gelernte Routen.",
        "extraInfo_en": "Not sending it to other non-clients is exactly the classic RR rule for routes learned from a non-client.",
        "tip": "Non-client gelernt = Clients ja, andere Non-Clients nein.",
        "tip_en": "Learned from a non-client = clients yes, other non-clients no.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Non-Client",
    ...
    {
        "id": "bgp-m3s2-q10",
        "question": "Wenn der beste Pfad auf einem RR von einem Client kommt, welche Weitergabe passt am besten?",
        "question_en": "If the best path on an RR is learned from a client, which propagation behavior fits best?",
        "options": [
            "Zu Clients, Non-Clients und eBGP-Peers, soweit Policy oder Split-Horizon das nicht unterdruecken",
            "Nur zu Non-Clients, aber nie zu anderen Clients",
            "Nur zu Clients desselben Clusters und nie zu eBGP-Peers",
            "Nur lokal in das RIB, aber gar nicht weiter"
        ],
        "options_en": [
            "To clients, non-clients, and eBGP peers, unless policy or split horizon suppresses it",
            "Only to non-clients and never to other clients",
            "Only to clients of the same cluster and never to eBGP peers",
            "Only into the local RIB and not onward at all"
        ],
        "correctIndex": 0,
        "explanation": "Eine client-gelernte beste Route ist der klassische Fall fuer breite Reflection: RR darf sie an andere Clients und Non-Clients weitergeben und auf SR OS auch an eBGP peers, wenn Policy das erlaubt.",
        "explanation_en": "A best route learned from a client is the classic case for broad reflection: the RR may send it to other clients and non-clients and on SR OS also to eBGP peers if policy allows it.",
        "extraInfo": "Split-Horizon oder spezielle Policy kann das Rueckadvertising zum sendenden Peer zusaetzlich einschraenken.",
        "extraInfo_en": "Split horizon or specific policy can additionally limit re-advertisement back to the sending peer.",
        "tip": "Client gelernt = breit reflektierbar.",
        "tip_en": "Learned from a client = broadly reflectable.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Client",
    ...
    {
        "id": "bgp-m3s2-q11",
        "question": "Was passiert auf einem RR typischerweise mit einer besten Route, die von einem eBGP-Peer gelernt wurde?",
        "question_en": "What typically happens on an RR with a best route learned from an eBGP peer?",
        "options": [
            "Sie kann zu Clients, Non-Clients und anderen eBGP-Peers propagiert werden, soweit Policy das erlaubt",
            "Sie darf wegen RFC4456 nie zu iBGP-Peers propagiert werden",
            "Sie wird zuerst in OSPF umgewandelt und dann reflektiert",
            "Sie wird immer nur lokal genutzt und nie advertised"
        ],
        "options_en": [
            "It can be propagated to clients, non-clients, and other eBGP peers as allowed by policy",
            "RFC4456 forbids it from ever being propagated to iBGP peers",
            "It is first converted into OSPF and then reflected",
            "It is always used only locally and never advertised"
        ],
        "correctIndex": 0,
        "explanation": "Eine vom eBGP-Peer gelernte beste Route kann im RR-Design an iBGP peers und andere eBGP peers weitergehen. Policy entscheidet dabei mit.",
        "explanation_en": "A best route learned from an eBGP peer can be propagated to iBGP peers and other eBGP peers in an RR design. Policy also participates in that decision.",
        "extraInfo": "Fuer eBGP-gelernte oder lokal erzeugte Routen werden ORIGINATOR_ID und CLUSTER_LIST dabei nicht neu hinzugefuegt.",
        "extraInfo_en": "For eBGP-learned or locally originated routes, ORIGINATOR_ID and CLUSTER_LIST are not newly added in this process.",
        "tip": "eBGP gelernt = kann breit weitergehen, wenn Policy es zulaesst.",
        "tip_en": "Learned from eBGP = may be broadly propagated if policy allows it.",
        "tags": [
            "BGP",
            "Route Reflector",
            "eBGP",
    ...
    {
        "id": "bgp-m3s2-q12",
        "question": "Welche Aussage zur eBGP-Weitergabe auf einem Nokia 7750 RR ist am treffendsten?",
        "question_en": "Which statement about eBGP propagation on a Nokia 7750 RR is the most accurate?",
        "options": [
            "Sie ist in der Praxis weiterhin von Export-Policy abhaengig; ohne erlaubende Policy wird nicht einfach blind exportiert",
            "Sobald ein RR aktiv ist, werden alle besten Routen automatisch an jeden eBGP-Peer exportiert",
            "Ein RR darf grundsaetzlich nie an eBGP-Peers advertisen",
            "eBGP-Weitergabe ist nur moeglich, wenn der empfangene Pfad von einem Non-Client stammt"
        ],
        "options_en": [
            "In practice it still depends on export policy; without an allowing policy routes are not blindly exported",
            "As soon as an RR is active, all best routes are automatically exported to every eBGP peer",
            "An RR may never advertise to eBGP peers at all",
            "eBGP propagation is possible only if the received path came from a non-client"
        ],
        "correctIndex": 0,
        "explanation": "Auf SR OS bleibt die Export-Policy massgeblich. Die RR-Logik oeffnet die moegliche Weitergabe, ersetzt aber nicht die Policy-Kontrolle.",
        "explanation_en": "On SR OS, export policy remains decisive. RR logic opens the possibility of propagation, but does not replace policy control.",
        "extraInfo": "Das verhindert, dass RR-Verhalten mit generellem \"alles nach eBGP\" verwechselt wird.",
        "extraInfo_en": "This prevents RR behavior from being confused with a generic \"everything to eBGP\" rule.",
        "tip": "RR-Logik und Export-Policy sind zwei verschiedene Ebenen.",
        "tip_en": "RR logic and export policy are two different layers.",
        "tags": [
            "BGP",
            "Route Reflector",
            "eBGP",
    ...
    {
        "id": "bgp-m3s2-q13",
        "question": "Welche Nokia-SR-OS-Aussage zum Split-Horizon-Verhalten ist korrekt?",
        "question_en": "Which Nokia SR OS statement about split-horizon behavior is correct?",
        "options": [
            "Fuer von Non-Clients gelernte Routen wirkt dieses Split-Horizon-Verhalten immer; fuer Clients oder eBGP-Peers muss zusaetzlich split-horizon konfiguriert werden",
            "Split-Horizon ist auf SR OS fuer alle Peer-Typen immer voll aktiv und kann nicht beeinflusst werden",
            "Split-Horizon gilt nur fuer eBGP, nie fuer iBGP",
            "Split-Horizon ist per Default fuer alle Peer-Typen aktiv und muss bei Bedarf global deaktiviert werden"
        ],
        "options_en": [
            "For routes learned from non-clients, this split-horizon behavior always applies; for clients or eBGP peers, split-horizon must additionally be configured",
            "On SR OS, split horizon is always fully active for all peer types and cannot be influenced",
            "Split horizon applies only to eBGP and never to iBGP",
            "Split horizon is active by default for all peer types and must be disabled globally when needed"
        ],
        "correctIndex": 0,
        "explanation": "SR OS hat hier eine wichtige Nuance: das Non-Client-Verhalten ist fest verdrahtet. Fuer Clients, confed-eBGP oder eBGP braucht es zusaetzlich den split-horizon BGP-Command.",
        "explanation_en": "SR OS has an important nuance here: the non-client behavior is hard-wired. For clients, confed-eBGP, or eBGP, the BGP split-horizon command is additionally required.",
        "extraInfo": "Genau deshalb kann auf 7750 ohne extra Split-Horizon eine beste Route an den sendenden Client oder eBGP-Peer zurueckgehen.",
        "extraInfo_en": "That is exactly why on a 7750, without extra split horizon, a best route can be advertised back to the sending client or eBGP peer.",
        "tip": "Non-Client-Split-Horizon ist speziell; Client/eBGP braucht extra Konfiguration.",
        "tip_en": "Non-client split horizon is special; client/eBGP needs extra configuration.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Split Horizon",
    ...
    {
        "id": "bgp-m3s2-q14",
        "question": "Welche Aussage zum Rueckadvertising an denselben Peer auf einem 7750 ist korrekt?",
        "question_en": "Which statement about re-advertising back to the same peer on a 7750 is correct?",
        "options": [
            "Ohne zusaetzliches Split-Horizon kann eine beste Route von einem eBGP-Peer oder RR-Client grundsaetzlich auch an denselben Peer zurueckadvertised werden",
            "SR OS verhindert bei jedem Peer-Typ immer automatisch jede Rueckadvertisement-Situation",
            "Rueckadvertising ist nur bei OSPF moeglich, nicht bei BGP",
            "Rueckadvertising macht AS_PATH-Loop-Erkennung komplett ueberfluessig"
        ],
        "options_en": [
            "Without additional split horizon, a best route from an eBGP peer or RR client can in principle be re-advertised back to the same peer",
            "SR OS always automatically prevents every re-advertisement situation for every peer type",
            "Re-advertisement is possible only in OSPF, not in BGP",
            "Re-advertisement makes AS_PATH loop detection completely unnecessary"
        ],
        "correctIndex": 0,
        "explanation": "Nokia dokumentiert genau dieses Verhalten: ohne split-horizon wird kein Aufwand betrieben, um die beste Route vom sendenden Peer fernzuhalten. Bei eBGP schuetzt dann typischerweise AS_PATH-Loop-Erkennung.",
        "explanation_en": "Nokia documents exactly this behavior: without split horizon, no effort is made to keep the best route away from the sending peer. In eBGP, AS_PATH loop detection then typically provides protection.",
        "extraInfo": "Will man das unterbinden, kann man export policy oder den split-horizon command einsetzen.",
        "extraInfo_en": "If you want to suppress it, you can use export policy or the split-horizon command.",
        "tip": "Rueckadvertising ist auf SR OS eine Policy-/Split-Horizon-Frage.",
        "tip_en": "Re-advertisement on SR OS is a policy/split-horizon question.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Split Horizon",
    ...
    {
        "id": "bgp-m3s2-q15",
        "question": "Welche Werkzeuge nennt dein Stoff, um unerwuenschtes Rueckadvertising zu unterdruecken?",
        "question_en": "Which tools does your material mention to suppress unwanted re-advertisement?",
        "options": [
            "Export-Policies pro Nachbar und den BGP split-horizon command global, pro Group oder pro Neighbor",
            "Nur ARP-Timeout und MAC-Aging",
            "Nur OSPF passive-interface",
            "Nur das Absenken des LOCAL_PREF auf 0"
        ],
        "options_en": [
            "Export policies per neighbor and the BGP split-horizon command globally, per group, or per neighbor",
            "Only ARP timeout and MAC aging",
            "Only OSPF passive-interface",
            "Only lowering LOCAL_PREF to 0"
        ],
        "correctIndex": 0,
        "explanation": "Nokia nennt hier genau diese beiden Hebel: Policy-basiert selektiv oder split-horizon als breiteres Verhaltensmerkmal.",
        "explanation_en": "Nokia calls out exactly these two levers here: selectively by policy or more broadly through split-horizon behavior.",
        "extraInfo": "Mit Policy kann man feiner pro Peer unterscheiden; split-horizon ist der grobere Mechanismus.",
        "extraInfo_en": "With policy, you can differentiate more finely per peer; split horizon is the broader mechanism.",
        "tip": "Policy = fein, split-horizon = grober.",
        "tip_en": "Policy = fine-grained, split horizon = broader.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Export Policy",
    ...
    {
        "id": "bgp-m3s2-q16",
        "question": "Welche Aussage zu ORIGINATOR_ID und CLUSTER_LIST passt am besten?",
        "question_en": "Which statement about ORIGINATOR_ID and CLUSTER_LIST fits best?",
        "options": [
            "Sie werden vor allem bei reflektierten iBGP-Routen genutzt, um Schleifen im RR-Umfeld zu erkennen und zu vermeiden",
            "Sie ersetzen in reflected routes immer den AS_PATH",
            "Sie werden bei jeder eBGP-gelernten Route zwingend neu hinzugefuegt",
            "Sie dienen nur dazu, die Tunnel-Preference fuer LDP und RSVP zu steuern"
        ],
        "options_en": [
            "They are mainly used on reflected iBGP routes to detect and avoid loops in the RR environment",
            "They always replace AS_PATH on reflected routes",
            "They must be newly added on every eBGP-learned route",
            "They are used only to control tunnel preference for LDP and RSVP"
        ],
        "correctIndex": 0,
        "explanation": "ORIGINATOR_ID und CLUSTER_LIST sind die klassischen RR-Loop-Avoidance-Attribute aus RFC 4456.",
        "explanation_en": "ORIGINATOR_ID and CLUSTER_LIST are the classic RR loop-avoidance attributes from RFC 4456.",
        "extraInfo": "Bei eBGP-gelernten oder lokal erzeugten Routen werden sie in der Grundlogik gerade nicht neu hinzugefuegt.",
        "extraInfo_en": "For eBGP-learned or locally originated routes, they are specifically not newly added in the basic logic.",
        "tip": "RR-Loops erkennen = ORIGINATOR_ID und CLUSTER_LIST.",
        "tip_en": "Recognize RR loops = ORIGINATOR_ID and CLUSTER_LIST.",
        "tags": [
            "BGP",
            "Route Reflector",
            "ORIGINATOR_ID",
    ...
    {
        "id": "bgp-m3s3-q1",
        "question": "Warum sind ORIGINATOR_ID und CLUSTER_LIST in einem RR-Umfeld wichtig?",
        "question_en": "Why are ORIGINATOR_ID and CLUSTER_LIST important in an RR environment?",
        "options": [
            "Weil die normale iBGP Split-Horizon-Regel gelockert ist und AS_PATH bei iBGP-Updates nicht mitwaechst",
            "Weil eBGP in einem RR-Umfeld grundsaetzlich deaktiviert wird",
            "Weil sie die TCP-Session fuer BGP ersetzen",
            "Weil sie NEXT_HOP automatisch aufloesen"
        ],
        "options_en": [
            "Because the normal iBGP split-horizon rule is relaxed and AS_PATH does not grow on iBGP updates",
            "Because eBGP is fundamentally disabled in an RR environment",
            "Because they replace the TCP session for BGP",
            "Because they automatically resolve NEXT_HOP"
        ],
        "correctIndex": 0,
        "explanation": "Bei Route Reflection wird die iBGP-Split-Horizon-Regel kontrolliert gelockert. Da AS_PATH bei iBGP-Weitergabe nicht veraendert wird, braucht man andere Marker fuer die Schleifenerkennung.",
        "explanation_en": "Route reflection deliberately relaxes the iBGP split-horizon rule. Because AS_PATH is not changed on iBGP propagation, other markers are needed for loop detection.",
        "extraInfo": "Genau dafuer wurden ORIGINATOR_ID und CLUSTER_LIST in RFC 4456 definiert.",
        "extraInfo_en": "That is exactly why ORIGINATOR_ID and CLUSTER_LIST were defined in RFC 4456.",
        "tip": "AS_PATH hilft bei normalen AS-Schleifen, aber nicht gut bei RR-internen iBGP-Reflections.",
        "tip_en": "AS_PATH helps with normal AS loops, but not well with RR-internal iBGP reflections.",
        "tags": [
            "BGP",
            "Route Reflector",
            "ORIGINATOR_ID",
    ...
    {
        "id": "bgp-m3s3-q2",
        "question": "Welche Aussage zu ORIGINATOR_ID ist korrekt?",
        "question_en": "Which statement about ORIGINATOR_ID is correct?",
        "options": [
            "Der erste RR, der eine iBGP-Route reflektiert, setzt ORIGINATOR_ID auf die Router-ID des urspruenglichen iBGP-Originators",
            "Jeder RR ersetzt ORIGINATOR_ID bei jeder Reflection durch seine eigene Cluster-ID",
            "ORIGINATOR_ID wird nur bei eBGP-Updates gesetzt",
            "ORIGINATOR_ID ist ein transitive Attribut und geht immer ueber AS-Grenzen weiter"
        ],
        "options_en": [
            "The first RR that reflects an iBGP route sets ORIGINATOR_ID to the router ID of the original iBGP originator",
            "Every RR replaces ORIGINATOR_ID on each reflection with its own cluster ID",
            "ORIGINATOR_ID is set only on eBGP updates",
            "ORIGINATOR_ID is a transitive attribute and always continues across AS boundaries"
        ],
        "correctIndex": 0,
        "explanation": "ORIGINATOR_ID markiert den urspruenglichen iBGP-Speaker, dessen Route reflektiert wurde. Ist der Wert einmal gesetzt, wird er nicht neu geschrieben.",
        "explanation_en": "ORIGINATOR_ID marks the original iBGP speaker whose route was reflected. Once set, it is not rewritten.",
        "extraInfo": "Damit kann ein Router spaeter erkennen, ob seine eigene Route zu ihm zurueckgekommen ist.",
        "extraInfo_en": "This lets a router later detect whether its own route has come back to it.",
        "tip": "ORIGINATOR_ID zeigt auf den Ursprung, nicht auf den letzten RR.",
        "tip_en": "ORIGINATOR_ID points to the origin, not to the last RR.",
        "tags": [
            "BGP",
            "Route Reflector",
            "ORIGINATOR_ID"
    ...
    {
        "id": "bgp-m3s3-q3",
        "question": "Wann ignoriert ein Router eine reflektierte Route wegen ORIGINATOR_ID?",
        "question_en": "When does a router ignore a reflected route because of ORIGINATOR_ID?",
        "options": [
            "Wenn ORIGINATOR_ID der eigenen Router-ID entspricht",
            "Wenn ORIGINATOR_ID kleiner als die lokale Cluster-ID ist",
            "Wenn ORIGINATOR_ID aus einem anderen AS stammt",
            "Wenn ORIGINATOR_ID nicht zusammen mit MED gesendet wurde"
        ],
        "options_en": [
            "When ORIGINATOR_ID matches the local router ID",
            "When ORIGINATOR_ID is smaller than the local cluster ID",
            "When ORIGINATOR_ID came from another AS",
            "When ORIGINATOR_ID was not sent together with MED"
        ],
        "correctIndex": 0,
        "explanation": "Sieht ein Router seine eigene Router-ID im ORIGINATOR_ID-Feld, erkennt er, dass die Route von ihm selbst stammt und verwirft sie.",
        "explanation_en": "If a router sees its own router ID in ORIGINATOR_ID, it recognizes that the route originally came from itself and discards it.",
        "extraInfo": "Das ist die direkte Schleifenerkennung ueber den Ursprungs-Router.",
        "extraInfo_en": "This is direct loop detection via the original router identity.",
        "tip": "Eigene ID im ORIGINATOR_ID = verwerfen.",
        "tip_en": "Own ID in ORIGINATOR_ID = discard.",
        "tags": [
            "BGP",
            "Route Reflector",
            "ORIGINATOR_ID",
    ...
    {
        "id": "bgp-m3s3-q4",
        "question": "Welche Aussage zur CLUSTER_LIST passt am besten?",
        "question_en": "Which statement about CLUSTER_LIST fits best?",
        "options": [
            "Sie ist eine Sequenz von Cluster-IDs, und ein RR fuegt beim Reflecten seine lokale Cluster-ID vorne hinzu",
            "Sie enthaelt nur AS-Nummern und wird wie AS_PATH behandelt",
            "Sie wird ausschliesslich von Clients gesetzt",
            "Sie ersetzt NEXT_HOP innerhalb eines Clusters"
        ],
        "options_en": [
            "It is a sequence of cluster IDs, and an RR prepends its local cluster ID when reflecting",
            "It contains only AS numbers and is handled like AS_PATH",
            "It is set only by clients",
            "It replaces NEXT_HOP inside a cluster"
        ],
        "correctIndex": 0,
        "explanation": "CLUSTER_LIST beschreibt den Reflection-Pfad ueber RR-Cluster. Ein RR praefixt seine lokale Cluster-ID, damit nachfolgende RRs Schleifen erkennen koennen.",
        "explanation_en": "CLUSTER_LIST describes the reflection path across RR clusters. An RR prepends its local cluster ID so downstream RRs can detect loops.",
        "extraInfo": "Die Liste ist variabel lang, aber sie ist kein AS-Pfad und kein Cross-AS-Transportmechanismus.",
        "extraInfo_en": "The list has variable length, but it is not an AS path and not a cross-AS transport mechanism.",
        "tip": "Cluster-ID wird vorne angehaengt, nicht als Ersatz fuer AS_PATH genutzt.",
        "tip_en": "The cluster ID is added at the front, not used as a replacement for AS_PATH.",
        "tags": [
            "BGP",
            "Route Reflector",
            "CLUSTER_LIST"
    ...
    {
        "id": "bgp-m3s3-q5",
        "question": "Wann verwirft ein RR eine Route wegen CLUSTER_LIST?",
        "question_en": "When does an RR discard a route because of CLUSTER_LIST?",
        "options": [
            "Wenn die lokale Cluster-ID bereits in der CLUSTER_LIST enthalten ist",
            "Wenn die CLUSTER_LIST laenger als der AS_PATH ist",
            "Wenn die CLUSTER_LIST fehlt",
            "Wenn die CLUSTER_LIST mehr als einen Wert enthaelt"
        ],
        "options_en": [
            "When the local cluster ID is already present in CLUSTER_LIST",
            "When CLUSTER_LIST is longer than the AS_PATH",
            "When CLUSTER_LIST is missing",
            "When CLUSTER_LIST contains more than one value"
        ],
        "correctIndex": 0,
        "explanation": "Taucht die eigene Cluster-ID bereits in der CLUSTER_LIST auf, hat die Route das lokale Cluster schon einmal passiert und wird verworfen.",
        "explanation_en": "If the local cluster ID is already present in CLUSTER_LIST, the route has already passed through the local cluster and is discarded.",
        "extraInfo": "Das ist die Schleifenerkennung ueber Clustergrenzen innerhalb desselben AS.",
        "extraInfo_en": "This is loop detection across clusters within the same AS.",
        "tip": "Eigene Cluster-ID in der Liste = Schleifenverdacht.",
        "tip_en": "Own cluster ID in the list = loop suspicion.",
        "tags": [
            "BGP",
            "Route Reflector",
            "CLUSTER_LIST",
    ...
    },
    {
        ...
        "options": [
            "CLUSTER_LIST wird fuer die Schleifenerkennung zwischen verschiedenen AS genutzt wie AS_PATH",
            "ORIGINATOR_ID und CLUSTER_LIST sind optional non-transitive",
            "AS_PATH wird bei iBGP-Updates nicht angepasst",
            "ORIGINATOR_ID und CLUSTER_LIST sind nur im RR-Umfeld relevant"
        ],
        "options_en": [
            "CLUSTER_LIST is used for loop detection between different ASes like AS_PATH",
            "ORIGINATOR_ID and CLUSTER_LIST are optional non-transitive",
            "AS_PATH is not changed on iBGP updates",
            "ORIGINATOR_ID and CLUSTER_LIST are relevant only in an RR environment"
        ],
        "correctIndex": 0,
        "explanation": "CLUSTER_LIST ist kein AS-uebergreifendes Attribut wie AS_PATH. Es dient der Schleifenerkennung im Route-Reflection-Design innerhalb eines AS.",
        "explanation_en": "CLUSTER_LIST is not an inter-AS attribute like AS_PATH. It is used for loop detection in route reflection within a single AS.",
        "extraInfo": "Das war in deinen Notizen der wichtigste fachliche Stolperpunkt.",
        "extraInfo_en": "This was the main technical pitfall in your notes.",
        "tip": "AS_PATH = AS-Ebene, CLUSTER_LIST = RR-Cluster-Ebene.",
        "tip_en": "AS_PATH = AS level, CLUSTER_LIST = RR cluster level.",
        "tags": [
            "BGP",
            "Route Reflector",
            "CLUSTER_LIST",
    ...
    {
        "id": "bgp-m3s4-q1",
        "question": "Warum kann ein einzelner Route Reflector ein Single Point of Failure sein?",
        "question_en": "Why can a single route reflector become a single point of failure?",
        "options": [
            "Weil reine RR-Clients ohne RR-Ausfall keine neuen iBGP-Updates mehr von dort erhalten",
            "Weil ein RR nie mehr als einen Client gleichzeitig bedienen darf",
            "Weil ein RR keine TCP-Sessions redundant halten kann",
            "Weil eBGP auf einem RR technisch verboten ist"
        ],
        "options_en": [
            "Because pure RR clients stop receiving new iBGP updates from that path when the RR fails",
            "Because an RR may never serve more than one client at a time",
            "Because an RR cannot keep TCP sessions redundantly",
            "Because eBGP is technically forbidden on an RR"
        ],
        "correctIndex": 0,
        "explanation": "Wenn Clients nur an einem RR haengen, verlieren sie bei dessen Ausfall ihren zentralen iBGP-Verteiler und damit neue Steuerungsinformationen.",
        "explanation_en": "If clients rely on only one RR, they lose their central iBGP distributor and therefore new control-plane information when it fails.",
        "extraInfo": "Darum werden RR oft redundant gebaut.",
        "extraInfo_en": "That is why RRs are often deployed redundantly.",
        "tip": "Nicht Datenebene, sondern Control-Plane-Verlust ist das Kernproblem.",
        "tip_en": "The main issue is control-plane loss, not the data plane itself.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Redundancy",
    ...
    {
        "id": "bgp-m3s4-q2",
        "question": "Wie wird RR-Redundanz innerhalb eines Clusters typischerweise aufgebaut?",
        "question_en": "How is RR redundancy typically built within a cluster?",
        "options": [
            "Mehrere RRs im selben Cluster, full-meshed untereinander und mit derselben Cluster-ID",
            "Genau ein RR pro Cluster und alle Clients full-meshed untereinander",
            "Mehrere RRs mit unterschiedlichen Cluster-IDs im selben Cluster",
            "Ein RR und alle Clients nur per eBGP"
        ],
        "options_en": [
            "Multiple RRs in the same cluster, full-meshed to each other and using the same cluster ID",
            "Exactly one RR per cluster and all clients full-meshed to each other",
            "Multiple RRs with different cluster IDs in the same cluster",
            "One RR and all clients using only eBGP"
        ],
        "correctIndex": 0,
        "explanation": "Redundante RRs im selben Cluster teilen sich typischerweise dieselbe Cluster-ID und peeren untereinander per iBGP.",
        "explanation_en": "Redundant RRs in the same cluster typically share the same cluster ID and peer with each other via iBGP.",
        "extraInfo": "Verschiedene Cluster innerhalb eines AS brauchen dagegen unterschiedliche Cluster-IDs.",
        "extraInfo_en": "Different clusters inside one AS, however, need different cluster IDs.",
        "tip": "Gleiches Cluster = gleiche Cluster-ID.",
        "tip_en": "Same cluster = same cluster ID.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Redundancy",
    ...
    {
        "id": "bgp-m3s4-q3",
        "question": "Welche Peering-Regel passt fuer Clients in einem redundanten RR-Cluster am besten?",
        "question_en": "Which peering rule best fits clients in a redundant RR cluster?",
        "options": [
            "Clients sollten iBGP-Sessions zu allen RRs ihres Clusters haben",
            "Clients sollten nur zu einem RR peeren, sonst verletzt man RFC 4456",
            "Clients muessen untereinander full-meshed sein, RR sind optional",
            "Clients duerfen nur eBGP-Sessions zu RRs haben"
        ],
        "options_en": [
            "Clients should have iBGP sessions to all RRs in their cluster",
            "Clients should peer with only one RR, otherwise RFC 4456 is violated",
            "Clients must be full-meshed with each other and RRs are optional",
            "Clients may have only eBGP sessions to RRs"
        ],
        "correctIndex": 0,
        "explanation": "Nur so bleibt die RR-Redundanz wirksam, wenn ein RR oder eine Session ausfaellt.",
        "explanation_en": "Only then does RR redundancy remain effective if one RR or one session fails.",
        "extraInfo": "Die Clients selbst muessen dafuer nicht untereinander full-meshed sein.",
        "extraInfo_en": "The clients themselves do not need to be full-meshed for this.",
        "tip": "Redundante RRs bringen nur etwas, wenn der Client beide auch wirklich peert.",
        "tip_en": "Redundant RRs help only if the client actually peers with both.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Redundancy",
    ...
    },
    {
        ...
        "question_en": "Which statement is false?",
        "options": [
            "Alle Cluster in einem AS muessen dieselbe Cluster-ID nutzen",
            "Es koennen mehrere RR-Cluster in einem AS existieren",
            "RR-Redundanz reduziert das Risiko eines Single Point of Failure",
            "Non-Clients sind keine klassischen RR-Clients"
        ],
        "options_en": [
            "All clusters in one AS must use the same cluster ID",
            "Multiple RR clusters can exist in one AS",
            "RR redundancy reduces the risk of a single point of failure",
            "Non-clients are not classical RR clients"
        ],
        "correctIndex": 0,
        "explanation": "Nur redundante RRs desselben Clusters nutzen typischerweise dieselbe Cluster-ID. Verschiedene Cluster innerhalb eines AS sollten unterschiedliche IDs haben.",
        "explanation_en": "Only redundant RRs of the same cluster typically use the same cluster ID. Different clusters inside one AS should use different IDs.",
        "extraInfo": "Sonst wird die Schleifenerkennung ueber CLUSTER_LIST unklar.",
        "extraInfo_en": "Otherwise loop detection via CLUSTER_LIST becomes ambiguous.",
        "tip": "Gleiche Cluster-ID nur fuer dasselbe Cluster.",
        "tip_en": "Use the same cluster ID only for the same cluster.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Redundancy",
    ...
    {
        "id": "bgp-m3s5-q1",
        "question": "Wann nimmt ein Nokia 7750 die Rolle eines Route Reflectors an?",
        "question_en": "When does a Nokia 7750 assume the role of a route reflector?",
        "options": [
            "Sobald fuer eine Gruppe oder einen Nachbarn eine Cluster-ID konfiguriert ist",
            "Erst wenn zusaetzlich client-reflect true auf allen Nachbarn gesetzt wird",
            "Nur wenn OSPF und BGP dieselbe Router-ID nutzen",
            "Erst wenn alle Clients untereinander full-meshed sind"
        ],
        "options_en": [
            "As soon as a cluster ID is configured for a group or a neighbor",
            "Only when client-reflect true is additionally set on all neighbors",
            "Only when OSPF and BGP use the same router ID",
            "Only when all clients are full-meshed with each other"
        ],
        "correctIndex": 0,
        "explanation": "Auf dem 7750 macht die Cluster-ID den Router bereits zum RR. Weitere Grundkommandos sind dafuer nicht noetig.",
        "explanation_en": "On the 7750, the cluster ID already makes the router an RR. No additional base commands are required for that.",
        "extraInfo": "Will man Reflection fuer einzelne Peers unterdruecken, kommt erst dann ein zusaetzlicher Befehl ins Spiel.",
        "extraInfo_en": "Only if you want to suppress reflection for specific peers does an extra command come into play.",
        "tip": "Cluster-ID ist der Schalter fuer die RR-Rolle.",
        "tip_en": "The cluster ID is the switch that enables the RR role.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Nokia",
    ...
    {
        "id": "bgp-m3s5-q2",
        "question": "Wofuer dient auf einem Nokia 7750 der Parameter disable-client-reflect?",
        "question_en": "What is the purpose of disable-client-reflect on a Nokia 7750?",
        "options": [
            "Er verhindert Reflection zu einem bestimmten Peer, etwa wenn ein Client ohnehin full-meshed ist",
            "Er schaltet BGP komplett fuer den Peer ab",
            "Er deaktiviert CLUSTER_LIST global",
            "Er zwingt den Peer in eBGP statt iBGP"
        ],
        "options_en": [
            "It prevents reflection to a specific peer, for example when a client is already full-meshed",
            "It disables BGP entirely for the peer",
            "It globally disables CLUSTER_LIST",
            "It forces the peer to use eBGP instead of iBGP"
        ],
        "correctIndex": 0,
        "explanation": "Damit kann man redundante Reflection fuer gezielte Peers abschalten, ohne die RR-Rolle des Routers komplett zu entfernen.",
        "explanation_en": "It lets you disable redundant reflection for selected peers without removing the RR role from the router.",
        "extraInfo": "Das ist vor allem bei bereits anderweitig gut vermaschten Clients sinnvoll.",
        "extraInfo_en": "This is especially useful for clients that are already otherwise well meshed.",
        "tip": "disable-client-reflect wirkt gezielt pro Peer, nicht global fuer ganz BGP.",
        "tip_en": "disable-client-reflect works per peer, not globally for all of BGP.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Nokia",
    ...
    {
        "id": "bgp-m3s5-q3",
        "question": "Welche Aussage zur Aufraeumarbeit nach der RR-Einfuehrung ist am treffendsten?",
        "question_en": "Which statement about cleanup after introducing an RR is the most accurate?",
        "options": [
            "Client-zu-Client-Full-Mesh ist nicht mehr noetig, aber Sessions sollten gezielt und vorsichtig entfernt werden",
            "Nach der RR-Einfuehrung muessen alle iBGP-Sessions ausserhalb des RR sofort geloescht werden",
            "Zusatzsessions zwischen Clients erzeugen automatisch Routing-Loops",
            "RRs funktionieren nur, wenn keinerlei direkte iBGP-Sessions mehr existieren"
        ],
        "options_en": [
            "Client-to-client full mesh is no longer required, but sessions should be removed selectively and carefully",
            "After introducing an RR, all iBGP sessions outside the RR must be deleted immediately",
            "Extra sessions between clients automatically create routing loops",
            "RRs work only when absolutely no direct iBGP sessions remain"
        ],
        "correctIndex": 0,
        "explanation": "Der Sinn von RR ist, unnoetige Full-Mesh-Sessions abzubauen. Das sollte aber geplant passieren, weil man sonst Transit- oder Reachability-Probleme erzeugen kann.",
        "explanation_en": "The point of RRs is to remove unnecessary full-mesh sessions. But this should be done in a planned way, otherwise you can create transit or reachability problems.",
        "extraInfo": "Zusatzsessions sind vor allem ein Skalierungs- und Betriebsproblem, nicht automatisch eine Loop-Garantie.",
        "extraInfo_en": "Extra sessions are primarily a scaling and operational issue, not an automatic guarantee of loops.",
        "tip": "Nicht blind alles loeschen und nicht jede alte Session fuer eine Loop halten.",
        "tip_en": "Do not blindly delete everything and do not treat every old session as a loop by default.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Configuration",
    ...
    },
    {
        ...
        "question_en": "Which statement is false?",
        "options": [
            "disable-client-reflect ist zwingend noetig, damit ein 7750 ueberhaupt als RR arbeitet",
            "Mit einer Cluster-ID kann ein 7750 bereits RR sein",
            "Zu aggressives Entfernen alter Sessions kann AS-internen Transit stoeren",
            "Nicht jede zusaetzliche Client-Session bedeutet automatisch eine Schleife"
        ],
        "options_en": [
            "disable-client-reflect is mandatory for a 7750 to work as an RR at all",
            "With a cluster ID, a 7750 can already operate as an RR",
            "Removing old sessions too aggressively can break intra-AS transit",
            "Not every extra client session automatically means a loop"
        ],
        "correctIndex": 0,
        "explanation": "disable-client-reflect ist nur eine zusaetzliche Feineinstellung. Die RR-Rolle selbst kommt bereits durch die konfigurierte Cluster-ID zustande.",
        "explanation_en": "disable-client-reflect is only an extra fine-tuning setting. The RR role itself already comes from the configured cluster ID.",
        "extraInfo": "Das ist genau der Unterschied zwischen Grundfunktion und optionaler Optimierung.",
        "extraInfo_en": "That is exactly the difference between core function and optional optimization.",
        "tip": "Cluster-ID macht den RR, disable-client-reflect nur die Detailsteuerung.",
        "tip_en": "The cluster ID makes the RR; disable-client-reflect only controls the details.",
        "tags": [
            "BGP",
            "Route Reflector",
            "Configuration",
    ...
    {
        "id": "bgp-m1s3-q18",
        "question": "Welche Aussage zu Connect und Active ist am treffendsten?",
        "question_en": "Which statement about the Connect and Active states is the most accurate?",
        "options": [
            "Connect beweist eine lokale Fehlkonfiguration und Active beweist eine Remote-Fehlkonfiguration",
            "Connect und Active sind nur grobe Diagnosehinweise; lokal, remote oder Routing- und TCP-Reachability-Probleme kommen alle infrage",
            "Sobald Connect oder Active erscheint, ist die TCP-Session bereits erfolgreich aufgebaut",
            "Connect und Active treten nur bei eBGP auf, nicht bei iBGP"
        ],
        "options_en": [
            "Connect proves a local misconfiguration and Active proves a remote misconfiguration",
            "Connect and Active are only rough diagnostic hints; local, remote, or routing and TCP reachability problems are all possible",
            "As soon as Connect or Active appears, the TCP session is already up successfully",
            "Connect and Active occur only with eBGP, not with iBGP"
        ],
        "correctIndex": 1,
        "explanation": "Nach RFC 4271 wartet BGP in Connect auf den TCP-Abschluss und versucht in Active erneut einen Verbindungsaufbau. Das ist hilfreich fuer die Fehlersuche, beweist aber den Fehlerort nicht eindeutig.",
        "explanation_en": "According to RFC 4271, BGP waits for TCP completion in Connect and retries session establishment in Active. That helps troubleshooting, but it does not prove the exact fault location.",
        "extraInfo": "Viele Kursfolien nutzen Connect gleich remote und Active gleich lokal als Heuristik. In der Praxis kann aber auch schlicht die Erreichbarkeit oder ein Filterproblem dazwischenstoeren.",
        "extraInfo_en": "Many course slides use Connect equals remote and Active equals local as a heuristic. In practice, plain reachability or filtering in between can also be the cause.",
        "tip": "States lesen, aber Routing, ACLs und Peer-Konfiguration immer mitpruefen.",
        "tip_en": "Read the states, but always check routing, ACLs, and peer configuration as well.",
        "tags": [
            "BGP",
            "FSM",
            "Connect",
    ...
    {
        "id": "bgp-m1s3-q19",
        "question": "Welche Aussage ist falsch, wenn eine BGP-Session zwischen Connect und Active pendelt?",
        "question_en": "Which statement is false when a BGP session keeps bouncing between Connect and Active?",
        "options": [
            "Ein Routing- oder Erreichbarkeitsproblem kann die Ursache sein",
            "Nur anhand dieser beiden States laesst sich der Fehlerort immer eindeutig bestimmen",
            "Eine falsche oder fehlende Peer-Konfiguration kann ebenfalls die Ursache sein",
            "Der Router versucht weiter, eine TCP-Verbindung aufzubauen oder anzunehmen"
        ],
        "options_en": [
            "A routing or reachability issue can be the cause",
            "The fault location can always be determined exactly from those two states alone",
            "A wrong or missing peer configuration can also be the cause",
            "The router keeps trying to establish or accept a TCP connection"
        ],
        "correctIndex": 1,
        "explanation": "Connect und Active sind FSM-Zustaende rund um den TCP-Aufbau. Sie helfen bei der Eingrenzung, aber sie liefern keinen mathematisch sicheren Beweis, ob lokal, remote oder im Transportpfad der Fehler sitzt.",
        "explanation_en": "Connect and Active are FSM states around TCP establishment. They help narrow things down, but they do not provide mathematically certain proof whether the fault is local, remote, or in the transport path.",
        "extraInfo": "Genau deshalb sollte man Peer-IP-Erreichbarkeit, TTL, ACLs, Multihop und die eigentliche Nachbarkonfiguration gemeinsam pruefen.",
        "extraInfo_en": "That is why you should check peer reachability, TTL, ACLs, multihop, and the actual neighbor configuration together.",
        "tip": "BGP-State allein reicht nicht, immer auch den TCP-Unterbau mitdenken.",
        "tip_en": "A BGP state alone is not enough; always include the TCP underlay in your reasoning.",
        "tags": [
            "BGP",
            "FSM",
            "Connect",
    ...
    {
        "id": "bgp-m2s3-q14",
        "question": "Welche Methode skaliert in einem Multi-Region-VPN-Umfeld typischerweise am besten?",
        "question_en": "Which method typically scales best in a multi-region VPN environment?",
        "options": [
            "End-to-End-Transport-Tunnel zwischen den PE-Routern zu signalisieren",
            "Jeden Intermediate Router pro VPN manuell zu konfigurieren",
            "Alle VPNs nur noch lokal in einer Region zu terminieren",
            "Auf Service-Label komplett zu verzichten"
        ],
        "options_en": [
            "Signal end-to-end transport tunnels between the PE routers",
            "Manually configure every intermediate router per VPN",
            "Terminate all VPNs locally in one region only",
            "Avoid service labels entirely"
        ],
        "correctIndex": 0,
        "explanation": "Die skalierbarste Grundidee ist, den Transport Ende zu Ende zwischen den PE-Routern bereitzustellen. Dadurch muessen Intermediate Router keinen per-VPN-State kennen.",
        "explanation_en": "The most scalable basic idea is to provide transport end to end between the PE routers. That way intermediate routers do not need per-VPN state.",
        "extraInfo": "Genau das reduziert Konfigurationsaufwand und Betriebszustand im Kern oder an Regionsgrenzen.",
        "extraInfo_en": "That is exactly what reduces configuration effort and operational state in the core or at region borders.",
        "tip": "Skalierbar ist meist das Design mit moeglichst wenig VPN-Wissen unterwegs.",
        "tip_en": "Scalable usually means a design with as little VPN knowledge as possible in the middle.",
        "tags": [
            "BGP",
            "Multi-Region",
            "VPN",
    ...
    {
        "id": "bgp-m2s3-q15",
        "question": "Warum ist ein End-to-End-Transport-Tunnel zwischen PE-Routern so attraktiv fuer Multi-Region-VPNs?",
        "question_en": "Why is an end-to-end transport tunnel between PE routers so attractive for multi-region VPNs?",
        "options": [
            "Weil Intermediate Router dann keine per-VPN-State-Informationen oder per-VPN-Konfigurationen brauchen",
            "Weil dadurch Route Targets ueberfluessig werden",
            "Weil MPLS-Labels dann gar nicht mehr benoetigt werden",
            "Weil MP-BGP dann nur noch fuer iBGP genutzt wird"
        ],
        "options_en": [
            "Because intermediate routers then do not need per-VPN state information or per-VPN configuration",
            "Because Route Targets become unnecessary",
            "Because MPLS labels are no longer needed at all",
            "Because MP-BGP is then used only for iBGP"
        ],
        "correctIndex": 0,
        "explanation": "Die Intermediate Router muessen den VPN-Service nicht verstehen. Sie transportieren nur den Tunnelverkehr weiter, was die Loesung deutlich besser skalieren laesst.",
        "explanation_en": "The intermediate routers do not need to understand the VPN service. They only forward the tunnel traffic, which makes the solution scale much better.",
        "extraInfo": "Alternative Verfahren wie VC-Switching oder bestimmte Inter-AS-Modelle brauchen mehr service-spezifischen Zustand auf Zwischenknoten.",
        "extraInfo_en": "Alternative methods such as VC switching or certain inter-AS models require more service-specific state on intermediate nodes.",
        "tip": "Skalierung gewinnt man hier durch weniger VPN-Wissen im Transit.",
        "tip_en": "You gain scale here by keeping VPN knowledge out of the transit path.",
        "tags": [
            "BGP",
            "Multi-Region",
            "VPN",
    ...
    {
        "id": "bgp-m2s3-q16",
        "question": "Warum werden Tunnel an Regionsgrenzen in der Praxis oft gestitcht?",
        "question_en": "Why are tunnels often stitched at region borders in practice?",
        "options": [
            "Weil Operatoren LDP-, RSVP- oder SR-Signaling haeufig nicht ueber Regionsgrenzen hinweg erlauben",
            "Weil MP-BGP an Regionsgrenzen immer deaktiviert werden muss",
            "Weil PE-Router keine Loopback-Adressen ueber Regionen hinweg advertisen duerfen",
            "Weil MPLS-Labels nur innerhalb einer Region gueltig sein duerfen und nie weitergegeben werden koennen"
        ],
        "options_en": [
            "Because operators often do not allow LDP, RSVP, or SR signaling across region boundaries",
            "Because MP-BGP must always be disabled at region borders",
            "Because PE routers are not allowed to advertise loopback addresses across regions",
            "Because MPLS labels may be valid only inside one region and can never be passed on"
        ],
        "correctIndex": 0,
        "explanation": "Innerhalb jeder Region koennen partielle Tunnel signalisiert werden. An den Grenzen werden sie verbunden, damit trotzdem End-to-End-Konnektivitaet entsteht.",
        "explanation_en": "Inside each region, partial tunnels can be signaled. They are joined at the borders so that end-to-end connectivity still exists.",
        "extraInfo": "Das ist ein klassischer Grund, warum Multi-Region-Designs gern zwischen intra-region und inter-region Transport unterscheiden.",
        "extraInfo_en": "That is a classic reason why multi-region designs often separate intra-region from inter-region transport.",
        "tip": "Nicht alles darf operational ueber Regionsgrenzen hinweg signalisiert werden.",
        "tip_en": "Not everything is operationally allowed to be signaled across region boundaries.",
        "tags": [
            "BGP",
            "Multi-Region",
            "Tunnel Stitching",
    ...
    {
        "id": "bgp-m2s3-q17",
        "question": "Welche Alternative kann einen durchgehenden End-to-End-Transport-Tunnel ohne klassisches Stitching aufbauen?",
        "question_en": "Which alternative can build a continuous end-to-end transport tunnel without classical stitching?",
        "options": [
            "Gelabelte Prefixe ueber BGP Labeled Unicast, also label-ipv4 oder label-ipv6",
            "Nur ungetaggte Ethernet-Frames auf allen PE-Routern",
            "Ausschliesslich Route Targets ohne Transport-Labels",
            "Vollstaendiger Verzicht auf Loopback-Adressen auf den PEs"
        ],
        "options_en": [
            "Labeled prefixes via BGP Labeled Unicast, meaning label-ipv4 or label-ipv6",
            "Only untagged Ethernet frames on all PE routers",
            "Route Targets only, without transport labels",
            "Complete removal of loopback addresses on the PEs"
        ],
        "correctIndex": 0,
        "explanation": "Bei BGP Labeled Unicast wird jedem IP-Prefix ein Label zugeordnet. So kann ein durchgehender Transportpfad auf Basis gelabelter Prefixe entstehen.",
        "explanation_en": "With BGP Labeled Unicast, each IP prefix gets a label. That allows a continuous transport path based on labeled prefixes.",
        "extraInfo": "In der Praxis advertisen PEs dabei oft ihre Loopback-Prefixe als Tunnel-Endpunkte mit der passenden MP-BGP-Familie.",
        "extraInfo_en": "In practice, PEs often advertise their loopback prefixes as tunnel endpoints with the matching MP-BGP family.",
        "tip": "label-ipv4 und label-ipv6 sind genau fuer gelabelte IP-Prefixe gedacht.",
        "tip_en": "label-ipv4 and label-ipv6 are exactly for labeled IP prefixes.",
        "tags": [
            "BGP",
            "Labeled Unicast",
            "label-ipv4",
    ...
    {
        "id": "bgp-m2s3-q18",
        "question": "Was advertist ein PE fuer einen label-ipv4- oder label-ipv6-basierten Transport typischerweise?",
        "question_en": "What does a PE typically advertise for transport based on label-ipv4 or label-ipv6?",
        "options": [
            "Seine Loopback-IP bzw. sein Loopback-Prefix zusammen mit einem MPLS-Label",
            "Nur Route Targets ohne Prefix",
            "Nur die MAC-Adressen seiner Kundenstandorte",
            "Nur den Namen des VPN-Service ohne Adressinformation"
        ],
        "options_en": [
            "Its loopback IP or loopback prefix together with an MPLS label",
            "Only Route Targets without a prefix",
            "Only the MAC addresses of its customer sites",
            "Only the VPN service name without address information"
        ],
        "correctIndex": 0,
        "explanation": "Die Loopback-Adresse dient typischerweise als Tunnel-Endpunkt. Ueber die passende MP-BGP Address-Family wird das Prefix zusammen mit einem Label verteilt.",
        "explanation_en": "The loopback address typically serves as the tunnel endpoint. Via the matching MP-BGP address family, the prefix is distributed together with a label.",
        "extraInfo": "Intermediate MP-BGP Router koennen solche gelabelten Prefixe weiterreichen, ohne selbst per-VPN-Logik kennen zu muessen.",
        "extraInfo_en": "Intermediate MP-BGP routers can forward such labeled prefixes without needing per-VPN logic themselves.",
        "tip": "Loopback plus Label ist hier der Kern, nicht RT oder Service-Name.",
        "tip_en": "Loopback plus label is the key here, not the RT or service name.",
        "tags": [
            "BGP",
            "Labeled Unicast",
            "Loopback",
    ...
    {
        "id": "bgp-m2s3-q19",
        "question": "Welche Aussage zu Intermediate MP-BGP Routern in diesem Modell ist am treffendsten?",
        "question_en": "Which statement about intermediate MP-BGP routers in this model is the most accurate?",
        "options": [
            "Sie koennen gelabelte Prefixe weiterpropagieren und so beim Aufbau eines End-to-End-Transport-Tunnels helfen, ohne per-VPN-Konfiguration zu brauchen",
            "Sie muessen fuer jedes VPN eigene Service-SAPs anlegen",
            "Sie brauchen fuer jedes VPRN einen eigenen Route Distinguisher im Transit",
            "Sie ersetzen dabei die PE-Router als eigentliche Service-Endpunkte"
        ],
        "options_en": [
            "They can propagate labeled prefixes and thus help build an end-to-end transport tunnel without needing per-VPN configuration",
            "They must create dedicated service SAPs for every VPN",
            "They need a dedicated Route Distinguisher in transit for every VPRN",
            "They replace the PE routers as the actual service endpoints"
        ],
        "correctIndex": 0,
        "explanation": "Das ist genau der Skalierungsvorteil: Intermediate Router reichen den gelabelten Transport weiter, ohne selbst service-spezifische Endpunkte oder per-VPN-Konfiguration zu tragen.",
        "explanation_en": "That is exactly the scaling advantage: intermediate routers forward the labeled transport without carrying service-specific endpoints or per-VPN configuration themselves.",
        "extraInfo": "Die eigentlichen VPN-spezifischen Parameter werden weiterhin zwischen den PE-Routern ausgetauscht.",
        "extraInfo_en": "The actual VPN-specific parameters are still exchanged between the PE routers.",
        "tip": "Transit transportiert, PE terminiert den Service.",
        "tip_en": "Transit transports, the PE terminates the service.",
        "tags": [
            "BGP",
            "Multi-Region",
            "MP-BGP",
    ...
    {
        "id": "bgp-m2s3-q20",
        "question": "Warum sieht man innerhalb einer Region oft einen Zwei-Label-Stack, obwohl die MP-BGP Peers nicht direkt benachbart sind?",
        "question_en": "Why do you often see a two-label stack inside one region even though the MP-BGP peers are not directly adjacent?",
        "options": [
            "Weil das innere BGP-Label den stitched Weiterweg repraesentiert und der BGP Next Hop intra-regional ueber ein aeusseres LDP-, RSVP- oder SR-Label aufgeloest wird",
            "Weil ein MP-BGP Router immer zwei Service-Labels pro VPN-Prefix senden muss",
            "Weil der Route Distinguisher als zweites Data-Plane-Label transportiert wird",
            "Weil Route Targets im Transport-Stack als aeusseres Label erscheinen"
        ],
        "options_en": [
            "Because the inner BGP label represents the stitched onward path and the BGP next hop is resolved intra-region via an outer LDP, RSVP, or SR label",
            "Because an MP-BGP router must always send two service labels per VPN prefix",
            "Because the route distinguisher is transported as a second data-plane label",
            "Because route targets appear in the transport stack as an outer label"
        ],
        "correctIndex": 0,
        "explanation": "Der innere Labelwert kommt aus dem BGP-labeled Transportkontext. Das aeussere Label bringt das Paket innerhalb der Region ueber LDP, RSVP oder SR bis zum passenden Border Router oder naechsten Transitknoten.",
        "explanation_en": "The inner label comes from the BGP-labeled transport context. The outer label carries the packet inside the region via LDP, RSVP, or SR to the proper border router or next transit node.",
        "extraInfo": "Genau diese Trennung erlaubt es, dass MP-BGP Peers logisch verbunden sind, obwohl der konkrete Transport in der Region separat aufgeloest wird.",
        "extraInfo_en": "That separation is exactly what allows MP-BGP peers to be logically connected while the actual transport inside the region is resolved separately.",
        "tip": "Inner = stitched BGP-Kontext, outer = regionaler Transport.",
        "tip_en": "Inner = stitched BGP context, outer = regional transport.",
        "tags": [
            "BGP",
            "Data Plane",
            "Label Stack",
    ...
    {
        "id": "bgp-m2s3-q21",
        "question": "Welche Aussage zum Pop des aeusseren Labels am Region Border Router ist am treffendsten?",
        "question_en": "Which statement about popping the outer label at the region border router is the most accurate?",
        "options": [
            "Nach dem Pop des aeusseren intra-region Labels wird das sichtbare BGP-Label relevant, weil es den naechsten partiellen Tunnel beziehungsweise den naechsten BGP-Schritt identifiziert",
            "Nach dem Pop des aeusseren Labels ist kein MPLS-Kontext mehr vorhanden und der Rest laeuft rein auf ARP",
            "Das innere BGP-Label wird am Border Router immer sofort durch einen Route Distinguisher ersetzt",
            "Sobald das aeussere Label entfernt wird, wird das Paket stets direkt nativ zum CE ausgesendet"
        ],
        "options_en": [
            "After the outer intra-region label is popped, the visible BGP label becomes relevant because it identifies the next partial tunnel or next BGP step",
            "After the outer label is popped, no MPLS context remains and the rest runs purely on ARP",
            "The inner BGP label is always immediately replaced by a route distinguisher at the border router",
            "As soon as the outer label is removed, the packet is always sent natively to the CE"
        ],
        "correctIndex": 0,
        "explanation": "Das aeussere Label war nur fuer den regionalen Transport noetig. Nach dessen Entfernung bleibt der BGP-labeled Kontext sichtbar und kann fuer den naechsten gestitchten Abschnitt genutzt oder geswappt werden.",
        "explanation_en": "The outer label was needed only for regional transport. Once it is removed, the BGP-labeled context remains visible and can be used or swapped for the next stitched segment.",
        "extraInfo": "Gerade dieser Moment am Border Router macht das Stitching im Data Plane nachvollziehbar: regionales Transportlabel weg, BGP-Label bleibt als Hinweis auf den naechsten Abschnitt.",
        "extraInfo_en": "That exact moment at the border router makes stitching in the data plane easy to understand: the regional transport label disappears, while the BGP label stays as the clue for the next segment.",
        "tip": "Outer faellt, inner zeigt den weiteren Weg.",
        "tip_en": "The outer one disappears, the inner one shows the onward path.",
        "tags": [
            "BGP",
            "Data Plane",
    ...
    {
        "id": "bgp-m1s2-q24",
        "question": "Welche Aussage zur BGP OPEN Message ist falsch?",
        "question_en": "Which statement about the BGP OPEN message is false?",
        "options": [
            "Sie enthaelt Version, AS, Hold Time, BGP Identifier und optionale Parameter bzw. Capabilities",
            "Sie dient dazu, grundlegende Sitzungsparameter zwischen Nachbarn abzugleichen",
            "Sie enthaelt ein eigenes Feld fuer die Source-IP des Senders",
            "Wenn die ausgehandelten Parameter nicht zusammenpassen, kann die Session scheitern"
        ],
        "options_en": [
            "It contains version, AS, hold time, BGP identifier, and optional parameters or capabilities",
            "It is used to align basic session parameters between neighbors",
            "It contains a dedicated field for the sender source IP",
            "If the negotiated parameters do not match, the session can fail"
        ],
        "correctIndex": 2,
        "explanation": "Die Source-IP ist kein eigenes OPEN-Feld. Sie ergibt sich aus der bereits bestehenden TCP-Verbindung. In der OPEN Message stehen stattdessen unter anderem Version, AS, Hold Time, BGP Identifier und optionale Parameter.",
        "explanation_en": "The source IP is not a dedicated OPEN field. It comes from the already established TCP connection. The OPEN message instead contains items such as version, AS, hold time, BGP identifier, and optional parameters.",
        "extraInfo": "Genau dieser Punkt ist eine typische Stolperfalle: TCP bringt die Adressen, OPEN bringt die BGP-Sitzungsparameter.",
        "extraInfo_en": "That point is a common trap: TCP carries the addresses, OPEN carries the BGP session parameters.",
        "tip": "OPEN = BGP-Parameter. Die IP-Adressen kommen vom TCP-Unterbau.",
        "tip_en": "OPEN = BGP parameters. The IP addresses come from the TCP underlay.",
        "tags": [
            "BGP",
            "OPEN",
            "Messages",
    ...
    {
        "id": "bgp-m1s2-q25",
        "question": "Welche zusaetzliche BGP Message wird genutzt, wenn ein Router nach einer Import-Policy-Aenderung eine neue Kopie der RIB-Out seines Nachbarn anfordert?",
        "question_en": "Which additional BGP message is used when a router asks a neighbor for a fresh copy of its RIB-Out after an import policy change?",
        "options": [
            "Route Refresh",
            "Notification",
            "MED Update",
        ...
        "correctIndex": 0,
        "explanation": "Dafuer ist die Route-Refresh-Message da. Im SR OS Kurskontext wird sie speziell beim Austausch von VPRN-Routing-Informationen ueber BGP hervorgehoben.",
        "explanation_en": "That is the purpose of the Route Refresh message. In the SR OS course context, it is specifically highlighted for BGP exchange of VPRN routing information.",
        "extraInfo": "Statt den Nachbarn komplett neu aufzubauen, fordert man damit die relevanten Routen noch einmal zur erneuten Policy-Auswertung an.",
        "extraInfo_en": "Instead of rebuilding the neighbor from scratch, it requests the relevant routes again for renewed policy evaluation.",
        "tip": "Policy aendert sich, RIB-Out nochmal sehen wollen = Route Refresh.",
        "tip_en": "Policy changes and you want to see RIB-Out again = Route Refresh.",
        "tags": [
            "BGP",
            "Route Refresh",
            "Import Policy",
    ...
    {
        "id": "bgp-m1s2-q26",
        "question": "Welche Liste enthaelt nur die klassischen Haupt-Messages einer BGP-Session?",
        "question_en": "Which list contains only the classic main messages of a BGP session?",
        "options": [
            "OPEN, KEEPALIVE, UPDATE, NOTIFICATION",
            "OPEN, ROUTE REFRESH, MED, KEEPALIVE",
            "UPDATE, OSPF HELLO, KEEPALIVE, NOTIFICATION",
            "OPEN, ICMP, UPDATE, NOTIFICATION"
        ],
        "options_en": [
            "OPEN, KEEPALIVE, UPDATE, NOTIFICATION",
            "OPEN, ROUTE REFRESH, MED, KEEPALIVE",
        ...
        "correctIndex": 0,
        "explanation": "Das sind die vier klassischen Kern-Messages. Route Refresh ist eine zusaetzliche Message, aber nicht Teil dieser klassischen Viererliste.",
        "explanation_en": "Those are the four classic core messages. Route Refresh is an additional message, but it is not part of that classic list of four.",
        "extraInfo": "Gerade in Pruefungsfragen wird Route Refresh gern mit in die Hauptliste gemischt, obwohl es sauberer als Zusatzmessage gesehen wird.",
        "extraInfo_en": "Especially in exam questions, Route Refresh is often mixed into the main list even though it is cleaner to treat it as an additional message.",
        "tip": "Die klassische Vierergruppe auswendig koennen.",
        "tip_en": "Know the classic group of four by heart.",
        "tags": [
            "BGP",
            "Messages",
            "OPEN",
    ...
    {
        "id": "bgp-m1s3-q20",
        "question": "Welche Reihenfolge beschreibt den erfolgreichen Sitzungsaufbau am treffendsten?",
        "question_en": "Which sequence best describes a successful session establishment?",
        "options": [
            "TCP steht, OPEN wird gesendet, Zustand OpenSent; OPEN empfangen, KEEPALIVE senden, Zustand OpenConfirm; KEEPALIVE empfangen, Zustand Established",
            "TCP steht, UPDATE wird gesendet, Zustand Active; NOTIFICATION empfangen, Zustand Established",
            "OPEN wird vor TCP gesendet; danach geht es direkt in Established",
            "Nach Connect folgt immer sofort Established, wenn die AS-Nummern korrekt sind"
        ],
        "options_en": [
            "TCP is up, OPEN is sent, state OpenSent; OPEN is received, KEEPALIVE is sent, state OpenConfirm; KEEPALIVE is received, state Established",
            "TCP is up, UPDATE is sent, state Active; NOTIFICATION is received, state Established",
            "OPEN is sent before TCP; then it goes directly to Established",
            "After Connect, it always goes straight to Established if the AS numbers are correct"
        ],
        "correctIndex": 0,
        "explanation": "Genau so laeuft die FSM nach erfolgreichem TCP-Aufbau weiter: OPEN senden -> OpenSent, OPEN empfangen und KEEPALIVE senden -> OpenConfirm, KEEPALIVE empfangen -> Established.",
        "explanation_en": "That is exactly how the FSM continues after successful TCP establishment: send OPEN -> OpenSent, receive OPEN and send KEEPALIVE -> OpenConfirm, receive KEEPALIVE -> Established.",
        "extraInfo": "Das ist eine gute Pruefungsfrage, weil gern UPDATE oder NOTIFICATION an die falsche Stelle gemischt werden.",
        "extraInfo_en": "That is a good exam question because UPDATE or NOTIFICATION are often mixed into the wrong place.",
        "tip": "Erst TCP, dann OPEN, dann KEEPALIVE, dann Established.",
        "tip_en": "First TCP, then OPEN, then KEEPALIVE, then Established.",
        "tags": [
            "BGP",
            "FSM",
            "OpenSent",
    ...
    {
        "id": "bgp-m1s3-q21",
        "question": "Welche Aussage zu iBGP, eBGP und Multihop ist falsch?",
        "question_en": "Which statement about iBGP, eBGP, and multihop is false?",
        "options": [
            "iBGP Peers muessen immer direkt benachbart sein",
            "eBGP Peers sind oft direkt benachbart, muessen es mit Multihop aber nicht zwingend sein",
            "Ohne Multihop kann eine nicht-adjacent eBGP-Session standardmaessig an der TTL scheitern",
            "Multihop-Werte koennen je nach Plattform und Hierarchie geerbt werden"
        ],
        "options_en": [
            "iBGP peers must always be directly adjacent",
            "eBGP peers are often directly adjacent, but with multihop they do not have to be",
            "Without multihop, a non-adjacent eBGP session can fail because of the TTL by default",
            "Multihop values can be inherited depending on platform and hierarchy"
        ],
        "correctIndex": 0,
        "explanation": "iBGP Peers muessen nicht direkt benachbart sein. Entscheidend ist, dass sie sich IP-seitig erreichen koennen, typischerweise ueber das IGP desselben AS.",
        "explanation_en": "iBGP peers do not have to be directly adjacent. What matters is IP reachability, typically provided by the IGP of the same AS.",
        "extraInfo": "Bei eBGP ist direkte Nachbarschaft typisch, aber nicht zwingend, wenn der TTL-Wert per Multihop passend erhoeht wird.",
        "extraInfo_en": "For eBGP, direct adjacency is typical, but not mandatory if the TTL is increased appropriately with multihop.",
        "tip": "Adjacent ist typisch fuer eBGP, Pflicht ist es erst ohne passenden Multihop.",
        "tip_en": "Adjacent is typical for eBGP; it becomes a requirement only without proper multihop.",
        "tags": [
            "BGP",
            "iBGP",
            "eBGP",
    ...
    {
        "id": "bgp-m1s3-q22",
        "question": "Welche Aussage zur Adresswahl fuer BGP Sessions ist am treffendsten?",
        "question_en": "Which statement about address selection for BGP sessions is the most accurate?",
        "options": [
            "iBGP nutzt oft System- oder Loopback-IPs, waehrend eBGP typischerweise Interface-IPs nutzt",
            "eBGP nutzt grundsaetzlich nur Loopback-IPs und iBGP nur MAC-Adressen",
            "iBGP und eBGP nutzen immer dieselben Access-VLAN-IPs",
            "Die IP-Wahl ist bei BGP irrelevant, solange die AS-Nummer stimmt"
        ],
        "options_en": [
            "iBGP often uses system or loopback IPs, while eBGP typically uses interface IPs",
            "eBGP always uses only loopback IPs and iBGP only MAC addresses",
            "iBGP and eBGP always use the same access VLAN IPs",
            "The IP choice is irrelevant in BGP as long as the AS number is correct"
        ],
        "correctIndex": 0,
        "explanation": "iBGP baut Sessions oft ueber stabile System- oder Loopback-IPs auf, die ueber das IGP bekannt sind. eBGP nutzt typischerweise direkt die Interface-IPs zum Nachbarn.",
        "explanation_en": "iBGP often builds sessions over stable system or loopback IPs known via the IGP. eBGP typically uses the interface IPs directly toward the neighbor.",
        "extraInfo": "Das passt gut zur typischen Topologie: iBGP im selben AS ueber mehr Hops, eBGP haeufig direkt am Rand.",
        "extraInfo_en": "That fits the typical topology: iBGP inside the same AS across more hops, eBGP often directly at the edge.",
        "tip": "iBGP eher System-IP, eBGP eher Interface-IP.",
        "tip_en": "iBGP more often system IP, eBGP more often interface IP.",
        "tags": [
            "BGP",
            "iBGP",
            "eBGP",
    ...
    {
        "id": "bgp-m1s4-q25",
        "question": "Was ist im BGP-Kontext am saubersten als Route beschrieben?",
        "question_en": "What is the cleanest description of a route in the BGP context?",
        "options": [
            "NLRI plus Path Attributes",
            "Nur der IP-Prefix ohne weitere Information",
            "Ausschliesslich das NEXT_HOP Attribut",
            "Nur Community und LOCAL_PREFERENCE"
        ],
        "options_en": [
            "NLRI plus path attributes",
            "Only the IP prefix without any further information",
            "Only the NEXT_HOP attribute",
            "Only community and LOCAL_PREFERENCE"
        ],
        "correctIndex": 0,
        "explanation": "Eine BGP-Route besteht logisch aus der Network Layer Reachability Information und den zugehoerigen Path Attributes.",
        "explanation_en": "A BGP route logically consists of the Network Layer Reachability Information and the associated path attributes.",
        "extraInfo": "Die NLRI ist der Prefix-Teil; die Attribute steuern Herkunft, Weitergabe und Best-Path-Entscheidung.",
        "extraInfo_en": "The NLRI is the prefix part; the attributes control origin, propagation, and best-path decisions.",
        "tip": "Prefix allein ist noch nicht die ganze BGP-Route.",
        "tip_en": "The prefix alone is not the whole BGP route.",
        "tags": [
            "BGP",
            "NLRI",
            "Path Attributes",
    ...
    {
        "id": "bgp-m1s4-q26",
        "question": "Welche Aussage zu optional non-transitiven Attributen ist am treffendsten?",
        "question_en": "Which statement about optional non-transitive attributes is the most accurate?",
        "options": [
            "Sie duerfen innerhalb des lokalen AS weitergegeben werden, aber nicht ueber dieses AS hinaus an weitere eBGP-Nachbarn",
            "Sie muessen auch bei unbekanntem Format immer ueber jedes AS hinaus propagiert werden",
            "Sie sind identisch mit well-known mandatory Attributen",
            "Sie duerfen weder innerhalb noch ausserhalb des lokalen AS weitergegeben werden"
        ],
        "options_en": [
            "They may be propagated inside the local AS, but not beyond that AS to further eBGP neighbors",
            "They must always be propagated across every AS even if their format is unknown",
            "They are identical to well-known mandatory attributes",
            "They may be propagated neither inside nor outside the local AS"
        ],
        "correctIndex": 0,
        "explanation": "Optional non-transitive Attribute duerfen den lokalen AS-Kontext ueber iBGP durchlaufen, sollen aber nicht ueber weitere AS-Grenzen hinaus exportiert werden.",
        "explanation_en": "Optional non-transitive attributes may travel through the local AS via iBGP, but they should not be exported beyond additional AS boundaries.",
        "extraInfo": "Genau deshalb ist die Formulierung wichtig: nicht ueber das lokale AS hinaus, aber innerhalb des AS kann die Information relevant bleiben.",
        "extraInfo_en": "That is exactly why the wording matters: not beyond the local AS, but the information may still remain relevant within the AS.",
        "tip": "Non-transitive heisst nicht unsichtbar im eigenen AS, sondern nicht ueber weitere AS-Grenzen hinaus.",
        "tip_en": "Non-transitive does not mean invisible inside the AS, it means not beyond further AS boundaries.",
        "tags": [
            "BGP",
            "Path Attributes",
            "Optional",
    ...
    {
        "id": "bgp-m1s4-q27",
        "question": "Welche Aussage zum NEXT_HOP Attribut ist am treffendsten?",
        "question_en": "Which statement about the NEXT_HOP attribute is the most accurate?",
        "options": [
            "Bei Redistribution identifiziert NEXT_HOP typischerweise den redistribuierenden Router selbst; bei extern gelernten Routen kann next-hop-self den lokalen Werber als neuen NEXT_HOP setzen",
            "NEXT_HOP ist immer identisch mit dem ORIGIN Attribut",
            "NEXT_HOP wird nur innerhalb von Route Reflector Clustern benutzt",
            "NEXT_HOP ist immer die Customer-ID des werbenden VPN-Service"
        ],
        "options_en": [
            "With redistribution, NEXT_HOP typically identifies the redistributing router itself; for externally learned routes, next-hop-self can set the local advertiser as the new NEXT_HOP",
            "NEXT_HOP is always identical to the ORIGIN attribute",
            "NEXT_HOP is used only inside route reflector clusters",
            "NEXT_HOP is always the customer ID of the advertising VPN service"
        ],
        "correctIndex": 0,
        "explanation": "Genau diese Unterscheidung ist wichtig: Bei lokal redistribuierten Prefixen zeigt NEXT_HOP oft direkt auf den einbringenden Router. Bei extern gelernten Routen kann das Verhalten ueber next-hop-self geaendert werden.",
        "explanation_en": "That distinction is important: for locally redistributed prefixes, NEXT_HOP often points directly to the introducing router. For externally learned routes, the behavior can be changed with next-hop-self.",
        "extraInfo": "Gerade in Pruefungen wird gern vermischt, ob NEXT_HOP den originalen externen Werber oder den lokalen Weitergeber zeigt.",
        "extraInfo_en": "Especially in exams, it is often mixed up whether NEXT_HOP points to the original external advertiser or the local re-advertiser.",
        "tip": "Redistribute lokal -> oft lokaler Router. Extern gelernt -> next-hop-self kann umschreiben.",
        "tip_en": "Locally redistributed -> often local router. Learned externally -> next-hop-self can rewrite it.",
        "tags": [
            "BGP",
            "NEXT_HOP",
            "next-hop-self",
    ...
    {
        "id": "isis-m1s3-q1",
        "question": "Welche Aussage beschreibt den Unterschied zwischen IP- und MAC-Adressen am besten?",
        "question_en": "Which statement best describes the difference between IP and MAC addresses?",
        "options": [
            "IP dient der End-to-End-Adressierung, MAC dem Hop-by-Hop-Forwarding auf dem lokalen Link",
            "IP ist nur fuer einen einzelnen Link gueltig, MAC fuer die gesamte End-to-End-Strecke",
            "IP und MAC sind austauschbar, solange das Zielsubnetz bekannt ist",
            "MAC wird nur in Routing-Tabellen verwendet, IP nur in Ethernet-Frames"
        ],
        "options_en": [
            "IP is used for end-to-end addressing, while MAC is used for hop-by-hop forwarding on the local link",
            "IP is valid only for a single link, while MAC is valid for the full end-to-end path",
            "IP and MAC are interchangeable as long as the destination subnet is known",
            "MAC is used only in routing tables, while IP is used only in Ethernet frames"
        ],
        "correctIndex": 0,
        "explanation": "Die IP-Adresse bleibt fuer die logische Quelle und das logische Ziel relevant. Die MAC-Adresse ist nur fuer den naechsten lokalen Hop im aktuellen Layer-2-Segment wichtig.",
        "explanation_en": "The IP address remains relevant for the logical source and logical destination. The MAC address is important only for the next local hop in the current Layer-2 segment.",
        "extraInfo": "Genau diese Trennung ist die Grundlage dafuer, dass Router auf jedem Hop das Layer-2-Frame neu bauen koennen, waehrend das IP-Ziel gleich bleibt.",
        "extraInfo_en": "This exact separation is what allows routers to rebuild the Layer-2 frame at every hop while the IP destination remains the same.",
        "tip": "IP = Ende zu Ende, MAC = nur der naechste Link.",
        "tip_en": "IP = end to end, MAC = only the next link.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "IP",
    ...
    {
        "id": "isis-m1s3-q2",
        "question": "Warum muss ein IP-Paket fuer die Uebertragung ueber ein Ethernet-Netz in einen Layer-2-Header eingekapselt werden?",
        "question_en": "Why must an IP packet be encapsulated in a Layer 2 header for transmission across an Ethernet network?",
        "options": [
            "Weil das lokale Medium ein eigenes Forwarding-Schema nutzt und Ethernet dafuer MAC-Adressen verwendet",
            "Weil Router nur reine Ethernet-Frames weiterleiten und niemals IP-Pakete verarbeiten",
            "Weil die IP-Adresse erst durch den Ethernet-Header erzeugt wird",
            "Weil ARP nur mit bereits gekapselten IP-Paketen funktioniert"
        ],
        "options_en": [
            "Because the local medium uses its own forwarding scheme and Ethernet uses MAC addresses for that",
            "Because routers forward only pure Ethernet frames and never process IP packets",
            "Because the IP address is created only by the Ethernet header",
            "Because ARP works only with already encapsulated IP packets"
        ],
        "correctIndex": 0,
        "explanation": "Das IP-Paket loest das logische Routingproblem. Fuer den konkreten Transport auf einem Link braucht es aber ein Layer-2-Frame mit dem jeweils passenden lokalen Adressschema, bei Ethernet also MAC-Adressen.",
        "explanation_en": "The IP packet solves the logical routing problem. But for actual transport on a link, it needs a Layer 2 frame with the matching local addressing scheme, which in Ethernet means MAC addresses.",
        "extraInfo": "Der Link-Layer ist also nicht nur Verpackung, sondern die konkrete Transportform fuer den naechsten Hop.",
        "extraInfo_en": "So the link layer is not just packaging, but the actual transport form for the next hop.",
        "tip": "Routing entscheidet wohin, Layer 2 entscheidet wie ueber den naechsten Link.",
        "tip_en": "Routing decides where, Layer 2 decides how across the next link.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "Ethernet",
    ...
    {
        "id": "isis-m1s3-q3",
        "question": "Was macht ein Host typischerweise, wenn das Ziel in einem anderen Subnetz liegt?",
        "question_en": "What does a host typically do when the destination is in a different subnet?",
        "options": [
            "Er sendet das Paket an sein Default Gateway und braucht dafuer die MAC-Adresse dieses Routers",
            "Er versucht immer direkt die MAC-Adresse des entfernten Zielhosts ueber alle Router hinweg per ARP zu lernen",
            "Er ersetzt die Ziel-IP durch die MAC-Adresse des Zielhosts",
            "Er schickt das Paket zuerst an alle Hosts im lokalen Netz und wartet auf eine Antwort"
        ],
        "options_en": [
            "It sends the packet to its default gateway and therefore needs the MAC address of that router",
            "It always tries to learn the MAC address of the remote destination host directly across all routers using ARP",
            "It replaces the destination IP with the MAC address of the destination host",
            "It first sends the packet to all hosts in the local network and waits for a reply"
        ],
        "correctIndex": 0,
        "explanation": "Fuer fremde Subnetze wird nicht die MAC des Endhosts gebraucht, sondern die MAC des naechsten Routers auf dem lokalen Link, also typischerweise des Default Gateways.",
        "explanation_en": "For remote subnets, the required MAC is not the end host MAC but the MAC of the next router on the local link, typically the default gateway.",
        "extraInfo": "ARP hilft dem Host also zunaechst nur auf dem lokalen Segment, nicht bis zum finalen Ziel ueber mehrere Router hinweg.",
        "extraInfo_en": "ARP therefore helps the host only on the local segment first, not all the way to the final destination across multiple routers.",
        "tip": "Anderes Subnetz = Default Gateway, nicht direkte Ziel-MAC.",
        "tip_en": "Different subnet = default gateway, not the direct destination MAC.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "Default Gateway",
    ...
    {
        "id": "isis-m1s3-q4",
        "question": "Welche Aussage beschreibt die Arbeit eines Routers beim Weiterleiten am treffendsten?",
        "question_en": "Which statement best describes what a router does when forwarding traffic?",
        "options": [
            "Er prueft das ankommende Layer-2-Frame, entfernt den alten L2-Header, trifft eine Entscheidung anhand der Ziel-IP und kapselt fuer den naechsten Hop neu ein",
            "Er liest nur die Ziel-MAC und laesst IP komplett unberuehrt und uninteressant",
            "Er aendert die Ziel-IP auf die Adresse des naechsten Routers bei jedem Hop",
            "Er sendet das urspruengliche Ethernet-Frame unveraendert durch alle Netze bis zum Zielhost weiter"
        ],
        "options_en": [
            "It checks the incoming Layer 2 frame, removes the old L2 header, makes a decision based on the destination IP, and encapsulates again for the next hop",
            "It reads only the destination MAC and treats IP as untouched and irrelevant",
            "It changes the destination IP to the next router address at every hop",
            "It forwards the original Ethernet frame unchanged through all networks until the destination host"
        ],
        "correctIndex": 0,
        "explanation": "Router arbeiten auf Layer 3 fuer die Pfadentscheidung, aber auf jedem Link muss das Paket erneut in ein passendes Layer-2-Frame fuer den naechsten Hop eingekapselt werden.",
        "explanation_en": "Routers operate on Layer 3 for path selection, but on every link the packet must be re-encapsulated into a suitable Layer 2 frame for the next hop.",
        "extraInfo": "Das ist der Kern von hop-by-hop auf Layer 2 bei gleichzeitig end-to-end auf Layer 3.",
        "extraInfo_en": "That is the core of hop by hop at Layer 2 while remaining end to end at Layer 3.",
        "tip": "Router ersetzt das Frame, nicht die gesamte End-to-End-Identitaet des Pakets.",
        "tip_en": "A router replaces the frame, not the entire end-to-end identity of the packet.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "Routers",
    ...
    },
    {
        ...
        "question_en": "Which statement is false?",
        "options": [
            "Der letzte Router findet die MAC-Adresse des Zielhosts direkt in seiner Routing-Tabelle",
            "Jedes Router-Interface kann in einem anderen Subnetz liegen und besitzt seine eigene MAC-Adresse",
            "Der letzte Router braucht eine Route zum Zielsubnetz und anschliessend typischerweise ARP, um die Ziel-MAC auf dem direkt angeschlossenen Netz zu lernen",
            "Hosts senden Verkehr zu fremden Subnetzen normalerweise ueber ihr Default Gateway"
        ],
        "options_en": [
            "The last router finds the destination host MAC address directly in its routing table",
            "Each router interface can belong to a different subnet and has its own MAC address",
            "The last router needs a route to the destination subnet and then typically ARP to learn the destination MAC on the directly attached network",
            "Hosts normally send traffic for remote subnets through their default gateway"
        ],
        "correctIndex": 0,
        "explanation": "Die Routing-Tabelle kennt Zielpraefixe und naechste Hops, nicht die Ziel-MAC eines Endhosts. Die Ziel-MAC auf dem direkt angeschlossenen Netz wird typischerweise per ARP oder Neighbor-Discovery gelernt.",
        "explanation_en": "The routing table knows destination prefixes and next hops, not the destination host MAC. The destination MAC on the directly attached network is typically learned via ARP or Neighbor Discovery.",
        "extraInfo": "Das ist ein wichtiger Unterschied zwischen Routing-Information und Layer-2-Nachbarauflosung.",
        "extraInfo_en": "That is an important distinction between routing information and Layer 2 neighbor resolution.",
        "tip": "Routing-Tabelle = IP-Pfade, ARP-Cache = lokale MAC-Zuordnung.",
        "tip_en": "Routing table = IP paths, ARP cache = local MAC mapping.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "Routing Table",
    ...
    {
        "id": "isis-m1s3-q6",
        "question": "Welche Aussage zum Default Gateway eines Hosts ist am treffendsten?",
        "question_en": "Which statement about a host default gateway is the most accurate?",
        "options": [
            "Ein Host hat typischerweise einen Standardrouter fuer Verkehr zu Zielen ausserhalb des eigenen Subnetzes",
            "Ein Host braucht fuer jedes entfernte Ziel immer einen eigenen Default Router",
            "Ein Default Gateway ersetzt die Ziel-IP des Pakets durch seine eigene IP",
            "Ein Default Gateway ist nur bei Layer-2-Switches relevant, nicht bei Hosts"
        ],
        "options_en": [
            "A host typically has one standard router for traffic to destinations outside its own subnet",
            "A host needs a separate default router for every remote destination",
            "A default gateway replaces the packet destination IP with its own IP",
            "A default gateway matters only for Layer 2 switches, not for hosts"
        ],
        "correctIndex": 0,
        "explanation": "Der Host muss nicht fuer jedes fremde Ziel den kompletten Pfad kennen. Er uebergibt solchen Verkehr an seinen Standardrouter, der das weitere Routing uebernimmt.",
        "explanation_en": "The host does not need to know the full path for every remote destination. It hands such traffic to its default router, which takes over the further routing.",
        "extraInfo": "Gerade dieses Prinzip vereinfacht die Host-Konfiguration massiv.",
        "extraInfo_en": "This principle greatly simplifies host configuration.",
        "tip": "Host kennt oft nur lokal und den Weg zum Standardrouter.",
        "tip_en": "The host often knows only local reachability and the path to the default router.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "Default Gateway",
    ...
    {
        "id": "isis-m1s3-q7",
        "question": "Welche Beschreibung des gesamten Weges von Host A zu Host B in einem anderen Subnetz ist am besten?",
        "question_en": "Which description of the full path from host A to host B in another subnet is the best one?",
        "options": [
            "Host A kapselt zum Default Gateway ein, Router fuer Router wird der Layer-2-Header jeweils neu gebaut, bis ein Router das Zielsubnetz direkt erreicht und den finalen Host lokal aufloesen kann",
            "Host A schickt ein einziges unveraendertes Ethernet-Frame durch alle Router bis zu Host B",
            "Jeder Router behaelt dieselben Source- und Destination-MAC-Adressen vom ersten Link bis zum letzten Link bei",
            "Die Ziel-IP wird auf jedem Hop auf die IP des naechsten Routers umgeschrieben"
        ],
        "options_en": [
            "Host A encapsulates toward the default gateway, and router by router the Layer 2 header is rebuilt until one router directly reaches the destination subnet and can resolve the final host locally",
            "Host A sends one unchanged Ethernet frame through all routers to host B",
            "Each router keeps the same source and destination MAC addresses from the first link to the last link",
            "The destination IP is rewritten at every hop to the next router IP"
        ],
        "correctIndex": 0,
        "explanation": "Genau so bewegt sich das Paket praktisch: Die IP-Zielidee bleibt erhalten, waehrend auf jedem Link das passende lokale Layer-2-Frame fuer den naechsten Hop erzeugt wird.",
        "explanation_en": "That is how the packet actually moves: the IP destination concept remains, while on each link the correct local Layer 2 frame is created for the next hop.",
        "extraInfo": "Dieser Ablauf ist grundlegendes Routing-Verstaendnis und spaeter wichtig fuer IGPs wie IS-IS.",
        "extraInfo_en": "This flow is core routing understanding and becomes important later for IGPs such as IS-IS.",
        "tip": "IP bleibt logisch gleich, Layer 2 wird pro Hop neu gebaut.",
        "tip_en": "IP stays logically the same, Layer 2 is rebuilt per hop.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "Packet Forwarding",
    ...
    {
        "id": "isis-m1s3-q8",
        "question": "Welche Aufgabe hat ARP im IPv4-Ethernet-Kontext am treffendsten?",
        "question_en": "What is the most accurate description of ARP's role in an IPv4 Ethernet context?",
        "options": [
            "ARP ordnet einer IPv4-Adresse auf dem lokalen Link eine passende MAC-Adresse zu",
            "ARP verteilt MAC-Adressen ueber mehrere Router hinweg bis zum finalen Zielhost",
            "ARP ersetzt die Routing-Tabelle bei der Pfadauswahl",
            "ARP wird nur von Switches verwendet, nicht von Hosts oder Routern"
        ],
        "options_en": [
            "ARP maps an IPv4 address to the corresponding MAC address on the local link",
            "ARP distributes MAC addresses across multiple routers all the way to the final destination host",
            "ARP replaces the routing table for path selection",
            "ARP is used only by switches, not by hosts or routers"
        ],
        "correctIndex": 0,
        "explanation": "ARP loest im IPv4-over-Ethernet-Kontext die lokale Zuordnung von Layer 3 zu Layer 2 auf. Es beantwortet also die Frage, welche MAC-Adresse auf dem direkt angeschlossenen Link fuer eine bestimmte IPv4-Adresse verwendet werden soll.",
        "explanation_en": "In an IPv4-over-Ethernet context, ARP resolves the local Layer 3 to Layer 2 mapping. It answers which MAC address should be used on the directly attached link for a given IPv4 address.",
        "extraInfo": "Die Routing-Tabelle bestimmt weiterhin das Zielpraefix oder den Next Hop. ARP liefert nur die lokale Nachbarauflosung fuer die konkrete Aussendung auf Ethernet.",
        "extraInfo_en": "The routing table still determines the destination prefix or next hop. ARP only provides the local neighbor resolution for the actual Ethernet transmission.",
        "tip": "ARP = lokale IPv4-zu-MAC-Aufloesung.",
        "tip_en": "ARP = local IPv4-to-MAC resolution.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "ARP",
    ...
    {
        "id": "isis-m1s3-q9",
        "question": "Welche MAC-Adresse braucht ein Router auf einem Ethernet-Interface typischerweise fuer die Weiterleitung zu einem nicht direkt erreichbaren Ziel?",
        "question_en": "Which MAC address does a router on an Ethernet interface typically need when forwarding to a destination that is not directly reachable?",
        "options": [
            "Die MAC-Adresse des naechsten Hops auf dem ausgehenden lokalen Link",
            "Die MAC-Adresse des finalen Zielhosts ueber die gesamte End-to-End-Strecke",
            "Gar keine MAC-Adresse, solange eine Next-Hop-IP bekannt ist",
            "Die MAC-Adresse des urspruenglichen Senders vom eingehenden Interface"
        ],
        "options_en": [
            "The MAC address of the next hop on the outgoing local link",
            "The MAC address of the final destination host across the full end-to-end path",
            "No MAC address at all as long as a next-hop IP is known",
            "The MAC address of the original sender from the incoming interface"
        ],
        "correctIndex": 0,
        "explanation": "Auf Ethernet reicht die Next-Hop-IP allein fuer die konkrete Aussendung nicht aus. Der Router braucht fuer den ausgehenden Link auch die passende Ziel-MAC des lokalen Nachbarn, also typischerweise des naechsten Routers.",
        "explanation_en": "On Ethernet, a next-hop IP alone is not enough for the actual transmission. The router also needs the proper destination MAC for the outgoing link, typically the MAC of the next router.",
        "extraInfo": "Nur beim letzten Hop in das Zielsubnetz kann diese lokale Ziel-MAC die des finalen Endhosts sein. Davor ist es ueblicherweise die MAC des naechsten Routers.",
        "extraInfo_en": "Only on the last hop into the destination subnet can that local destination MAC be the final end host. Before that, it is usually the MAC of the next router.",
        "tip": "Next-Hop-IP bestimmt wohin logisch, MAC bestimmt wohin lokal auf Ethernet.",
        "tip_en": "The next-hop IP determines where logically, the MAC determines where locally on Ethernet.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "ARP",
    ...
    {
        "id": "isis-m1s3-q10",
        "question": "Welche Aussage zur Reichweite von ARP-Nachrichten trifft am besten zu?",
        "question_en": "Which statement best describes the scope of ARP messages?",
        "options": [
            "ARP-Requests bleiben auf der lokalen Layer-2-Broadcast-Domain und werden von Routern typischerweise nicht weitergeleitet",
            "ARP-Requests werden standardmaessig ueber Router hinweg bis zum finalen Zielnetz weitergeroutet",
            "ARP funktioniert nur dann, wenn Sender und Empfaenger exakt dieselbe MAC-Adresse haben",
            "ARP-Responses werden immer als Broadcast an alle Hosts im Netz gesendet"
        ],
        "options_en": [
            "ARP requests stay within the local Layer 2 broadcast domain and are typically not forwarded by routers",
            "ARP requests are normally routed across routers all the way to the final destination network",
            "ARP works only when sender and receiver have exactly the same MAC address",
            "ARP replies are always sent as broadcasts to every host in the network"
        ],
        "correctIndex": 0,
        "explanation": "ARP dient der Nachbarauflosung auf dem lokalen Link. Im Ethernet-Kontext wird ein Request als Broadcast im lokalen Segment versendet und ueberschreitet Routergrenzen typischerweise nicht.",
        "explanation_en": "ARP is used for neighbor resolution on the local link. In an Ethernet context, a request is sent as a broadcast within the local segment and typically does not cross routers.",
        "extraInfo": "Genau deshalb kann ein Host per ARP nicht direkt die MAC eines entfernten Endsystems in einem anderen Subnetz lernen.",
        "extraInfo_en": "That is exactly why a host cannot use ARP to directly learn the MAC of a remote end system in another subnet.",
        "tip": "ARP fragt lokal, nicht ueber das ganze geroutete Netz.",
        "tip_en": "ARP asks locally, not across the whole routed network.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "ARP",
    ...
    {
        "id": "isis-m1s3-q11",
        "question": "Was passiert typischerweise, bevor ein Host oder Router einen neuen ARP-Request sendet?",
        "question_en": "What typically happens before a host or router sends a new ARP request?",
        "options": [
            "Zuerst wird geprueft, ob bereits ein passender Eintrag im lokalen ARP-Cache vorhanden ist",
            "Zuerst wird immer ein Broadcast an alle Router im Internet gesendet",
            "Zuerst wird die Routing-Tabelle geloescht, damit nur aktuelle Daten verwendet werden",
            "Zuerst wird die Ziel-IP in eine neue Source-IP umgeschrieben"
        ],
        "options_en": [
            "First it checks whether a matching entry already exists in the local ARP cache",
            "First it always sends a broadcast to all routers on the Internet",
            "First it clears the routing table so only fresh data is used",
            "First it rewrites the destination IP into a new source IP"
        ],
        "correctIndex": 0,
        "explanation": "Bevor erneut per ARP gefragt wird, schaut das System typischerweise zuerst in den lokalen ARP-Cache. Ist dort schon eine gueltige Zuordnung vorhanden, kann direkt ein Ethernet-Frame gebaut werden.",
        "explanation_en": "Before asking again via ARP, the system typically checks the local ARP cache first. If a valid mapping is already present there, it can build the Ethernet frame immediately.",
        "extraInfo": "Caching vermeidet unnoetige Broadcasts und beschleunigt die Aussendung. Genau deshalb ist ARP nicht fuer jedes Paket erneut sichtbar, auch wenn derselbe Nachbar mehrfach genutzt wird.",
        "extraInfo_en": "Caching avoids unnecessary broadcasts and speeds up transmission. That is why ARP is not seen again for every packet even when the same neighbor is used repeatedly.",
        "tip": "Erst Cache, dann eventuell ARP-Request.",
        "tip_en": "First the cache, then possibly an ARP request.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "ARP",
    ...
    {
        "id": "isis-m1s3-q12",
        "question": "Warum werden ARP-Cache-Eintraege typischerweise nicht unbegrenzt behalten?",
        "question_en": "Why are ARP cache entries typically not kept forever?",
        "options": [
            "Weil Zuordnungen veralten koennen und daher alte Eintraege regelmaessig entfernt oder erneuert werden muessen",
            "Weil ARP nur fuer genau ein einziges Paket gueltig ist",
            "Weil MAC-Adressen sich bei jedem gesendeten Frame automatisch aendern",
            "Weil die Routing-Tabelle immer alle ARP-Eintraege sofort ersetzt"
        ],
        "options_en": [
            "Because mappings can become stale and old entries therefore need to be removed or refreshed regularly",
            "Because ARP is valid for exactly one single packet only",
            "Because MAC addresses automatically change with every transmitted frame",
            "Because the routing table always replaces all ARP entries immediately"
        ],
        "correctIndex": 0,
        "explanation": "ARP-Cache-Eintraege sind nur zwischengespeicherte lokale Zuordnungen. Da sich Nachbarschaften oder Zuordnungen aendern koennen, muessen veraltete Eintraege irgendwann aus dem Cache verschwinden oder neu bestaetigt werden.",
        "explanation_en": "ARP cache entries are only cached local mappings. Since neighbors or mappings can change, outdated entries must eventually disappear from the cache or be confirmed again.",
        "extraInfo": "Der Kernpunkt ist nicht nur dynamische IP-Adressvergabe, sondern allgemein das Vermeiden veralteter Layer-2-Zuordnungen.",
        "extraInfo_en": "The key point is not only dynamic IP address assignment, but more generally avoiding stale Layer 2 mappings.",
        "tip": "ARP-Cache ist Kurzzeitwissen, kein ewiges Verzeichnis.",
        "tip_en": "An ARP cache is short-term knowledge, not a permanent directory.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "ARP",
    ...
    {
        "id": "isis-m1s3-q13",
        "question": "Welche Aussage beschreibt die IPv6-Entsprechung zu ARP am besten?",
        "question_en": "Which statement best describes the IPv6 counterpart to ARP?",
        "options": [
            "IPv6 verwendet Neighbor Discovery ueber ICMPv6 statt ARP fuer die lokale Nachbarauflosung",
            "IPv6 verwendet unveraendert dasselbe ARP-Protokoll wie IPv4",
            "IPv6 braucht auf Ethernet keine lokale Nachbarauflosung mehr",
            "IPv6 speichert Nachbarn ausschliesslich in der Routing-Tabelle und nicht in einem eigenen Nachbarstatus"
        ],
        "options_en": [
            "IPv6 uses Neighbor Discovery over ICMPv6 instead of ARP for local neighbor resolution",
            "IPv6 uses the exact same ARP protocol as IPv4 unchanged",
            "IPv6 no longer needs local neighbor resolution on Ethernet",
            "IPv6 stores neighbors only in the routing table and not in a separate neighbor state"
        ],
        "correctIndex": 0,
        "explanation": "IPv6 ersetzt ARP nicht durch gar nichts, sondern durch Neighbor Discovery auf Basis von ICMPv6. Damit werden Nachbarn auf dem lokalen Link aufgeloest und zusaetzliche Funktionen wie Router Discovery mit abgedeckt.",
        "explanation_en": "IPv6 does not replace ARP with nothing, but with Neighbor Discovery based on ICMPv6. It resolves neighbors on the local link and also covers additional functions such as router discovery.",
        "extraInfo": "Fuer das Kursverstaendnis reicht hier vor allem: IPv4 nutzt ARP, IPv6 nutzt Neighbor Discovery.",
        "extraInfo_en": "For the course, the main takeaway here is: IPv4 uses ARP, IPv6 uses Neighbor Discovery.",
        "tip": "IPv6 = ND, nicht ARP.",
        "tip_en": "IPv6 = ND, not ARP.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "IPv6",
    ...
    {
        "id": "isis-m1s3-q14",
        "question": "Was passiert in einem IPv4-Router typischerweise, wenn nach dem Longest-Prefix-Match keine passende Route gefunden wird?",
        "question_en": "What typically happens in an IPv4 router when no matching route is found after longest-prefix match?",
        "options": [
            "Das Paket wird verworfen, und typischerweise wird eine ICMP Destination Unreachable Meldung erzeugt",
            "Das Paket wird sicherheitshalber als Broadcast auf allen Interfaces weitergesendet",
            "Der Router fragt per ARP alle Nachbarn im Netz nach einer passenden Route",
            "Der Router sendet das Paket mit der urspruenglichen Ziel-MAC einfach weiter"
        ],
        "options_en": [
            "The packet is dropped, and typically an ICMP Destination Unreachable message is generated",
            "The packet is forwarded as a broadcast on all interfaces just to be safe",
            "The router asks all neighbors via ARP for a matching route",
            "The router simply forwards the packet using the original destination MAC"
        ],
        "correctIndex": 0,
        "explanation": "Findet ein IPv4-Router keine Route zum Ziel, kann er das Paket nicht sinnvoll weiterleiten. Typischerweise wird es verworfen und ein ICMP Destination Unreachable erzeugt, sofern dieses Verhalten nicht anderweitig unterdrueckt wird.",
        "explanation_en": "If an IPv4 router cannot find a route to the destination, it cannot forward the packet meaningfully. It is typically dropped and an ICMP Destination Unreachable is generated unless that behavior is suppressed for some reason.",
        "extraInfo": "Die genaue ICMP-Variante haengt vom Fall ab, etwa Network Unreachable oder Host Unreachable. Fuer das Grundverstaendnis reicht hier: keine Route bedeutet kein Forwarding.",
        "extraInfo_en": "The exact ICMP variant depends on the case, such as Network Unreachable or Host Unreachable. For the fundamentals, the key point is: no route means no forwarding.",
        "tip": "Kein Match in der Routing-Sicht = kein Weiterleiten.",
        "tip_en": "No match in the routing view = no forwarding.",
        "tags": [
            "IS-IS",
            "IP Routing Review",
            "Routing Table",
    ...
    {
        "id": "isis-m1s4-q8",
        "question": "Wie gelangen direkt verbundene Subnetze in die Routing-Tabelle eines Routers?",
        "question_en": "How do directly connected subnets get into a router's routing table?",
        "options": [
            "Sie werden automatisch aus den lokal verbundenen Interfaces abgeleitet",
            "Sie muessen immer manuell als statische Route eingetragen werden",
            "Sie erscheinen erst nach einer BGP-Nachbarschaft",
            "Sie werden nur durch ARP in die Routing-Tabelle eingetragen"
        ],
        "options_en": [
            "They are derived automatically from locally connected interfaces",
            "They must always be entered manually as static routes",
            "They only appear after a BGP adjacency is established",
            "They are only added to the routing table through ARP"
        ],
        "correctIndex": 0,
        "explanation": "Direkt angeschlossene Netze entstehen aus der lokalen Interface-Konfiguration und werden automatisch als erreichbar betrachtet.",
        "explanation_en": "Directly attached networks come from the local interface configuration and are automatically considered reachable.",
        "extraInfo": "Das ist die Basis, bevor statische oder dynamisch gelernte Routen dazukommen.",
        "extraInfo_en": "This is the baseline before static or dynamically learned routes are added.",
        "tip": "Direkt verbunden bedeutet: Das Netz haengt an einem eigenen Interface des Routers.",
        "tip_en": "Directly connected means the network is attached to one of the router's own interfaces.",
        "tags": [
            "IS-IS",
            "Routing Table",
            "Connected Routes",
    ...
    {
        "id": "isis-m1s4-q9",
        "question": "Welche zwei Hauptarten koennen zusaetzlich direkt verbundenen Netzen weitere Routen in eine Routing-Tabelle bringen?",
        "question_en": "Which two main types can add routes to a routing table in addition to directly connected networks?",
        "options": [
            "Statische Routen und dynamisch gelernte Routen",
            "Nur ARP-Eintraege und MAC-Learnings",
            "Nur Default Routes und Summaries",
            "NAT-Regeln und ACLs"
        ],
        "options_en": [
            "Static routes and dynamically learned routes",
            "Only ARP entries and MAC learnings",
            "Only default routes and summaries",
            "NAT rules and ACLs"
        ],
        "correctIndex": 0,
        "explanation": "Neben direkt verbundenen Netzen koennen Router Routen statisch konfiguriert bekommen oder dynamisch ueber Routing-Protokolle lernen.",
        "explanation_en": "Besides directly connected networks, routers can receive routes through static configuration or learn them dynamically via routing protocols.",
        "extraInfo": "Dynamisch gelernt bedeutet hier ueber Protokolle wie OSPF, IS-IS, RIP oder BGP.",
        "extraInfo_en": "Dynamically learned here means through protocols such as OSPF, IS-IS, RIP, or BGP.",
        "tip": "Denke an die drei grossen Quellen: connected, static, dynamic.",
        "tip_en": "Think of the three big sources: connected, static, dynamic.",
        "tags": [
            "IS-IS",
            "Routing Table",
            "Static Routes",
    ...
    {
        "id": "isis-m1s4-q10",
        "question": "Welche Gruppe enthaelt nur Interior Gateway Protocols (IGPs)?",
        "question_en": "Which group contains only Interior Gateway Protocols (IGPs)?",
        "options": [
            "OSPF, IS-IS und RIP",
            "OSPF, BGP und RIP",
            "IS-IS, BGP und MPLS",
        ...
        "correctIndex": 0,
        "explanation": "OSPF, IS-IS und RIP sind klassische IGPs fuer Routing innerhalb eines autonomen Systems. BGP ist dagegen das gaengige EGP.",
        "explanation_en": "OSPF, IS-IS, and RIP are classic IGPs for routing within an autonomous system. BGP, by contrast, is the common EGP.",
        "extraInfo": "ARP und MPLS gehoeren nicht in diese Protokollklasse fuer IGP versus EGP.",
        "extraInfo_en": "ARP and MPLS do not belong to this protocol class of IGP versus EGP.",
        "tip": "BGP ist der Ausreisser, wenn nach IGPs gefragt wird.",
        "tip_en": "BGP is the odd one out when the question asks for IGPs.",
        "tags": [
            "IS-IS",
            "IGP",
            "EGP",
    ...
    {
        "id": "isis-m1s4-q11",
        "question": "Welches Protokoll ist das klassische Exterior Gateway Protocol fuer den Austausch zwischen autonomen Systemen?",
        "question_en": "Which protocol is the classic exterior gateway protocol for exchange between autonomous systems?",
        "options": [
            "BGP",
            "ARP",
            "IS-IS",
        ...
        "correctIndex": 0,
        "explanation": "BGP ist fuer Inter-AS-Routing entwickelt worden und ist das typische Exterior Gateway Protocol.",
        "explanation_en": "BGP was developed for inter-AS routing and is the typical exterior gateway protocol.",
        "extraInfo": "IGPs wie OSPF, IS-IS und RIP arbeiten innerhalb eines AS, BGP zwischen ASes.",
        "extraInfo_en": "IGPs such as OSPF, IS-IS, and RIP operate within an AS, while BGP operates between ASes.",
        "tip": "Wenn es um zwischen ASes geht, ist fast immer BGP gemeint.",
        "tip_en": "When the question is about between ASes, it almost always means BGP.",
        "tags": [
            "IS-IS",
            "BGP",
            "EGP",
    ...
    {
        "id": "isis-m1s4-q12",
        "question": "Warum braucht ein Router bei gleichen Praefixen aus verschiedenen Routing-Protokollen einen Preference-Wert?",
        "question_en": "Why does a router need a preference value for identical prefixes learned from different routing protocols?",
        "options": [
            "Weil Metriken verschiedener Protokolle nicht direkt vergleichbar sind",
            "Weil Longest Prefix Match sonst nicht funktioniert",
            "Weil ARP sonst keine MAC-Adresse aufloesen kann",
            "Weil nur so IPv6 ueberhaupt geroutet werden kann"
        ],
        "options_en": [
            "Because metrics from different protocols are not directly comparable",
            "Because otherwise longest prefix match would not work",
            "Because otherwise ARP could not resolve a MAC address",
            "Because only then can IPv6 be routed at all"
        ],
        "correctIndex": 0,
        "explanation": "Jedes Routing-Protokoll nutzt eigene Metriken. Deshalb braucht der Router eine protokolluebergreifende Entscheidungsregel, und das ist hier die Preference.",
        "explanation_en": "Each routing protocol uses its own metrics. Therefore, the router needs a cross-protocol decision rule, which here is the preference.",
        "extraInfo": "Die Preference entscheidet zwischen Protokollen, waehrend die Metrik innerhalb eines Protokolls wichtig bleibt.",
        "extraInfo_en": "Preference decides between protocols, while the metric remains important within a protocol.",
        "tip": "Vergleiche nicht Hop Count direkt mit Cost oder anderen protokollspezifischen Metriken.",
        "tip_en": "Do not directly compare hop count with cost or other protocol-specific metrics.",
        "tags": [
            "IS-IS",
            "Preference",
            "Route Selection",
    ...
    {
        "id": "isis-m1s4-q13",
        "question": "Welche Route wird bei der protocol-uebergreifenden Auswahl anhand des Preference-Werts bevorzugt?",
        "question_en": "Which route is preferred during cross-protocol selection based on the preference value?",
        "options": [
            "Die Route mit dem niedrigsten Preference-Wert",
            "Die Route mit dem hoechsten Preference-Wert",
            "Immer die zuletzt gelernte Route",
            "Immer die Route mit der laengsten Prefixlaenge"
        ],
        "options_en": [
            "The route with the lowest preference value",
            "The route with the highest preference value",
            "Always the most recently learned route",
            "Always the route with the longest prefix length"
        ],
        "correctIndex": 0,
        "explanation": "Bei der Nokia-SR-OS-Logik gilt: je niedriger die Preference, desto eher wird die Route installiert.",
        "explanation_en": "In Nokia SR OS logic, the lower the preference, the more likely the route is to be installed.",
        "extraInfo": "Das ist eine Auswahl zwischen konkurrierenden Protokollen fuer dasselbe Zielpraefix.",
        "extraInfo_en": "This is a selection between competing protocols for the same destination prefix.",
        "tip": "Preference ist hier wie eine Prioritaet: kleiner gewinnt.",
        "tip_en": "Preference is like a priority here: smaller wins.",
        "tags": [
            "IS-IS",
            "Preference",
            "RTM",
    ...
    {
        "id": "isis-m1s4-q14",
        "question": "Welche Kombination zeigt korrekte Standard-Preference-Werte auf Nokia SR OS?",
        "question_en": "Which combination shows correct default preference values on Nokia SR OS?",
        "options": [
            "Direct attached 0, static 5, OSPF internal 10, IS-IS Level 1 internal 15",
            "Direct attached 10, static 0, OSPF internal 5, IS-IS Level 1 internal 15",
            "Direct attached 0, static 15, OSPF internal 10, IS-IS Level 1 internal 5",
            "Direct attached 5, static 10, OSPF internal 15, IS-IS Level 1 internal 0"
        ],
        "options_en": [
            "Direct attached 0, static 5, OSPF internal 10, IS-IS Level 1 internal 15",
            "Direct attached 10, static 0, OSPF internal 5, IS-IS Level 1 internal 15",
        ...
        "correctIndex": 0,
        "explanation": "Diese Werte entsprechen den dokumentierten Standard-Praeferenzen fuer direkt angeschlossene, statische, OSPF-interne und IS-IS-Level-1-interne Routen.",
        "explanation_en": "These values match the documented default preferences for directly attached, static, OSPF internal, and IS-IS level 1 internal routes.",
        "extraInfo": "Weitere Standardwerte sind zum Beispiel IS-IS Level 2 internal 18, RIP 100 und BGP 170.",
        "extraInfo_en": "Further default values include IS-IS level 2 internal 18, RIP 100, and BGP 170.",
        "tip": "Merke dir die kleine aufsteigende Reihe 0, 5, 10, 15.",
        "tip_en": "Remember the small ascending sequence 0, 5, 10, 15.",
        "tags": [
            "IS-IS",
            "Preference",
            "Nokia SR OS",
    ...
    {
        "id": "isis-m1s4-q15",
        "question": "Welche Aussage zur Auswahl konkurrierender Routen ist korrekt?",
        "question_en": "Which statement about selecting competing routes is correct?",
        "options": [
            "Verschiedene Protokolle sollten moeglichst nicht denselben Preference-Wert haben",
            "Bei gleichem Prefix gewinnt immer automatisch BGP",
            "Wenn die Preference gleich ist, wird die Route mit der groessten Metrik bevorzugt",
            "ECMP wird immer zwischen verschiedenen Protokollen zuerst angewendet"
        ],
        "options_en": [
            "Different protocols should ideally not have the same preference value",
            "For the same prefix, BGP always wins automatically",
            "If the preference is equal, the route with the highest metric is preferred",
            "ECMP is always applied first between different protocols"
        ],
        "correctIndex": 0,
        "explanation": "Gleiche Preference-Werte zwischen verschiedenen Protokollen sollte man vermeiden. Innerhalb desselben Protokolls gewinnt zuerst die niedrigere Metrik, und erst bei gleichem Wert kann ECMP relevant werden.",
        "explanation_en": "Equal preference values across different protocols should be avoided. Within the same protocol, the lower metric wins first, and only with equal values can ECMP become relevant.",
        "extraInfo": "Damit bleibt die Auswahl nachvollziehbar und stabiler konfiguriert.",
        "extraInfo_en": "This keeps route selection understandable and more stable in configuration.",
        "tip": "Preference zuerst zwischen Protokollen, Metrik danach innerhalb eines Protokolls.",
        "tip_en": "Preference first between protocols, metric afterwards within one protocol.",
        "tags": [
            "IS-IS",
            "Preference",
            "ECMP",
    ...
    {
        "id": "isis-m1s4-q16",
        "question": "Welche Aussage zu den Standard-Praeferenzen ist korrekt?",
        "question_en": "Which statement about default preferences is correct?",
        "options": [
            "Direct attached hat standardmaessig 0 und ist nicht konfigurierbar",
            "Static hat standardmaessig 0 und ist nicht konfigurierbar",
            "BGP hat standardmaessig 5 und ist nicht konfigurierbar",
            "RIP hat standardmaessig 18 und ist nicht konfigurierbar"
        ],
        "options_en": [
            "Direct attached defaults to 0 and is not configurable",
            "Static defaults to 0 and is not configurable",
            "BGP defaults to 5 and is not configurable",
            "RIP defaults to 18 and is not configurable"
        ],
        "correctIndex": 0,
        "explanation": "Direkt angeschlossene Routen haben standardmaessig die Preference 0 und sind in der Default-Tabelle als nicht konfigurierbar aufgefuehrt.",
        "explanation_en": "Directly attached routes default to preference 0 and are listed as not configurable in the default table.",
        "extraInfo": "Die meisten anderen dort gezeigten Protokoll-Praeferenzen koennen angepasst werden.",
        "extraInfo_en": "Most of the other protocol preferences shown there can be adjusted.",
        "tip": "Direct attached ist der Spezialfall ganz oben in der Tabelle.",
        "tip_en": "Direct attached is the special case at the very top of the table.",
        "tags": [
            "IS-IS",
            "Preference",
            "Connected Routes",
    ...
    {
        "id": "isis-m1s4-q17",
        "question": "Was aktiviert der Befehl `prefix-attributes-tlv` in Nokia SR OS fuer IS-IS?",
        "question_en": "What does the `prefix-attributes-tlv` command enable in Nokia SR OS for IS-IS?",
        "options": [
            "Den Austausch erweiterter IPv4- und IPv6-Reachability-Informationen",
            "Die automatische Bildung aller Level-2-Adjaenzen",
            "Die Umwandlung aller internen Routen in externe Routen",
            "Die Deaktivierung der IS-IS-Praeferenzlogik"
        ],
        "options_en": [
            "The exchange of extended IPv4 and IPv6 reachability information",
            "The automatic formation of all level 2 adjacencies",
            "The conversion of all internal routes into external routes",
            "The disabling of IS-IS preference logic"
        ],
        "correctIndex": 0,
        "explanation": "Die SR-OS-Doku beschreibt `prefix-attributes-tlv` genau so: Das Feature aktiviert den Austausch erweiterter IPv4- und IPv6-Reachability-Informationen.",
        "explanation_en": "The SR OS documentation describes `prefix-attributes-tlv` exactly this way: the feature enables the exchange of extended IPv4 and IPv6 reachability information.",
        "extraInfo": "Diese Prefix-Attribute sind die Grundlage dafuer, zusaetzliche Kennzeichnungen am beworbenen Praefix mitzugeben.",
        "extraInfo_en": "These prefix attributes are the basis for carrying additional markings on the advertised prefix.",
        "tip": "Der Name sagt es schon: Es geht um Attributinformationen zum Prefix, nicht um Nachbarschaften.",
        "tip_en": "The name already hints at it: this is about attribute information for a prefix, not about adjacencies.",
        "tags": [
            "IS-IS",
            "Nokia SR OS",
    ...
    {
        "id": "isis-m1s4-q18",
        "question": "Welches Flag kennzeichnet in der SR-OS-IS-IS-Anzeige ein externes Praefix?",
        "question_en": "Which flag marks an external prefix in the SR OS IS-IS display?",
        "options": [
            "X",
            "N",
            "D",
        ...
        "correctIndex": 0,
        "explanation": "In der dokumentierten IS-IS-Anzeige von Nokia SR OS steht explizit: `X = External Prefix Flag`.",
        "explanation_en": "In the documented IS-IS display of Nokia SR OS, it explicitly states: `X = External Prefix Flag`.",
        "extraInfo": "Andere dort gezeigte Flags sind zum Beispiel `D = Prefix Leaked Down`, `N = Node Flag` und `S = Sub-TLVs Present`.",
        "extraInfo_en": "Other flags shown there include `D = Prefix Leaked Down`, `N = Node Flag`, and `S = Sub-TLVs Present`.",
        "tip": "X wie external.",
        "tip_en": "X as in external.",
        "tags": [
            "IS-IS",
            "Nokia SR OS",
            "External Prefix",
    ...
    {
        "id": "isis-m1s4-q19",
        "question": "Welche Gegenueberstellung der Standard-Praeferenzen fuer interne und externe IS-IS-Routen ist auf Nokia SR OS korrekt?",
        "question_en": "Which comparison of default preferences for internal and external IS-IS routes is correct on Nokia SR OS?",
        "options": [
            "Level 1 intern 15, Level 1 extern 160, Level 2 intern 18, Level 2 extern 165",
            "Level 1 intern 160, Level 1 extern 15, Level 2 intern 165, Level 2 extern 18",
            "Level 1 intern 15, Level 1 extern 18, Level 2 intern 160, Level 2 extern 165",
            "Level 1 intern 5, Level 1 extern 15, Level 2 intern 10, Level 2 extern 18"
        ],
        "options_en": [
            "Level 1 internal 15, Level 1 external 160, Level 2 internal 18, Level 2 external 165",
            "Level 1 internal 160, Level 1 external 15, Level 2 internal 165, Level 2 external 18",
            "Level 1 internal 15, Level 1 external 18, Level 2 internal 160, Level 2 external 165",
            "Level 1 internal 5, Level 1 external 15, Level 2 internal 10, Level 2 external 18"
        ],
        "correctIndex": 0,
        "explanation": "Genau diese vier Default-Werte sind in der Nokia-SR-OS-Dokumentation fuer IS-IS dokumentiert.",
        "explanation_en": "Exactly these four default values are documented in the Nokia SR OS documentation for IS-IS.",
        "extraInfo": "Damit ist der Unterschied zwischen internen und externen IS-IS-Routen auf SR OS klar getrennt.",
        "extraInfo_en": "This cleanly separates internal and external IS-IS routes on SR OS.",
        "tip": "Die externen Werte liegen deutlich hoeher als die internen.",
        "tip_en": "The external values are much higher than the internal ones.",
        "tags": [
            "IS-IS",
            "Nokia SR OS",
            "Preference",
    ...
    {
        "id": "isis-ecmp-q1",
        "question": "Was passiert, wenn ein Router mehrere Routen fuer denselben Prefix vom selben Protokoll mit unterschiedlichen Costs lernt?",
        "question_en": "What happens when a router learns multiple routes for the same prefix from the same protocol with different costs?",
        "options": [
            "Nur die Route mit dem niedrigsten Cost-Wert wird dem RTM als Kandidat uebergeben",
            "Alle Routen werden gleichzeitig dem RTM uebergeben und dort verglichen",
            "Die Route mit dem hoechsten Cost-Wert wird bevorzugt, da sie mehr Pfade beschreibt",
            "Der Router waehlt zufaellig eine der Routen aus"
        ],
        "options_en": [
            "Only the route with the lowest cost value is passed to the RTM as a candidate",
            "All routes are passed to the RTM simultaneously and compared there",
            "The route with the highest cost value is preferred because it describes more paths",
            "The router selects one of the routes at random"
        ],
        "correctIndex": 0,
        "explanation": "Das Protokoll (hier IS-IS) fuehrt zuerst selbst eine Best-Path-Selektion durch. Nur die Route(n) mit dem niedrigsten Cost gehen als Kandidaten ans RTM weiter. Routen mit hoeherem Cost werden gar nicht erst eingereicht.",
        "explanation_en": "The protocol (IS-IS here) performs its own best-path selection first. Only the route(s) with the lowest cost are forwarded to the RTM as candidates. Routes with a higher cost are never submitted.",
        "extraInfo": "Diese Selektion findet innerhalb des Protokolls statt, bevor das RTM ueberhaupt involviert wird. Das RTM entscheidet dann via Preference zwischen verschiedenen Protokollen.",
        "extraInfo_en": "This selection happens within the protocol before the RTM is even involved. The RTM then decides between different protocols using preference values.",
        "tip": "Protokoll selektiert erst nach Cost, dann uebernimmt RTM die Preference-Entscheidung.",
        "tip_en": "Protocol selects by cost first, then RTM handles the preference decision.",
        "tags": [
            "IS-IS",
            "ECMP",
            "RTM",
    ...
    {
        "id": "isis-ecmp-q2",
        "question": "Was ist der Default-Wert des ECMP-Parameters auf Nokia SR OS, und was bedeutet das praktisch?",
        "question_en": "What is the default value of the ECMP parameter on Nokia SR OS, and what does that mean in practice?",
        "options": [
            "Default ist 1 -- der Router installiert nur eine einzige Route pro Prefix in die FIB",
            "Default ist 4 -- der Router nutzt automatisch bis zu 4 Pfade ohne Konfiguration",
            "Default ist 64 -- der Router nutzt immer alle verfuegbaren Equal-Cost-Pfade",
            "Default ist 0 -- ECMP muss explizit aktiviert werden, bevor ueberhaupt Routen installiert werden"
        ],
        "options_en": [
            "Default is 1 -- the router installs only a single route per prefix into the FIB",
            "Default is 4 -- the router automatically uses up to 4 paths without configuration",
            "Default is 64 -- the router always uses all available equal-cost paths",
            "Default is 0 -- ECMP must be explicitly activated before any routes are installed"
        ],
        "correctIndex": 0,
        "explanation": "ECMP ist per Default auf 1 gesetzt, was effektiv bedeutet: kein Load Balancing. Nur ein einziger Pfad wird in die FIB installiert, auch wenn mehrere Equal-Cost-Pfade vorhanden sind.",
        "explanation_en": "ECMP defaults to 1, which effectively means no load balancing. Only a single path is installed in the FIB even if multiple equal-cost paths exist.",
        "extraInfo": "ecmp 1 und no ecmp sind aequivalent. Erst ab ecmp 2 beginnt der Router, mehrere Pfade zu nutzen.",
        "extraInfo_en": "ecmp 1 and no ecmp are equivalent. Only from ecmp 2 onwards does the router start using multiple paths.",
        "tip": "Default ECMP = 1 = kein Load Balancing trotz mehrerer gleich-teurer Pfade.",
        "tip_en": "Default ECMP = 1 = no load balancing despite multiple equal-cost paths.",
        "tags": [
            "IS-IS",
            "ECMP",
            "Default",
    ...
    {
        "id": "isis-ecmp-q3",
        "question": "Wie viele Equal-Cost-Routen koennen maximal ueber den ECMP-Parameter fuer denselben Prefix konfiguriert werden?",
        "question_en": "What is the maximum number of equal-cost routes that can be configured via the ECMP parameter for the same prefix?",
        "options": [
            "64",
            "8",
            "16",
        ...
        "correctIndex": 0,
        "explanation": "Nokia SR OS erlaubt bis zu 64 Equal-Cost-Routen fuer denselben Prefix. Der ECMP-Parameter wird global im config>router Kontext gesetzt und gilt systemweit.",
        "explanation_en": "Nokia SR OS allows up to 64 equal-cost routes for the same prefix. The ECMP parameter is set globally in the config>router context and applies system-wide.",
        "extraInfo": "Praktisch werden selten mehr als 8-16 Pfade genutzt, da der Nutzen weiterer Pfade abnimmt und die Komplexitaet steigt.",
        "extraInfo_en": "In practice, more than 8-16 paths are rarely used, as the benefit of additional paths diminishes and complexity increases.",
        "tip": "ECMP-Maximum: 64 Pfade auf Nokia SR OS.",
        "tip_en": "ECMP maximum: 64 paths on Nokia SR OS.",
        "tags": [
            "IS-IS",
            "ECMP",
            "Maximum Paths",
    ...
    {
        "id": "isis-ecmp-q4",
        "question": "Wie verteilt Nokia SR OS den Traffic ueber ECMP-Pfade?",
        "question_en": "How does Nokia SR OS distribute traffic across ECMP paths?",
        "options": [
            "Per Flow via einem internen Hashing-Algorithmus -- alle Pakete desselben Flows gehen immer ueber denselben Pfad",
            "Per Paket Round-Robin -- jedes einzelne Paket wird auf den naechsten verfuegbaren Pfad verteilt",
            "Zufaellig -- jedes Paket bekommt einen zufaellig ausgewaehlten Pfad",
            "Nach Paketgroesse -- grosse Pakete gehen ueber Pfade mit hoeherer Bandbreite"
        ],
        "options_en": [
            "Per flow via an internal hashing algorithm -- all packets of the same flow always take the same path",
            "Per packet round-robin -- each individual packet is distributed to the next available path",
            "Randomly -- each packet gets a randomly selected path",
            "By packet size -- large packets go over paths with higher bandwidth"
        ],
        "correctIndex": 0,
        "explanation": "SR OS verwendet einen 5-Tuple-Hash (Source-IP, Dest-IP, Source-Port, Dest-Port, Protokoll). Alle Pakete eines Flows landen auf demselben Pfad -- das verhindert Paket-Reordering innerhalb eines TCP-Streams.",
        "explanation_en": "SR OS uses a 5-tuple hash (source IP, dest IP, source port, dest port, protocol). All packets of a flow land on the same path -- this prevents packet reordering within a TCP stream.",
        "extraInfo": "Per-Paket-Verteilung wuerde zwar theoretisch eine bessere Auslastung ergeben, aber TCP-Reordering kann den Throughput massiv reduzieren. Deshalb ist Flow-Hashing der Standard.",
        "extraInfo_en": "Per-packet distribution would theoretically yield better utilization, but TCP reordering can massively reduce throughput. That is why flow hashing is the standard.",
        "tip": "ECMP = Flow-basiertes Hashing, nicht Paket-basiertes Round-Robin.",
        "tip_en": "ECMP = flow-based hashing, not packet-based round-robin.",
        "tags": [
            "IS-IS",
            "ECMP",
            "Hashing",
    ...
    {
        "id": "isis-ecmp-q5",
        "question": "Es existieren 6 Equal-Cost-Pfade fuer einen Prefix, aber ECMP ist auf 4 konfiguriert. Welche 4 Pfade werden installiert?",
        "question_en": "There are 6 equal-cost paths for a prefix, but ECMP is configured to 4. Which 4 paths are installed?",
        "options": [
            "Die 4 Pfade mit den niedrigsten Next-Hop-IP-Adressen",
            "Die 4 Pfade werden zufaellig aus den 6 ausgewaehlt",
            "Die 4 zuerst gelernten Pfade werden bevorzugt",
            "Die 4 Pfade mit der hoechsten Next-Hop-IP-Adresse"
        ],
        "options_en": [
            "The 4 paths with the lowest next-hop IP addresses",
            "The 4 paths are randomly selected from the 6",
            "The 4 paths learned first are preferred",
            "The 4 paths with the highest next-hop IP address"
        ],
        "correctIndex": 0,
        "explanation": "Wenn mehr Equal-Cost-Pfade vorhanden sind als das ECMP-Limit erlaubt, waehlt Nokia SR OS deterministisch die Pfade mit den numerisch niedrigsten Next-Hop-IP-Adressen aus.",
        "explanation_en": "When more equal-cost paths exist than the ECMP limit allows, Nokia SR OS deterministically selects the paths with the numerically lowest next-hop IP addresses.",
        "extraInfo": "Dieses deterministische Verhalten ist wichtig fuer die Netzwerkplanung -- man kann vorhersagen, welche Pfade aktiv sein werden, ohne Protokoll-Logs lesen zu muessen.",
        "extraInfo_en": "This deterministic behavior is important for network planning -- you can predict which paths will be active without reading protocol logs.",
        "tip": "Mehr Pfade als ECMP-Limit -> niedrigste Next-Hop-IPs gewinnen.",
        "tip_en": "More paths than ECMP limit -> lowest next-hop IPs win.",
        "tags": [
            "IS-IS",
            "ECMP",
            "Next-Hop Selection",
    ...
    {
        "id": "isis-ecmp-q6",
        "question": "Welche Bedingungen muessen zwei Routen erfuellen, um als ECMP-Kandidaten zu gelten?",
        "question_en": "Which conditions must two routes meet to qualify as ECMP candidates?",
        "options": [
            "Gleiches Protokoll, gleiche Preference und gleicher Cost-Wert fuer denselben Prefix",
            "Gleicher Cost-Wert reicht -- das Protokoll spielt keine Rolle",
            "Gleiche Preference reicht -- Cost-Unterschiede werden automatisch ausgeglichen",
            "Gleiche Anzahl an Hops und gleicher Egress-Interface-Typ"
        ],
        "options_en": [
            "Same protocol, same preference, and same cost value for the same prefix",
            "Same cost value is sufficient -- the protocol does not matter",
            "Same preference is sufficient -- cost differences are automatically balanced",
            "Same number of hops and same egress interface type"
        ],
        "correctIndex": 0,
        "explanation": "Alle drei Kriterien muessen uebereinstimmen: gleiches Protokoll (z.B. IS-IS), gleiche Preference und gleicher Metric-Wert. Nur dann gelten Routen als Equal-Cost und kommen fuer ECMP in Frage.",
        "explanation_en": "All three criteria must match: same protocol (e.g. IS-IS), same preference, and same metric value. Only then are routes considered equal-cost and eligible for ECMP.",
        "extraInfo": "Ein haeufiger Fehler ist, Routen aus verschiedenen Protokollen (z.B. IS-IS und OSPF) als ECMP-Kandidaten zu betrachten -- das ist falsch, selbst wenn die Metric zufaellig gleich ist.",
        "extraInfo_en": "A common mistake is treating routes from different protocols (e.g. IS-IS and OSPF) as ECMP candidates -- this is incorrect even if the metric happens to be the same.",
        "tip": "ECMP-Kandidaten: gleiches Protokoll + gleiche Preference + gleicher Cost.",
        "tip_en": "ECMP candidates: same protocol + same preference + same cost.",
        "tags": [
            "IS-IS",
            "ECMP",
            "Route Selection",
    ...
    },
    {
        ...
        "question_en": "A network engineer claims: ECMP distributes every single packet evenly across all paths, so each path gets exactly the same amount of traffic. What is wrong with this claim?",
        "options": [
            "ECMP verteilt Flows, nicht einzelne Pakete -- ungleich grosse Flows fuehren zu ungleicher Auslastung der Pfade",
            "Die Aussage ist korrekt -- ECMP garantiert immer eine perfekt gleichmaessige Lastverteilung",
            "ECMP verteilt zwar Pakete, aber nur bei UDP -- bei TCP wird nur ein Pfad genutzt",
            "ECMP verteilt Pakete nur dann gleichmaessig, wenn alle Pfade dieselbe MTU haben"
        ],
        "options_en": [
            "ECMP distributes flows, not individual packets -- flows of unequal size lead to unequal path utilization",
            "The statement is correct -- ECMP always guarantees perfectly even load distribution",
            "ECMP distributes packets but only for UDP -- for TCP only one path is used",
            "ECMP distributes packets evenly only when all paths have the same MTU"
        ],
        "correctIndex": 0,
        "explanation": "ECMP-Hashing arbeitet auf Flow-Ebene. Ein grosser Elephant-Flow (z.B. ein Backup-Transfer) belegt einen Pfad komplett, waehrend andere Pfade nur kleine Flows tragen. Perfekte Gleichverteilung ist in der Praxis nicht garantiert.",
        "explanation_en": "ECMP hashing works at the flow level. A large elephant flow (e.g. a backup transfer) can occupy one path entirely while other paths carry only small flows. Perfect equal distribution is not guaranteed in practice.",
        "extraInfo": "Dieses Problem wird als Elephant Flow Problem bezeichnet. Loesungsansaetze sind z.B. Flowlet-basiertes Load Balancing oder Segment Routing Traffic Engineering.",
        "extraInfo_en": "This problem is known as the Elephant Flow Problem. Solutions include flowlet-based load balancing or Segment Routing Traffic Engineering.",
        "tip": "ECMP = Flow-Hashing = keine Garantie fuer gleichmaessige Auslastung bei ungleichen Flows.",
        "tip_en": "ECMP = flow hashing = no guarantee of even utilization with unequal flows.",
        "tags": [
            "IS-IS",
            "ECMP",
            "Load Balancing",
    ...
    {
        "id": "isis-ecmp-q8",
        "question": "In welchem Konfigurationskontext wird der ECMP-Parameter auf Nokia SR OS gesetzt?",
        "question_en": "In which configuration context is the ECMP parameter set on Nokia SR OS?",
        "options": [
            "config>router -- global fuer die gesamte Routing-Instanz",
            "config>router>isis -- spezifisch nur fuer IS-IS",
            "config>router>interface -- pro Interface einzeln",
            "config>service>vprn -- nur innerhalb von VPN-Instanzen"
        ],
        "options_en": [
            "config>router -- globally for the entire routing instance",
            "config>router>isis -- specifically for IS-IS only",
            "config>router>interface -- per interface individually",
            "config>service>vprn -- only within VPN instances"
        ],
        "correctIndex": 0,
        "explanation": "ECMP wird global im config>router Kontext konfiguriert und gilt damit fuer alle Protokolle in der jeweiligen Router-Instanz. Es ist keine protokollspezifische Einstellung.",
        "explanation_en": "ECMP is configured globally in the config>router context and therefore applies to all protocols in the respective router instance. It is not a protocol-specific setting.",
        "extraInfo": "Bei VPRN-Instanzen wird ECMP entsprechend im config>service>vprn Kontext gesetzt, da jede VPRN-Instanz eine eigene Routing-Tabelle hat.",
        "extraInfo_en": "For VPRN instances, ECMP is set in the config>service>vprn context accordingly, since each VPRN instance has its own routing table.",
        "tip": "ECMP global in config>router, nicht im Protokoll-Kontext.",
        "tip_en": "ECMP global in config>router, not in the protocol context.",
        "tags": [
            "IS-IS",
            "ECMP",
            "Nokia SR OS",
    ...
    {
        "id": "isis-ecmp-q12",
        "question": "ECMP ist auf dem Default-Wert 1 konfiguriert. Es existieren zwei Routen zum selben Prefix mit gleichem Cost und gleichem Protokoll. Welcher Pfad wird auf der Data Plane aktiv genutzt?",
        "question_en": "ECMP is set to its default value of 1. Two routes to the same prefix exist with equal cost and the same protocol. Which path is used as the active path on the data plane?",
        "options": [
            "Die Route mit der niedrigsten Next-Hop-Interface-IP-Adresse",
            "Die Route, die zuerst gelernt wurde",
            "Die Route mit der hoechsten Next-Hop-Interface-IP-Adresse",
            "Der Router waehlt zufaellig einen der beiden Pfade"
        ],
        "options_en": [
            "The route with the lowest next-hop interface IP address",
            "The route that was learned first",
            "The route with the highest next-hop interface IP address",
            "The router randomly selects one of the two paths"
        ],
        "correctIndex": 0,
        "explanation": "Bei ECMP=1 wird nur ein einziger Pfad in die FIB installiert. Existieren mehrere gleichwertige Kandidaten (gleiches Protokoll, gleiche Preference, gleicher Cost), greift die Tiebreaker-Regel: die Route mit der niedrigsten Next-Hop-Interface-IP-Adresse wird als aktiver Pfad auf der Data Plane genutzt.",
        "explanation_en": "With ECMP=1, only a single path is installed in the FIB. If multiple equal candidates exist (same protocol, same preference, same cost), the tiebreaker rule applies: the route with the lowest next-hop interface IP address is used as the active path on the data plane.",
        "extraInfo": "Diese Regel gilt nicht nur beim Default von 1, sondern immer dann, wenn mehr Equal-Cost-Pfade verfuegbar sind als der ECMP-Wert erlaubt.",
        "extraInfo_en": "This rule applies not only at the default of 1, but whenever more equal-cost paths are available than the ECMP value allows.",
        "tip": "Tiebreaker bei ECMP=1: niedrigste Next-Hop-Interface-IP gewinnt.",
        "tip_en": "Tiebreaker with ECMP=1: lowest next-hop interface IP wins.",
        "tags": [
            "IS-IS",
            "ECMP",
            "Tiebreaker",
    ...
    {
        "id": "isis-ecmp-q13",
        "question": "Was ist die Tiebreaker-Regel, wenn mehrere Equal-Cost-Routen des gleichen Protokolls existieren, aber ECMP nicht alle aufnehmen kann?",
        "question_en": "What is the tiebreaker rule when multiple equal-cost routes of the same protocol exist but ECMP cannot accommodate all of them?",
        "options": [
            "Die Route(n) mit den niedrigsten Next-Hop-Interface-IP-Adressen werden gewaehlt",
            "Die Route(n) mit der laengsten Uptime des naechsten Hops werden gewaehlt",
            "Die Route(n) mit dem kuerzesten AS-Path werden gewaehlt",
            "Die Route(n) mit der hoechsten Bandbreite des Ausgangs-Interface werden gewaehlt"
        ],
        "options_en": [
            "The route(s) with the lowest next-hop interface IP addresses are selected",
            "The route(s) with the longest next-hop uptime are selected",
            "The route(s) with the shortest AS path are selected",
            "The route(s) with the highest egress interface bandwidth are selected"
        ],
        "correctIndex": 0,
        "explanation": "Der Tiebreaker ist die numerisch niedrigste Next-Hop-Interface-IP-Adresse. Dieses Kriterium ist deterministisch und unabhaengig von der Reihenfolge, in der Routen gelernt wurden.",
        "explanation_en": "The tiebreaker is the numerically lowest next-hop interface IP address. This criterion is deterministic and independent of the order in which routes were learned.",
        "extraInfo": "Der Tiebreaker gilt sowohl bei ECMP=1 (einzelner Pfad) als auch bei hoeheren ECMP-Werten, wenn mehr Pfade vorhanden sind als konfiguriert.",
        "extraInfo_en": "The tiebreaker applies both at ECMP=1 (single path) and at higher ECMP values when more paths exist than configured.",
        "tip": "Tiebreaker = niedrigste Next-Hop-Interface-IP. Immer deterministisch.",
        "tip_en": "Tiebreaker = lowest next-hop interface IP. Always deterministic.",
        "tags": [
            "IS-IS",
            "ECMP",
            "Tiebreaker",
    ...
    {
        "id": "isis-ecmp-v4",
        "question": "Warum ist der Tiebreaker bei ECMP (niedrigste Next-Hop-IP) deterministisch und nicht zufaellig?",
        "question_en": "Why is the ECMP tiebreaker (lowest next-hop IP) deterministic rather than random?",
        "options": [
            "Ein deterministischer Tiebreaker macht den aktiven Pfad vorhersagbar und vereinfacht Troubleshooting und Netzwerkplanung",
            "Zufaellige Auswahl wuerde zu Routing-Loops fuehren",
            "Zufaellige Auswahl ist technisch nicht implementierbar, da Router keine Zufallsgeneratoren haben",
            "Ein deterministischer Tiebreaker erhoeh die verfuegbare Bandbreite automatisch"
        ],
        "options_en": [
            "A deterministic tiebreaker makes the active path predictable and simplifies troubleshooting and network planning",
            "Random selection would cause routing loops",
            "Random selection is technically not implementable because routers have no random number generators",
            "A deterministic tiebreaker automatically increases available bandwidth"
        ],
        "correctIndex": 0,
        "explanation": "Determinismus bedeutet: gegeben dieselbe Konfiguration und dieselben Routen, waehlt jeder Router immer denselben Pfad. Das macht Fehlersuche und Traffic-Engineering vorhersagbar -- man weiss ohne Log-Analyse, welcher Pfad aktiv ist.",
        "explanation_en": "Determinism means: given the same configuration and the same routes, every router always selects the same path. This makes troubleshooting and traffic engineering predictable -- you know which path is active without log analysis.",
        "extraInfo": "Zufaellige Tiebreaker existieren in manchen Implementierungen, sind aber operationell unpraktisch: nach einem Reboot koennte ein anderer Pfad aktiv werden, was Monitoring-Alarme ausloest.",
        "extraInfo_en": "Random tiebreakers exist in some implementations, but are operationally impractical: after a reboot a different path might become active, triggering monitoring alerts.",
        "tip": "Deterministisch = vorhersagbar = besser fuer Operations und Troubleshooting.",
        "tip_en": "Deterministic = predictable = better for operations and troubleshooting.",
        "tags": [
            "IS-IS",
            "ECMP",
            "Tiebreaker",
    ...
    {
        "id": "isis-s5-q1",
        "question": "Was ist Redistribution im Kontext von Routing-Protokollen?",
        "question_en": "What is redistribution in the context of routing protocols?",
        "options": [
            "Der Prozess, bei dem Routing-Informationen von einer Routing-Domain an eine andere weitergegeben werden",
            "Das automatische Aufteilen einer Routing-Tabelle auf mehrere Router",
            "Das Verfahren, bei dem IS-IS-Routen innerhalb derselben Area synchronisiert werden",
            "Die Methode, mit der ein Router seine eigene Loopback-Adresse anderen Protokollen bekanntgibt"
        ],
        "options_en": [
            "The process by which routing information is passed from one routing domain to another",
            "The automatic splitting of a routing table across multiple routers",
            "The procedure by which IS-IS routes are synchronized within the same area",
            "The method by which a router announces its own loopback address to other protocols"
        ],
        "correctIndex": 0,
        "explanation": "Redistribution bezeichnet den Prozess, bei dem ein Router Routing-Informationen, die er von einem Protokoll (z.B. OSPF) gelernt hat, in ein anderes Protokoll (z.B. IS-IS) einspeist und so zwischen Routing-Domains weitergibt.",
        "explanation_en": "Redistribution refers to the process by which a router injects routing information learned from one protocol (e.g. OSPF) into another protocol (e.g. IS-IS), passing it between routing domains.",
        "extraInfo": "Redistribution ist notwendig, wenn ein Netzwerk aus mehreren verschiedenen Routing-Domains besteht, die miteinander kommunizieren sollen.",
        "extraInfo_en": "Redistribution is necessary when a network consists of multiple different routing domains that need to communicate with each other.",
        "tip": "Redistribution = Routing-Infos von Domain A nach Domain B weitergeben.",
        "tip_en": "Redistribution = passing routing info from domain A to domain B.",
        "tags": [
            "IS-IS",
            "Redistribution",
            "Route Filtering",
    ...
    {
        "id": "isis-s5-q2",
        "question": "Welche Router fuehren Redistribution durch?",
        "question_en": "Which routers perform redistribution?",
        "options": [
            "Border Router -- Router, die entweder zwei verschiedene Routing-Protokolle oder zwei Instanzen desselben Protokolls betreiben",
            "Nur Designated Router (DR) innerhalb einer IS-IS-Area",
            "Alle Router im Netzwerk gleichzeitig, gesteuert durch das RTM",
            "Ausschliesslich Route-Reflektoren in BGP-Umgebungen"
        ],
        "options_en": [
            "Border routers -- routers running either two different routing protocols or two instances of the same protocol",
            "Only Designated Routers (DR) within an IS-IS area",
            "All routers in the network simultaneously, controlled by the RTM",
            "Only route reflectors in BGP environments"
        ],
        "correctIndex": 0,
        "explanation": "Redistribution wird von Border Routern durchgefuehrt. Ein Border Router laeuft entweder zwei verschiedene Routing-Protokolle (z.B. IS-IS und OSPF) oder zwei Instanzen desselben Protokolls und sitzt damit an der Grenze zwischen zwei Routing-Domains.",
        "explanation_en": "Redistribution is performed by border routers. A border router runs either two different routing protocols (e.g. IS-IS and OSPF) or two instances of the same protocol, sitting at the boundary between two routing domains.",
        "extraInfo": "Ein typisches Beispiel ist ein Router, der sowohl IS-IS als auch BGP betreibt und BGP-Praefixe in IS-IS redistributet.",
        "extraInfo_en": "A typical example is a router running both IS-IS and BGP, redistributing BGP prefixes into IS-IS.",
        "tip": "Border Router = Grenzrouter zwischen zwei Routing-Domains.",
        "tip_en": "Border router = boundary router between two routing domains.",
        "tags": [
            "IS-IS",
            "Redistribution",
            "Border Router"
    ...
    {
        "id": "isis-s5-q3",
        "question": "Welche Arten von Redistribution gibt es?",
        "question_en": "What types of redistribution exist?",
        "options": [
            "One-Way und Two-Way Redistribution",
            "Active und Passive Redistribution",
            "Internal und External Redistribution",
            "Level-1 und Level-2 Redistribution"
        ],
        "options_en": [
            "One-way and two-way redistribution",
            "Active and passive redistribution",
            "Internal and external redistribution",
            "Level-1 and Level-2 redistribution"
        ],
        "correctIndex": 0,
        "explanation": "Redistribution kann one-way (nur in eine Richtung) oder two-way (in beide Richtungen) konfiguriert werden. Bei two-way redistribution tauschen beide Protokolle gegenseitig Routen aus.",
        "explanation_en": "Redistribution can be configured one-way (in one direction only) or two-way (in both directions). With two-way redistribution, both protocols exchange routes with each other.",
        "extraInfo": "Two-way Redistribution birgt das Risiko von Routing-Loops, da Routen, die urspruenglich aus Protokoll A kamen, nach Redistribution in Protokoll B wieder zurueck in Protokoll A redistributet werden koennten.",
        "extraInfo_en": "Two-way redistribution carries the risk of routing loops, as routes originally from protocol A could be redistributed back into protocol A after redistribution into protocol B.",
        "tip": "One-way = eine Richtung, Two-way = beide Richtungen.",
        "tip_en": "One-way = one direction, two-way = both directions.",
        "tags": [
            "IS-IS",
            "Redistribution",
            "One-Way",
    ...
    {
        "id": "isis-s5-q4",
        "question": "Werden IP-Praefixe, die von einem anderen Routing-Protokoll gelernt wurden, automatisch an IS-IS-Peers weitergegeben?",
        "question_en": "Are IP prefixes learned from another routing protocol automatically advertised to IS-IS peers?",
        "options": [
            "Nein -- nur wenn explizit eine Export-Routing-Policy konfiguriert wird",
            "Ja -- IS-IS redistributet automatisch alle Routen anderer Protokolle",
            "Ja -- aber nur fuer direkt verbundene Subnetze",
            "Nein -- Redistribution ist in IS-IS grundsaetzlich nicht moeglich"
        ],
        "options_en": [
            "No -- only when an explicit export routing policy is configured",
            "Yes -- IS-IS automatically redistributes all routes from other protocols",
            "Yes -- but only for directly connected subnets",
            "No -- redistribution is fundamentally not possible in IS-IS"
        ],
        "correctIndex": 0,
        "explanation": "IS-IS (und andere IGPs wie OSPF) haben per Default eine ablehnende Export-Policy: Routen von anderen Protokollen werden nicht automatisch in IS-IS eingespeist. Dafuer muss explizit eine Export-Routing-Policy erstellt und angewendet werden.",
        "explanation_en": "IS-IS (and other IGPs like OSPF) have a default reject export policy: routes from other protocols are not automatically injected into IS-IS. An explicit export routing policy must be created and applied for this to happen.",
        "extraInfo": "Das ist ein wichtiges Sicherheitsmerkmal -- ohne explizite Konfiguration bleibt die Routing-Domain isoliert.",
        "extraInfo_en": "This is an important safety feature -- without explicit configuration, the routing domain remains isolated.",
        "tip": "Redistribution in IS-IS = immer explizite Export-Policy notwendig.",
        "tip_en": "Redistribution into IS-IS = explicit export policy always required.",
        "tags": [
            "IS-IS",
            "Redistribution",
            "Export Policy",
    ...
    {
        "id": "isis-s5-q5",
        "question": "Was muss konfiguriert werden, damit Redistribution in IS-IS funktioniert?",
        "question_en": "What must be configured for redistribution into IS-IS to work?",
        "options": [
            "Explizite Export-Routing-Policies",
            "Eine statische Route als Fallback",
            "Ein separates VRF fuer die Quell-Domain",
            "Eine hoeherePreference fuer die zu redistribuierenden Routen"
        ],
        "options_en": [
            "Explicit export routing policies",
            "A static route as fallback",
            "A separate VRF for the source domain",
            "A higher preference for the routes to be redistributed"
        ],
        "correctIndex": 0,
        "explanation": "Fuer Redistribution in IS-IS muessen explizite Export-Routing-Policies erstellt werden. Diese definieren, welche Routen aus welchem Quell-Protokoll in IS-IS eingespeist werden duerfen.",
        "explanation_en": "For redistribution into IS-IS, explicit export routing policies must be created. These define which routes from which source protocol are allowed to be injected into IS-IS.",
        "extraInfo": "Die Policy wird dann im IS-IS-Kontext als Export-Policy referenziert und aktiviert.",
        "extraInfo_en": "The policy is then referenced and activated in the IS-IS context as an export policy.",
        "tip": "Kein Redistribution ohne explizite Export-Policy.",
        "tip_en": "No redistribution without an explicit export policy.",
        "tags": [
            "IS-IS",
            "Redistribution",
            "Export Policy",
    ...
    {
        "id": "isis-s5-q6",
        "question": "Was ist der Zweck von Route Filtering?",
        "question_en": "What is the purpose of route filtering?",
        "options": [
            "Zu kontrollieren, welche Routen von Peers empfangen werden duerfen und welche weitergegeben werden sollen",
            "Die Routing-Tabelle automatisch von doppelten Eintraegen zu bereinigen",
            "Routen mit hoeheren Costs zu bevorzugen, um Schleifen zu vermeiden",
            "Den Speicherbedarf der FIB durch Entfernen alter Eintraege zu reduzieren"
        ],
        "options_en": [
            "To control which routes may be received from peers and which should be forwarded",
            "To automatically clean the routing table of duplicate entries",
            "To prefer routes with higher costs to avoid loops",
            "To reduce FIB memory usage by removing old entries"
        ],
        "correctIndex": 0,
        "explanation": "Route Filtering kontrolliert den Fluss von Routing-Informationen: Welche Routen werden von Nachbarn akzeptiert (Import) und welche lokal bekannten Routen werden an Nachbarn gesendet (Export).",
        "explanation_en": "Route filtering controls the flow of routing information: which routes are accepted from neighbors (import) and which locally known routes are sent to neighbors (export).",
        "extraInfo": "Route Filtering ist ein zentrales Werkzeug fuer Netzwerksicherheit und Traffic-Engineering.",
        "extraInfo_en": "Route filtering is a central tool for network security and traffic engineering.",
        "tip": "Route Filtering = Kontrolle ueber Empfang und Weitergabe von Routen.",
        "tip_en": "Route filtering = control over receiving and forwarding routes.",
        "tags": [
            "IS-IS",
            "Route Filtering",
            "Import",
    ...
    {
        "id": "isis-s5-q7",
        "question": "Was beschreibt eine Import-Policy in Route Filtering?",
        "question_en": "What does an import policy describe in route filtering?",
        "options": [
            "Akzeptieren oder Ablehnen von Routen, die von Nachbarn empfangen werden",
            "Welche lokal bekannten Routen an Nachbarn gesendet werden",
            "Die Reihenfolge, in der Routing-Protokolle gestartet werden",
            "Welche Interfaces fuer den Empfang von Routing-Updates gesperrt sind"
        ],
        "options_en": [
            "Accepting or rejecting routes received from neighbors",
            "Which locally known routes are sent to neighbors",
            "The order in which routing protocols are started",
            "Which interfaces are blocked from receiving routing updates"
        ],
        "correctIndex": 0,
        "explanation": "Eine Import-Policy bestimmt, ob empfangene Routen von einem Nachbarn in die lokale Routing-Tabelle aufgenommen (accept) oder verworfen (reject) werden.",
        "explanation_en": "An import policy determines whether routes received from a neighbor are added to the local routing table (accept) or discarded (reject).",
        "extraInfo": "Import-Policies erlauben eine feingranulare Kontrolle, welche externen Praefixe in die eigene Routing-Tabelle aufgenommen werden.",
        "extraInfo_en": "Import policies allow fine-grained control over which external prefixes are added to one's own routing table.",
        "tip": "Import = was kommt rein (accept/reject von Nachbarn).",
        "tip_en": "Import = what comes in (accept/reject from neighbors).",
        "tags": [
            "IS-IS",
            "Route Filtering",
            "Import Policy"
    ...
    {
        "id": "isis-s5-q8",
        "question": "Was beschreibt eine Export-Policy in Route Filtering?",
        "question_en": "What does an export policy describe in route filtering?",
        "options": [
            "Welche lokal bekannten Routen an Nachbarn gesendet oder verweigert werden",
            "Akzeptieren oder Ablehnen von Routen, die von Nachbarn empfangen werden",
            "Die maximale Anzahl an Routen, die ein Interface weiterleiten darf",
            "Welche Routing-Protokolle auf einem Interface aktiviert sind"
        ],
        "options_en": [
            "Which locally known routes are sent to or withheld from neighbors",
            "Accepting or rejecting routes received from neighbors",
            "The maximum number of routes an interface may forward",
            "Which routing protocols are active on an interface"
        ],
        "correctIndex": 0,
        "explanation": "Eine Export-Policy bestimmt, welche der lokal bekannten Routen an Nachbarn weitergegeben (advertised) oder zurueckgehalten werden. Sie kontrolliert also den ausgehenden Routing-Informationsfluss.",
        "explanation_en": "An export policy determines which locally known routes are advertised to neighbors or withheld. It controls the outgoing flow of routing information.",
        "extraInfo": "Export-Policies sind auch das Mittel fuer Redistribution: Routen aus einem anderen Protokoll werden als lokal bekannte Routen behandelt und koennen per Export-Policy in IS-IS eingespeist werden.",
        "extraInfo_en": "Export policies are also the means for redistribution: routes from another protocol are treated as locally known routes and can be injected into IS-IS via an export policy.",
        "tip": "Export = was geht raus (welche lokalen Routen werden gesendet).",
        "tip_en": "Export = what goes out (which local routes are sent).",
        "tags": [
            "IS-IS",
            "Route Filtering",
            "Export Policy"
    ...
    {
        "id": "isis-s5-q9",
        "question": "Ist eine Import-Policy fuer Routen moeglich, die von einem IS-IS-Peer empfangen werden?",
        "question_en": "Is an import policy possible for routes received from an IS-IS peer?",
        "options": [
            "Nein -- alle Routen von IS-IS-Peers werden akzeptiert und koennen nicht per Route-Policy gefiltert werden",
            "Ja -- Import-Policies koennen frei konfiguriert werden, um IS-IS-Routen zu filtern",
            "Ja -- aber nur fuer Level-2-Routen, Level-1-Routen sind immer akzeptiert",
            "Nein -- IS-IS verwendet stattdessen Prefix-Listen fuer den Import-Filter"
        ],
        "options_en": [
            "No -- all routes from IS-IS peers are accepted and cannot be filtered via route policy",
            "Yes -- import policies can be freely configured to filter IS-IS routes",
            "Yes -- but only for Level-2 routes; Level-1 routes are always accepted",
            "No -- IS-IS uses prefix lists instead for import filtering"
        ],
        "correctIndex": 0,
        "explanation": "Bei IS-IS ist eine Import-Policy nicht erlaubt. Alle Routen, die von IS-IS-Peers empfangen werden, werden akzeptiert und koennen nicht ueber Route-Policies gefiltert werden.",
        "explanation_en": "With IS-IS, an import policy is not allowed. All routes received from IS-IS peers are accepted and cannot be filtered via route policies.",
        "extraInfo": "Der Grund liegt in der Natur von IS-IS als Link-State-Protokoll: Alle Router in einer Area muessen eine identische Link-State-Datenbank (LSDB) haben. Selektives Filtern wuerde die LSDB inkonsistent machen.",
        "extraInfo_en": "The reason lies in the nature of IS-IS as a link-state protocol: all routers in an area must have an identical link-state database (LSDB). Selective filtering would make the LSDB inconsistent.",
        "tip": "IS-IS Import-Policy: nicht erlaubt -- alle Peers-Routen werden akzeptiert.",
        "tip_en": "IS-IS import policy: not allowed -- all peer routes are accepted.",
        "tags": [
            "IS-IS",
            "Route Filtering",
            "Import Policy",
    ...
    {
        "id": "isis-s5-q10",
        "question": "Was kann eine IS-IS Export-Policy bewirken, und was ist das Default-Verhalten bezueglich Level-2 zu Level-1 Route Leaking?",
        "question_en": "What can an IS-IS export policy do, and what is the default behavior regarding Level-2 to Level-1 route leaking?",
        "options": [
            "Export-Policy kann Level-2-Routen in Level-1-Areas leaken; per Default werden Level-2-Routen NICHT nach Level-1 geteilt",
            "Export-Policy kann Level-1-Routen in Level-2-Areas leaken; per Default werden alle Routen automatisch geteilt",
            "Export-Policy steuert nur Redistribution von externen Protokollen; Level-Leaking ist immer automatisch aktiv",
            "Export-Policy blockiert Level-2-Routen standardmaessig und muss deaktiviert werden, um Leaking zu erlauben"
        ],
        "options_en": [
            "Export policy can leak Level-2 routes into Level-1 areas; by default Level-2 routes are NOT shared to Level-1",
            "Export policy can leak Level-1 routes into Level-2 areas; by default all routes are automatically shared",
            "Export policy only controls redistribution from external protocols; level leaking is always automatic",
            "Export policy blocks Level-2 routes by default and must be disabled to allow leaking"
        ],
        "correctIndex": 0,
        "explanation": "IS-IS Export-Policies erlauben es, Level-2-Routing-Informationen in Level-1-Areas zu leaken (weiterzugeben). Per Default werden Level-2-Routen NICHT automatisch an Level-1-Peers weitergegeben -- das muss explizit konfiguriert werden.",
        "explanation_en": "IS-IS export policies allow Level-2 routing information to be leaked into Level-1 areas. By default, Level-2 routes are NOT automatically shared with Level-1 peers -- this must be explicitly configured.",
        "extraInfo": "Dieses Verhalten ist in RFC 2966 beschrieben. L2-zu-L1-Leaking ist nuetzlich, wenn L1-Router spezifische L2-Routen benoetigen, anstatt nur eine Default-Route zu haben.",
        "extraInfo_en": "This behavior is described in RFC 2966. L2-to-L1 leaking is useful when L1 routers need specific L2 routes instead of only having a default route.",
        "tip": "L2-zu-L1 Leaking: explizite Export-Policy noetig, Default = nicht geteilt.",
        "tip_en": "L2-to-L1 leaking: explicit export policy required, default = not shared.",
        "tags": [
            "IS-IS",
            "Route Filtering",
            "Export Policy",
    ...
    {
        "id": "isis-s5-v1",
        "question": "Warum ist eine Import-Policy fuer IS-IS-Peer-Routen nicht erlaubt?",
        "question_en": "Why is an import policy for IS-IS peer routes not allowed?",
        "options": [
            "IS-IS ist ein Link-State-Protokoll -- alle Router in einer Area muessen eine identische LSDB haben; Filtering wuerde die LSDB inkonsistent machen",
            "IS-IS verwendet keine Routing-Updates, daher gibt es keinen Punkt, an dem eine Import-Policy greifen koennte",
            "Import-Policies wuerden zu viel CPU-Last erzeugen und IS-IS-Konvergenz verlangsamen",
            "IS-IS-Routen haben eine feste Preference, die nicht durch Policies veraendert werden darf"
        ],
        "options_en": [
            "IS-IS is a link-state protocol -- all routers in an area must have an identical LSDB; filtering would make the LSDB inconsistent",
            "IS-IS does not use routing updates, so there is no point where an import policy could take effect",
            "Import policies would generate too much CPU load and slow down IS-IS convergence",
            "IS-IS routes have a fixed preference that cannot be changed by policies"
        ],
        "correctIndex": 0,
        "explanation": "In Link-State-Protokollen wie IS-IS fluten alle Router ihre LSPs (Link-State PDUs) durch die gesamte Area. Das Ergebnis ist eine identische LSDB auf allen Routern. Wuerde ein Router selektiv IS-IS-Routen filtern, haette er eine andere Sicht auf die Topologie als seine Nachbarn -- das fuehrt zu Inkonsistenzen und potenziellen Routing-Loops.",
        "explanation_en": "In link-state protocols like IS-IS, all routers flood their LSPs (Link-State PDUs) throughout the entire area. The result is an identical LSDB on all routers. If a router were to selectively filter IS-IS routes, it would have a different view of the topology than its neighbors -- this leads to inconsistencies and potential routing loops.",
        "extraInfo": "Distance-Vector-Protokolle wie RIP oder BGP koennen Import-Policies anwenden, weil jeder Router nur die beste Route aus der Perspektive des sendenden Routers erhaelt -- keine vollstaendige Topologie-Datenbank.",
        "extraInfo_en": "Distance-vector protocols like RIP or BGP can apply import policies because each router only receives the best route from the sending router's perspective -- no complete topology database.",
        "tip": "Link-State = alle haben gleiche LSDB = kein selektives Import-Filtering moeglich.",
        "tip_en": "Link-state = all have same LSDB = no selective import filtering possible.",
        "tags": [
            "IS-IS",
            "Route Filtering",
            "Import Policy",
    ...
    {
        "id": "isis-s5-v2",
        "question": "Welches Risiko birgt Two-Way Redistribution gegenueber One-Way Redistribution?",
        "question_en": "What risk does two-way redistribution pose compared to one-way redistribution?",
        "options": [
            "Routing-Loops -- Routen aus Protokoll A koennen nach Redistribution in Protokoll B wieder zurueck in Protokoll A gelangen",
            "Hoehere CPU-Last auf dem Border Router durch doppelte Berechnung",
            "Das RTM kann nicht mehr zwischen internen und externen Routen unterscheiden",
            "Alle IS-IS-Peers muessen neu gestartet werden, wenn Two-Way aktiviert wird"
        ],
        "options_en": [
            "Routing loops -- routes from protocol A can re-enter protocol A after redistribution into protocol B",
            "Higher CPU load on the border router due to double calculation",
            "The RTM can no longer distinguish between internal and external routes",
            "All IS-IS peers must be restarted when two-way is activated"
        ],
        "correctIndex": 0,
        "explanation": "Bei Two-Way Redistribution koennte eine Route, die urspruenglich aus IS-IS kommt, in OSPF redistributet werden und von dort wieder zurueck in IS-IS -- mit veraenderten Metriken. Das kann zu suboptimalen Pfaden oder Routing-Loops fuehren.",
        "explanation_en": "With two-way redistribution, a route originally from IS-IS could be redistributed into OSPF and then back into IS-IS -- with modified metrics. This can lead to suboptimal paths or routing loops.",
        "extraInfo": "Um Routing-Loops bei Two-Way Redistribution zu vermeiden, werden Techniken wie Route-Tagging eingesetzt: Routen erhalten beim ersten Redistributieren ein Tag, das den Border-Router anweist, sie nicht erneut zu redistributen.",
        "extraInfo_en": "To avoid routing loops in two-way redistribution, techniques like route tagging are used: routes receive a tag at first redistribution that instructs the border router not to redistribute them again.",
        "tip": "Two-Way Redistribution = Routing-Loop-Risiko. Route-Tagging als Gegenmassnahme.",
        "tip_en": "Two-way redistribution = routing loop risk. Route tagging as countermeasure.",
        "tags": [
            "IS-IS",
            "Redistribution",
            "Two-Way",
    ...
    {
        "id": "isis-s6-q1",
        "question": "Welche zwei funktionellen Komponenten hat ein typischer Router?",
        "question_en": "Which two functional components does a typical router have?",
        "options": [
            "Control Plane und Data Plane",
            "Management Plane und Forwarding Plane",
            "Routing Plane und Switching Plane",
            "North Plane und South Plane"
        ],
        "options_en": [
            "Control plane and data plane",
            "Management plane and forwarding plane",
            "Routing plane and switching plane",
            "North plane and south plane"
        ],
        "correctIndex": 0,
        "explanation": "Typische Router haben genau zwei funktionelle Komponenten: die Control Plane (Steuerungsebene) und die Data Plane (Datenebene). Beide haben klar getrennte Aufgaben.",
        "explanation_en": "Typical routers have exactly two functional components: the control plane and the data plane. Both have clearly separated responsibilities.",
        "extraInfo": "In modernen Router-Architekturen sind Control Plane und Data Plane auch physisch getrennt -- auf verschiedenen Hardware-Karten.",
        "extraInfo_en": "In modern router architectures, control plane and data plane are also physically separated -- on different hardware cards.",
        "tip": "Router = Control Plane + Data Plane.",
        "tip_en": "Router = control plane + data plane.",
        "tags": [
            "IS-IS",
            "Control Plane",
            "Data Plane",
    ...
    {
        "id": "isis-s6-q2",
        "question": "Welche Aufgaben hat die Control Plane?",
        "question_en": "What are the responsibilities of the control plane?",
        "options": [
            "Betrieb und Management des Routers, Unterstuetzung dynamischer Routing-Protokolle, Aufbau der FIB und Verteilung an die Data Plane",
            "Verarbeitung und Weiterleitung jedes eingehenden Pakets auf physischen Interfaces",
            "Ausschliesslich das Forwarding von Paketen anhand der FIB",
            "Verwaltung von physischen Ports und Durchfuehrung von Checksummen-Berechnungen"
        ],
        "options_en": [
            "Router operations and management, support of dynamic routing protocols, building the FIB and distributing it to the data plane",
            "Processing and forwarding every incoming packet on physical interfaces",
            "Exclusively forwarding packets based on the FIB",
            "Managing physical ports and performing checksum calculations"
        ],
        "correctIndex": 0,
        "explanation": "Die Control Plane hat drei Kernaufgaben: (1) Betrieb und Management des Routers, (2) Unterstuetzung dynamischer Routing-Protokolle fuer die Kommunikation mit anderen Routern, und (3) Aufbau der FIB und Verteilung von Kopien davon an die Data Plane.",
        "explanation_en": "The control plane has three core tasks: (1) router operations and management, (2) support of dynamic routing protocols for communication with other routers, and (3) building the FIB and distributing copies of it to the data plane.",
        "extraInfo": "Die Control Plane ist also 'das Gehirn' des Routers -- sie trifft alle Entscheidungen, fuehrt sie aber nicht direkt aus.",
        "extraInfo_en": "The control plane is the 'brain' of the router -- it makes all decisions but does not execute them directly.",
        "tip": "Control Plane: Management + Routing-Protokolle + FIB aufbauen.",
        "tip_en": "Control plane: management + routing protocols + build FIB.",
        "tags": [
            "IS-IS",
            "Control Plane",
            "FIB",
    ...
    {
        "id": "isis-s6-q3",
        "question": "Welche Aufgabe hat die Data Plane?",
        "question_en": "What is the responsibility of the data plane?",
        "options": [
            "Jedes eingehende Paket verarbeiten und anhand der FIB eine Forwarding-Entscheidung treffen und es auf dem richtigen physischen Interface weiterleiten",
            "Die FIB aufbauen und Kopien davon an den CPM verteilen",
            "Dynamische Routing-Protokolle ausfuehren und Routing-Updates senden",
            "Das Management und die Konfiguration aller Router-Interfaces verwalten"
        ],
        "options_en": [
            "Process every incoming packet and make a forwarding decision based on the FIB, then forward it on the correct physical interface",
            "Build the FIB and distribute copies of it to the CPM",
            "Run dynamic routing protocols and send routing updates",
            "Manage the configuration of all router interfaces"
        ],
        "correctIndex": 0,
        "explanation": "Die Data Plane verarbeitet jedes eingehende Paket und trifft anhand der FIB die passende Forwarding-Entscheidung. Die tatsaechliche Weiterleitung findet auf den physischen Interfaces statt.",
        "explanation_en": "The data plane processes every incoming packet and makes the appropriate forwarding decision based on the FIB. The actual forwarding takes place on the physical interfaces.",
        "extraInfo": "Die Data Plane arbeitet mit extrem hoher Geschwindigkeit im Hardware-Pfad (line-rate) -- deshalb muss die FIB auf die Data Plane verteilt werden statt jede Entscheidung an die Control Plane zu schicken.",
        "extraInfo_en": "The data plane operates at extremely high speed in the hardware path (line-rate) -- which is why the FIB must be distributed to the data plane instead of sending every decision to the control plane.",
        "tip": "Data Plane: FIB nutzen + Pakete weiterleiten auf physischen Interfaces.",
        "tip_en": "Data plane: use FIB + forward packets on physical interfaces.",
        "tags": [
            "IS-IS",
            "Data Plane",
            "FIB",
    ...
    {
        "id": "isis-s6-q4",
        "question": "Welche Hardware-Karte ist auf Nokia SR OS fuer die Control Plane zustaendig?",
        "question_en": "Which hardware card is responsible for the control plane on Nokia SR OS?",
        "options": [
        ...
        "correctIndex": 0,
        "explanation": "Die Control Plane laeuft auf dem CPM (Control Processor Module). Das CPM fuehrt alle Control-Plane-Funktionen aus: Routing-Protokolle, Management, FIB-Berechnung und Verteilung.",
        "explanation_en": "The control plane runs on the CPM (Control Processor Module). The CPM executes all control plane functions: routing protocols, management, FIB calculation and distribution.",
        "extraInfo": "Nokia SR OS Router haben typischerweise redundante CPMs fuer High Availability -- faellt eine aus, uebernimmt die andere ohne Traffic-Unterbrechung auf der Data Plane.",
        "extraInfo_en": "Nokia SR OS routers typically have redundant CPMs for high availability -- if one fails, the other takes over without traffic interruption on the data plane.",
        "tip": "Control Plane = CPM (Control Processor Module).",
        "tip_en": "Control plane = CPM (Control Processor Module).",
        "tags": [
            "IS-IS",
            "Control Plane",
            "CPM",
    ...
    {
        "id": "isis-s6-q5",
        "question": "Welche Hardware-Karte erledigt auf Nokia SR OS die Data Plane Funktionen?",
        "question_en": "Which hardware card handles data plane functions on Nokia SR OS?",
        "options": [
            "I/O Karten (Input/Output Modules)",
            "CPM -- Control Processor Module",
            "RSM -- Route Switch Module",
            "BMC -- Backplane Management Card"
        ],
        "options_en": [
            "I/O cards (Input/Output Modules)",
            "CPM -- Control Processor Module",
            "RSM -- Route Switch Module",
            "BMC -- Backplane Management Card"
        ],
        "correctIndex": 0,
        "explanation": "Die Data Plane Funktionen werden von den I/O Karten (Input/Output Modules) ausgefuehrt. Diese Karten verarbeiten den Datenverkehr direkt in Hardware mit Line-Rate-Geschwindigkeit.",
        "explanation_en": "Data plane functions are performed by I/O cards (Input/Output Modules). These cards process traffic directly in hardware at line-rate speed.",
        "extraInfo": "Die physische Trennung von CPM (Control Plane) und I/O Karten (Data Plane) ist entscheidend: Hohe Traffic-Last auf der Data Plane beeintraechtig die Control Plane nicht.",
        "extraInfo_en": "The physical separation of CPM (control plane) and I/O cards (data plane) is crucial: high traffic load on the data plane does not affect the control plane.",
        "tip": "Data Plane = I/O Karten.",
        "tip_en": "Data plane = I/O cards.",
        "tags": [
            "IS-IS",
            "Data Plane",
            "I/O Cards",
    ...
    {
        "id": "isis-s6-q6",
        "question": "Welche Rolle spielt die Control Plane beim Forwarding von Datenpaketen?",
        "question_en": "What role does the control plane play in the forwarding of data packets?",
        "options": [
            "Die Control Plane bereitet nur die FIB vor und nimmt ansonsten nicht am Forwarding teil",
            "Die Control Plane forwarded alle Pakete direkt ueber den CPM",
            "Die Control Plane und Data Plane forwarden Pakete gemeinsam im Round-Robin-Verfahren",
            "Die Control Plane uebernimmt das Forwarding nur bei Ausfall der I/O Karten"
        ],
        "options_en": [
            "The control plane only prepares the FIB and otherwise does not participate in forwarding",
            "The control plane forwards all packets directly via the CPM",
            "The control plane and data plane jointly forward packets in a round-robin manner",
            "The control plane takes over forwarding only when I/O cards fail"
        ],
        "correctIndex": 0,
        "explanation": "Die Control Plane bereitet die FIB vor und verteilt Kopien davon an die Data Plane -- damit ist ihre Rolle beim Forwarding abgeschlossen. Das eigentliche Forwarding jedes Pakets uebernimmt ausschliesslich die Data Plane.",
        "explanation_en": "The control plane prepares the FIB and distributes copies to the data plane -- that is where its role in forwarding ends. The actual forwarding of every packet is handled exclusively by the data plane.",
        "extraInfo": "Wuerde die Control Plane am Forwarding teilnehmen, waere sie schnell ueberlastet -- moderne Router forwarden Millionen von Paketen pro Sekunde, was CPUs nicht in Echtzeit bewaltigen koennen.",
        "extraInfo_en": "If the control plane participated in forwarding, it would quickly be overwhelmed -- modern routers forward millions of packets per second, which CPUs cannot handle in real time.",
        "tip": "Control Plane = FIB vorbereiten, NICHT forwarden.",
        "tip_en": "Control plane = prepare FIB, NOT forward.",
        "tags": [
            "IS-IS",
            "Control Plane",
            "Data Plane",
    ...
    {
        "id": "isis-s6-q7",
        "question": "Was verwaltet die Control Plane ausser Routing-Protokollen noch?",
        "question_en": "What else does the control plane manage besides routing protocols?",
        "options": [
            "Alle Arten des Router-Managements -- Interfaces, Konfiguration von Management-Tools und Router-Betrieb",
            "Ausschliesslich die Berechnung der kuerzesten Pfade fuer IGPs",
            "Nur die Synchronisation der FIB zwischen Control und Data Plane",
            "Einzig die Verwaltung von BGP-Sessions zu externen Peers"
        ],
        "options_en": [
            "All types of router management -- interfaces, configuration of management tools, and router operations",
            "Exclusively the calculation of shortest paths for IGPs",
            "Only the synchronization of the FIB between control and data plane",
            "Solely the management of BGP sessions to external peers"
        ],
        "correctIndex": 0,
        "explanation": "In der Control Plane werden alle Arten des Managements fuer den Router durchgefuehrt: Interface-Konfiguration, Management-Tools (SSH, SNMP, Syslog), Routing-Protokolle und der gesamte Router-Betrieb.",
        "explanation_en": "All types of management for the router are handled in the control plane: interface configuration, management tools (SSH, SNMP, Syslog), routing protocols, and overall router operations.",
        "extraInfo": "Auch Control Plane Protokolle wie OSPF Hello-Pakete oder IS-IS LSPs werden ueber die Control Plane verarbeitet -- nicht ueber die Data Plane.",
        "extraInfo_en": "Control plane protocols like OSPF hello packets or IS-IS LSPs are also processed via the control plane -- not via the data plane.",
        "tip": "Control Plane = alles ausser das Forwarden von Datenpaketen.",
        "tip_en": "Control plane = everything except forwarding data packets.",
        "tags": [
            "IS-IS",
            "Control Plane",
            "Management",
    ...
    {
        "id": "isis-s6-q8",
        "question": "Wie gelangt die FIB von der Control Plane zur Data Plane?",
        "question_en": "How does the FIB get from the control plane to the data plane?",
        "options": [
            "Die Control Plane baut die FIB auf und verteilt Kopien davon an die Data Plane",
            "Die Data Plane baut ihre eigene FIB unabhaengig von der Control Plane auf",
            "Die FIB wird direkt vom RTM auf die physischen Interfaces geladen ohne Zwischenschicht",
            "Jede I/O Karte berechnet ihre eigene FIB basierend auf den empfangenen Routing-Updates"
        ],
        "options_en": [
            "The control plane builds the FIB and distributes copies of it to the data plane",
            "The data plane builds its own FIB independently from the control plane",
            "The FIB is loaded directly from the RTM onto physical interfaces without an intermediate layer",
            "Each I/O card calculates its own FIB based on received routing updates"
        ],
        "correctIndex": 0,
        "explanation": "Die Control Plane (CPM) baut die FIB auf -- basierend auf den Routing-Protokollen und dem RTM -- und verteilt dann Kopien dieser FIB an die I/O Karten der Data Plane. Die Data Plane nutzt diese FIB dann fuer das Forwarding.",
        "explanation_en": "The control plane (CPM) builds the FIB -- based on routing protocols and the RTM -- and then distributes copies of this FIB to the I/O cards of the data plane. The data plane then uses this FIB for forwarding.",
        "extraInfo": "Diese Verteilung der FIB auf alle I/O Karten ist entscheidend fuer Line-Rate-Forwarding: Jede Karte kann Pakete sofort weiterleiten, ohne bei jeder Entscheidung den CPM zu befragen.",
        "extraInfo_en": "This distribution of the FIB to all I/O cards is crucial for line-rate forwarding: each card can immediately forward packets without querying the CPM for every decision.",
        "tip": "FIB: Control Plane baut sie, Data Plane bekommt Kopien und nutzt sie.",
        "tip_en": "FIB: control plane builds it, data plane receives copies and uses them.",
        "tags": [
            "IS-IS",
            "FIB",
            "Control Plane",
    ...
    },
    {
        ...
        "options": [
            "Hohe Traffic-Last auf der Data Plane beeintraechigt die Control Plane nicht -- Routing-Protokolle und Management bleiben stabil",
            "Damit der Router bei Ausfall einer I/O Karte automatisch neu startet",
            "Weil IS-IS LSPs nur ueber dedizierte Hardware-Karten versendet werden duerfen",
            "Um sicherzustellen, dass jede I/O Karte ihre eigene unabhaengige Routing-Tabelle hat"
        ],
        "options_en": [
            "High traffic load on the data plane does not affect the control plane -- routing protocols and management remain stable",
            "So the router automatically restarts when an I/O card fails",
            "Because IS-IS LSPs may only be sent via dedicated hardware cards",
            "To ensure each I/O card has its own independent routing table"
        ],
        "correctIndex": 0,
        "explanation": "Wenn Control Plane und Data Plane physisch getrennt sind, kann ein DDoS-Angriff oder extremer Traffic-Burst auf der Data Plane den CPM nicht ueberlasten. Routing-Protokolle konvergieren weiterhin normal und das Management bleibt erreichbar.",
        "explanation_en": "When control plane and data plane are physically separated, a DDoS attack or extreme traffic burst on the data plane cannot overload the CPM. Routing protocols continue to converge normally and management remains reachable.",
        "extraInfo": "Dieses Konzept ist auch als 'Control Plane Protection' bekannt und ist ein grundlegendes Sicherheitsmerkmal in Service-Provider-Routern.",
        "extraInfo_en": "This concept is also known as 'Control Plane Protection' and is a fundamental security feature in service provider routers.",
        "tip": "Physische Trennung = Data Plane Traffic kann CPM nicht ueberlasten.",
        "tip_en": "Physical separation = data plane traffic cannot overload the CPM.",
        "tags": [
            "IS-IS",
            "Control Plane",
            "Data Plane",
    ...
    {
        "id": "isis-s6-v2",
        "question": "Was passiert mit dem Daten-Forwarding, wenn der CPM (Control Plane) ausfaellt, die I/O Karten (Data Plane) aber noch laufen?",
        "question_en": "What happens to data forwarding if the CPM (control plane) fails but the I/O cards (data plane) are still running?",
        "options": [
            "Das Forwarding laeuft weiter -- die I/O Karten nutzen ihre lokal gespeicherte FIB-Kopie; nur neue Routing-Aenderungen koennen nicht mehr verarbeitet werden",
            "Das Forwarding stoppt sofort, da jedes Paket eine Entscheidung vom CPM benoetigt",
            "Die Data Plane wechselt automatisch auf statische Routen als Fallback",
            "Die I/O Karten senden alle Pakete an den naechsten Router ohne Forwarding-Entscheidung"
        ],
        "options_en": [
            "Forwarding continues -- the I/O cards use their locally stored FIB copy; only new routing changes can no longer be processed",
            "Forwarding stops immediately because every packet requires a decision from the CPM",
            "The data plane automatically switches to static routes as a fallback",
            "The I/O cards send all packets to the next router without a forwarding decision"
        ],
        "correctIndex": 0,
        "explanation": "Da jede I/O Karte eine lokale Kopie der FIB hat, kann das Forwarding ohne den CPM weiterlaufen. Allerdings koennen keine Routing-Updates mehr verarbeitet werden -- die FIB veraltet. Nokia SR OS unterstuetzt Non-Stop Routing (NSR) genau fuer diesen Fall.",
        "explanation_en": "Since each I/O card has a local copy of the FIB, forwarding can continue without the CPM. However, no routing updates can be processed anymore -- the FIB becomes stale. Nokia SR OS supports Non-Stop Routing (NSR) precisely for this case.",
        "extraInfo": "Dieses Verhalten ist der Hauptgrund, warum die FIB auf die I/O Karten verteilt wird -- es entkoppelt das Forwarding von der Verfuegbarkeit der Control Plane.",
        "extraInfo_en": "This behavior is the main reason why the FIB is distributed to I/O cards -- it decouples forwarding from the availability of the control plane.",
        "tip": "CPM-Ausfall = Forwarding weiter (alte FIB), aber keine Routing-Updates mehr.",
        "tip_en": "CPM failure = forwarding continues (old FIB), but no more routing updates.",
        "tags": [
            "IS-IS",
            "Control Plane",
            "Data Plane",
